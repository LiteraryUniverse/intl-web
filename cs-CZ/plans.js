export default {
  ...
  'payment.option.description':
    'Zde je seznam vašich uložených platebních metod. Nové platební metody si můžete uložit pro rychlejší platbu. Literární Universe neukládá ani nezpracovává vaše platební údaje, jako je číslo kreditní karty.',
  ...
  'plans.subscribed.paymentMethod':
    'Váš výchozí způsob platby bude použit k zaplacení za další cyklu.',
  ...
  'plans.cancel.question':
    'Opravdu chcete zrušit předplatné? Vaše předplatné zůstane aktivní až do konce fakturačního cyklu.',
  'plans.cancel.confirmationButton': 'Ano, chci zrušit své předplatné',
  'plans.cancel.failed':
    'Omlouváme se, v tuto chvíli jsme nebyli schopni zrušit váš plán. Zkuste to prosím za chvíli.',
  'plans.cancel.restoreBtn': 'Obnovit předplatné',
  'plans.cancel.restoreFailed':
    'Omlouváme se, momentálně jsme nebyli schopni obnovit předplatné. Zkuste to prosím znovu později.',
  'plans.change.button': 'Změnit předplatné',
  'plans.change.explanation':
    'Vyberte tarif, na který chcete přejít. Neprodleně vám bude účtován rozdíl v ceně.',
  'plans.change.failed':
    'Omlouváme se, v tuto chvíli jsme nebyli schopni změnit váš plán. Zkuste to prosím za chvíli.',
  'plans.change.upgrade': 'Upgradovat',
  'payments.disclaimer':
    'Platební informace a zpracování jsou prováděny přes Stripe. Na našich serverech neuchováváme žádné informace o kreditní kartě ani bankovním účtu.',
  ...
  'payment.webMonetization.explained':
    'Webová Monetizace je navrhovaným standardem pro webové platby. Zde můžete přidat ukazatel platby, který bude přidán na Vaši profilovou stránku, blog, vesmíry a příběhy, které mohou využít webovou Monetizací.',
  ...
  'stripeConnect.settings.intro':
    'Pokud chcete získat finanční prostředky nebo prodat prostřednictvím Literary Universe musíte vytvořit Stripe účet pomocí tlačítka níže.',
  'stripeConnect.settings.connectAccount': 'Nastavit Stripe účet',
  'stripeConnect.settings.ongoing':
    'Čekáme na zpětnou vazbu od Stripu. Může to chvíli trvat. Pokud to trvá příliš dlouho, klikněte na tlačítko níže což vás vrátí zpět na Stripe.',
  ...
  'payment.donations.payNowUSD':
    'Darovat {donation, number, ::compact-short currency/USD} {username}',
  'payment.donations.payNowJPY':
    'Darovat {donation, number, ::compact-short currency/JPY} {username}',
  'payment.donations.payNowEUR':
    'Darovat {donation, number, ::compact-short currency/EUR} {username}',
  'payment.donations.payNowCZK':
    'Darovat {donation, number, ::compact-short currency/CZK} {username}',
  'payment.donations.payNowGBP':
    'Darovat {donation, number, ::compact-short currency/GBP} {username}',
  'payment.donations.thankYouTitle': 'Děkujeme za Váš dar pro {username}',
  'payment.donations.thankYouContinue':
    'Děkujeme, že jste podpořili {username}, doufáme, že se budete i nadále těšit z jejich práce a podpoříte je i v budoucnosti.',
  ...
  'payment.author.requirementStripeConnect':
    'Než budeme moci zpracovat finanční transakce, musíte vytvořit a připojit svůj účet Stripe Connect.',
  'payment.author.requirementPublishWork':
    'Než budete pokračovat, zveřejněte prosím alespoň jedno dílo (příběh nebo vesmír).',
  'payment.author.createWork': 'Vytvořte nové dílo',
  'payment.author.directivesTitle': 'Doporučení',
  'payment.author.directivesExplained':
    'Máme několik dalších doporučení, která byste měli splnit předtím, než umožníte platební služby, které by měli zvýšit Vaší šanci na úspěch.',
  'payment.author.directivesStoryPublished':
    'Publikujte alespoň jeden příběh zdarma pro ukázku Vašeho řemesla.',
  'payment.author.directivesFreeStoryFinished':
    'Dokončete alespoň jeden bezplatný příběh a ukážete čtenářům, že je uprostřed cesty neopustíte.',
  'payment.universe.directivesUniversePublished': 'Publikujte Váš vesmír',
  'payment.universe.directivesEncFull':
    'Vyplňte svou encyklopedii, mějte alespoň 30 záznamů! Lepší, pokud útočíte na 100 záznamů.',
  'payment.universe.haveFans':
    'Je snazší vás přimět k sponzorování, pokud už mají zájem o to, co děláte. 100 fanoušků kteří mají Váš vesmír ve své knihovně je dobrý počáteční laťka.',
  ...
  'payment.fanClub.priceBreakdown':
    'Odběratel zaplatí: {amount}. Poplatek platformy je {fee}, obdržíte: {net}',
  'payment.feeNotice':
    'Mějte prosím na paměti, že se jedná o odhad a skutečný poplatek se může lišit v závislosti na způsobu platby zákazníka a případných dalších poplatcích od platební brány.',
