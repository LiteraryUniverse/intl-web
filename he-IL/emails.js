...
export default {
  ...
  'email.enrollAccount.messageHtml':
    'מעוניינים להזמינך ליקום הספרותי! הכנו עבורך חשבון אישי בו תוכל לגשת לכל התכונות של יקום הספרותי! בוא איתנו ליצור את הדור הבא של כתיבה וקריאה יצירתיים!',
  ...
  'email.resetPassword.messageHtml':
    'קיבלנו בקשה לאיפוס הסיסמה של חשבונך, אנא לחץ על הכפתור למטה כדי להמשיך בתהליך. אם לא ביקשת לאפס את הסיסמה, ניתן להתעלם מהודעה זו, אך זה יכול להיות זמן טוב לבדוק שוב את הגדרות האבטחה שלך.',
  'email.resetPassword.button': 'איפוס סיסמה',
  // E-mail verification
  'email.verifyEmail.messageHtml':
    'אנחנו שמחים לראותך בקרבנו! אנא לחץ על הכפתור למטה כדי לאמת את כתובת הדוא"ל הזו.',
