export default {
  ...
  'story.estimatedReadingTime.explained':
    'Βασισμένο σε μια μέση ταχύτητα ανάγνωσης των {avgReadingNum, number} λέξεων ανά λεπτό.',
  ...
  'discover.includesAds':
    'Αυτό το έργο περιλαμβάνει προϊόντα ή περιλαμβάνει άλλου είδους διαφημίσεις.',
