export default {
    ...
    'settings.export.explain': 'Ini akan mengekspor semua data pribadi Anda yang tersimpan di basis data kami sebagai file JSON. Ini termasuk profil, cerita, riwayat membaca, entri buku harian, catatan pribadi, statistik penulisan, penanda, daftar bacaan, aktivitas komunitas, keanggotaan, dan semua data lain yang terkait dengan akun Anda.',
    'settings.export.submit': 'Ekspor data',
    'settings.delete.title': 'Hapus Akun',
    'settings.delete.warning': 'PERINGATAN: Dengan menghapus akun, Anda akan kehilangan akses secara permanen ke akun ini dan tidak ada cara untuk memulihkannya. Semua data pribadi termasuk entri buku harian, catatan pribadi, riwayat membaca, dan statistik penulisan akan dihapus secara permanen.',
    'settings.delete.published': 'Anda telah menerbitkan konten di platform. Menghapus akun Anda akan menganonimkan karya yang telah Anda publikasikan (menghapus nama dan informasi profil Anda), bukan menghapusnya. Komentar Anda akan diganti dengan "[dihapus]". Jika Anda ingin membatalkan publikasi karya Anda terlebih dahulu, silakan lakukan sebelum menghapus akun Anda.',
    ...
    'settings.delete.error': 'Penghapusan akun mengalami kesalahan. Silakan hubungi dukungan jika masalah berlanjut.',
    ...
    'settings.apiKeys.noKeys': 'Anda belum memiliki kunci API apa pun.',
    'settings.apiKeys.created': 'Created {date, date, medium} at {date, time, short}',
    'settings.apiKeys.lastUsed': 'Terakhir digunakan {time}',
    'settings.apiKeys.neverUsed': 'Tidak pernah digunakan',
    'settings.apiKeys.expires': 'Kedaluwarsa {date, date, medium}',
    'settings.apiKeys.name': 'Nama Kunci',
    'settings.apiKeys.name.placeholder': 'misalnya, Plugin Obsidian',
    'settings.apiKeys.permissions': 'Izin',
    'settings.apiKeys.generate': 'Hasilkan Kunci API',
    'settings.apiKeys.generated.title': 'Kunci API Dihasilkan',
    'settings.apiKeys.generated.warning': 'Simpan kunci ini sekarang! Anda tidak akan dapat melihatnya lagi.',
    'settings.apiKeys.copyToClipboard': 'Menyalin ke Papan Klip',
    'settings.apiKeys.expiration': 'Kedaluwarsa',
    'settings.apiKeys.expiration.duration': `{months, plural,
    =1 {1 bulan}
    =3 {3 bulan}
    =6 {6 bulan}
    =12 {1 tahun (disarankan)}
    =24 {2 tahun}
    other {{months} bulan}
  }`,
    'settings.apiKeys.revoke.confirm': 'Apakah Anda yakin ingin mencabut kunci API ini? Tindakan ini tidak dapat dibatalkan.',
    'settings.apiKeys.delete.confirm': 'Apakah Anda yakin ingin menghapus kunci API ini? Tindakan ini tidak dapat dibatalkan.',
    'settings.apiKeys.error.nameRequired': 'Masukkan nama untuk kunci API Anda',
    'settings.apiKeys.error.scopesRequired': 'Pilih setidaknya satu izin',
    'settings.apiKeys.security.title': 'Pemberitahuan Keamanan',
    'settings.apiKeys.security.1': 'Jangan pernah membagikan kunci API Anda dengan siapa pun',
    'settings.apiKeys.security.2': 'Perlakukan seperti kata sandi',
    'settings.apiKeys.security.3': 'Anda dapat mencabut akses kapan saja',
    'settings.apiKeys.security.4': 'Kunci hanya akan ditampilkan satu kali',
    'settings.apiKeys.scope.story.read': 'Baca cerita',
    'settings.apiKeys.scope.story.read.desc': 'Mengakses judul, konten, dan bab cerita Anda',
    'settings.apiKeys.scope.story.write': 'Membuat dan mengedit cerita',
    'settings.apiKeys.scope.story.write.desc': 'Buat cerita baru dan perbarui cerita yang sudah ada',
    'settings.apiKeys.scope.universe.read': 'Membaca alam semesta',
    'settings.apiKeys.scope.universe.read.desc': 'Mengakses entri ensiklopedia dan data pembangunan dunia Anda',
    'settings.apiKeys.scope.universe.write': 'Membuat dan mengedit alam semesta',
    'settings.apiKeys.scope.universe.write.desc': 'Membuat dan memperbarui entri ensiklopedia',
    'settings.apiKeys.scope.scratchpad.read': 'Membaca catatan',
    'settings.apiKeys.scope.scratchpad.read.desc': 'Mengakses catatan pribadi dan buku catatan Anda',
    'settings.apiKeys.scope.scratchpad.write': 'Membuat dan mengedit catatan',
    'settings.apiKeys.scope.scratchpad.write.desc': 'Membuat dan memperbarui catatan Anda',
    'settings.apiKeys.scope.blog.read': 'Baca posting blog',
    'settings.apiKeys.scope.blog.read.desc': 'Mengakses postingan dan draf blog Anda',
    'settings.apiKeys.scope.blog.write': 'Membuat dan mengedit postingan blog',
    'settings.apiKeys.scope.blog.write.desc': 'Membuat dan memperbarui postingan blog',
    'settings.apiKeys.scope.user.read': 'Baca profil',
