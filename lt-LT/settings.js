export default {
    ...
    'settings.export.explain': 'Tai leis eksportuoti visus jūsų asmeninius duomenis, saugomus mūsų duomenų bazėje, į JSON failą. Tai apima jūsų profilį, istorijas, skaitymo istoriją, dienoraščio įrašus, asmenines pastabas, rašymo statistiką, žymes, skaitymo sąrašus, bendruomenės veiklą, narystę ir visus kitus su jūsų paskyra susijusius duomenis.',
    'settings.export.submit': 'Eksportuoti duomenis',
    'settings.delete.title': 'Ištrinti paskyrą',
    'settings.delete.warning': 'ĮSPĖJIMAS: ištrindami savo paskyrą visam laikui prarandate prieigą prie šios paskyros ir jos atkurti neįmanoma. Visi privatūs duomenys, įskaitant dienoraščio įrašus, asmenines pastabas, skaitymo istoriją ir rašymo statistiką, bus visam laikui ištrinti.',
    'settings.delete.published': 'Paskelbėte turinį platformoje. Ištrynus paskyrą, jūsų paskelbti kūriniai bus ne ištrinti, o nuasmeninti (bus pašalintas jūsų vardas ir profilio informacija). Jūsų komentarai bus pakeisti į "[ištrinti]". Jei pirmiausia norite panaikinti savo kūrinių publikavimą, padarykite tai prieš ištrindami savo paskyrą.',
    ...
    'settings.delete.error': 'Pašalinant paskyrą pasitaikė klaida. Jei problema išlieka, kreipkitės į palaikymo tarnybą.',
