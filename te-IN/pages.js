export default {
  ...
  'gdpr.processing.desc':
    'సాహిత్య యూనివర్స్ మరియున మాటోమో సంఖ్యల సర్వర్‌కు నమోదులు పంపడానికి "ట్ర్యాక్ చేయదు" అభ్యర్థనలను పూర్తిగా మాన్యంచినందుకు మానవీయంగా ఆచరించుకోవడానికి పూర్తిగా మాన్యంచినది.',
  ...
  'dmca.step2.desc1':
    'మీ నివేదిక పొందిన తరువాత, మేము మీ ప్రమాణాలను మరియు స్వామిత్వ దావాన్ని ధృవీకరించడానికి తనిఖీ చేస్తాము. ఎవరైనా సరిగా ఉంటే, మేము దావాన్ని తనిఖీ చేసేందుకు ముందు ప్రమాణాన్ని తలుపుచేస్తాము. దావాన్ని నిజం అని మేము తెలుసుకున్నాము అయితే, మేము దాడి నిర్ధారణ లేదా 14 రోజుల తర్వాత తొలగించబడుతాము.',
  'dmca.step3.desc1':
    'ఒక ఫిర్యాదు పొందబడిన తరువాత, నియమించబడిన సంపత్తి యొక్క యజమానికి 14 రోజులు ఉంటాయి కౌంటర్ నోటిస్ చేయడానికి. నియమించబడిన ఏజెంట్ ఆపరేషన్ వివరించేందుకు ముందు, వివాదాన్ని పరిశీలించడం ప్రారంభిస్తారు. ఈ దశలో యేమైనా నిర్ణయం తీసుకోవడం ప్రారంభించిన ఏజెంట్ చరిత్ర కానీసం ఉంటుంది.',
  ...
  'about.attributionsIntro':
    'సాహిత్య యూనివర్స్ చాలా ఉద్యోగ ప్రాజెక్టులపై నిర్మించబడింది మరియు ఉచిత వనరులను ఉపయోగిస్తుంది. క్రిందివరకు మీరు వారి జాబితాను కనుగొనేందుకు ఉంటారు.',
  'about.attributionsMatomo':
    'మా విశ్లేషణలు స్వయం-నిలువుగా ఉపయోగిస్తుంది Matomo తో, IP2Location LITE డేటాను https://lite.ip2location.com నుండి అందుబాటులో ఉంది.',
