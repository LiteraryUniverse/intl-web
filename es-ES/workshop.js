export default {
    ...
    'workshop.revisions.comments.list': '{revision}: {publication, select, beta {para lectores beta} readers {Público} other {}} {datetime, date, medium} a las {datetime, time, short}',
  ...
  `,
    ...
    'workshop.webMonetization.explain': 'La monetización web te proporcionará ingresos en función del tiempo que los usuarios inviertan en tu contenido. En los ajustes de monetización de tu perfil podrás establecer tu propia dirección de pago. Así podrás llegar a un acuerdo para repartir los ingresos con tus colaboradores que tengan activado el Pago Web. Literary Universe se queda automáticamente con el 10%.',
    'workshop.webMonetization.revShare': 'Debido a las limitaciones de la monetización web, se utiliza el reparto probabilístico de ingresos. El reparto probabilístico de ingresos funciona eligiendo aleatoriamente entre una lista de direcciones de pago predefinidos cada vez que un visitante con monetización web activa carga tu página. El visitante aporta ingresos a la dirección elegida hasta que la página se vuelve a cargar o se cierra.',
    'workshop.webMonetization.revShareMore': 'Aprende más sobre el reparto probabilístico de los ingresos. Utilizamos el mismo código que en esa página.',
