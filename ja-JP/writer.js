export default {
  ...
  'writer.publish.previousChapterPublished':
    '前の章は{publishDate, date, short}に{publishDate, time}に公開されました。',
  'writer.publish.previousChapterScheduled':
    '前の章は{publishDate, date, short}に{publishDate, time}に公開予定です。',
  'writer.publish.alreadyPublished':
    'この章は{publishedAt, date, short}に既に公開されています。新しいバージョンはもうすぐ公開されます。',
