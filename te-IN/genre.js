export default {
  'genre.scifi': 'సైన్స్ ఫిక్షన్',
  'genre.fantasy': 'ఫాంటసీ',
  'genre.adventure': 'సాహసం',
  'genre.poetry': 'కవిత',
  'genre.comedy': 'కామెడీ',
  'genre.drama': 'నాటకం',
  'genre.nonfiction': 'నా-కథ',
  'genre.fiction': 'కథానాయకత్వం',
  'genre.romance': 'రొమాన్స్',
  'genre.satire': 'సాటైర్',
  'genre.tragedy': 'శోకం',
  'genre.crime': 'Crime',
  'genre.historical': 'ఐతిహాసిక నాయకత్వం',
  'genre.horror': 'హార్రర్',
  'genre.mystery': 'రహస్యం',
  'genre.thriller': 'థ్రిల్లర్',
  'genre.western': 'పశ్చిమ',
  'genre.memoir': 'నా జీవిత చరిత్ర',
  'genre.biography': 'జీవిత చరిత్ర',
  'genre.steampunk': 'స్టీంపంక్',
  'genre.mythology': 'మిథాలజీ',
  'genre.fairytale': 'పిల్లల కధ',
  'genre.superhero': 'సూపర్ హీరో',
