export default {
    ...
    'blog.qa.references.title': '參考資料',
    'blog.qa.references.add': '加入參考',
    'blog.qa.references.sectionTitle': '相關內容',
    'blog.qa.reference.encyclopedia': '百科全書條目： {title}',
    'blog.qa.reference.story': '故事： {title}{chapter}',
    'blog.qa.reference.chapter': ' (章節： {chapterTitle})',
    'blog.qa.reference.blogPost': '部落格文章： {title}',
    'blog.qa.reference.type.encyclopedia': '百科全書條目',
    'blog.qa.reference.type.story': '故事',
    'blog.qa.reference.type.blog': '部落格文章',
    'blog.qa.reference.chapter.option': '章節 {sequence}',
    'blog.qa.reference.chapter.untitled': '無標題章節',
    'blog.qa.reference.chapter.placeholder': '選擇章節...',
    'blog.qa.reference.line': '{typeLabel} - {title}{chapterPart}',
    'blog.qa.reference.type': '{type, select, encyclopedia {📚 百科全書} story {📖 故事} blog {📝 部落格} other {參考資料}}',
    'blog.qa.outdated.title': '過期狀態',
    'blog.qa.outdated.marked': '此問題已標示為過期。',
    'blog.qa.outdated.replacement': '由問題取代：',
    'blog.qa.outdated.unmark': '標記為目前',
    'blog.qa.outdated.mark': '標記為過期',
    'blog.qa.outdated.confirm': '標記為過期',
    'blog.qa.outdated.replacementPlaceholder': '搜尋替換問題...',
    'blog.qa.outdated.notice': '此答案可能已經過時。',
    'blog.qa.outdated.seeReplacement': '請參閱問題 {question} 中的更新答案。',
    // Q&A Public
    'blog.qa.title': '問題',
