export default {
  ...
  'encyclopedia.help.text':
    'Используйте меню слева для перехода между пунктами энциклопедии. После выбора пункта он будет отображаться вместо данного текста.',
  ...
  'encyclopedia.container.desc':
    'Сделать эту запись контейнером для новой группы записей. Это позволит скрыть её из списка категорий.',
  'encyclopedia.entry.name': 'Название записи',
  'encyclopedia.summary': 'Краткое описание',
  'encyclopedia.summary.desc':
    'Это краткое описание, которое будет единственной первоначальной информацией, отображаемой на экране читателя.',
  ...
  'encyclopedia.translation.desc':
    'Этот интерфейс энциклопедии используется для перевода на: {language}. Выберите существующие записи в списке слева, чтобы начать их перевод.',
  ...
  'encyclopedia.settings.categoriesDesc':
    'Включайте и выключайте категории, которые вы хотите использовать в своей энциклопедии.',
  'encyclopedia.settings.introText':
    'Приветственное сообщение, которое будет отображаться после описания вселенной.',
  ...
  'enc.entries.limitReached':
    'Вы достигли максимально допустимого количества записей в энциклопедии для вашей подписки.',
  ...
  'encyclopedia.settings.templateDescription':
    'Разрешить копирование содержимого этой энциклопедии в другие вселенные. Это лучший вариант, если у вас нет историй и вы просто создаёте шаблон для других.',
  ...
  'encyclopedia.templateCopy.description':
    'Скопируйте содержимое этой энциклопедии в свою вселенную, чтобы обогатить её.',
