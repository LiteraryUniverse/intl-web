...
export default {
  ...
  'email.verifyEmail.subject':
    ".i se jivna be lo nu jai gau krici lo du'u do pu se ctino lo se preti be lo ka facki lo nu jivna do",
  ...
  'email.signature':
    ".i cinmo fi lo ka<br />lo se preti be lo ka facki lo nu jivna do lo za'u reno cevni",
  // Enrollment
  'email.enrollAccount.welcome': ".i co'a jivna",
  'email.enrollAccount.messageHtml':
    ".i mi pu cilre lo nu do pu'o jivna lo za'u reno cevni! .i mi pu zukte lo se pilno be lo za'u reno cevni pe do .i ko catlu lo te pilno be lo za'u reno cevni be lo nu penmi .i ko penmi mi lo nu pilno lo te pilno be lo za'u reno cevni be lo nu penmi",
  ...
  'email.resetPassword.messageHtml':
    "lo nu do cikre lo se jinvi be do ke'a cu se klama lo nu do jgari lo japyvla be do, .i ko jai gau kliki lo botpi bau la'o zoi. bellow .zoi. lo nu cnano lo pruce cu zmadu",
  'email.resetPassword.button': 'cnino japyvla',
  // E-mail verification
  'email.verifyEmail.messageHtml':
    "Mi'e la .ui. cu gleki lo nu do klama le daski! .i ko jai gau kliki lo botpi bau la'o zoi. bellow .zoi. lo nu sruma lo pruce cu zmadu",
