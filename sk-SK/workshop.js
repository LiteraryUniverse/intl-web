export default {
    ...
    'workshop.readingHistory.title': 'História čítania',
    'workshop.readingHistory.calendar': 'Mapa ročného čítania',
    'workshop.readingHistory.weekHour': 'Najlepší čas na čítanie',
    'workshop.readingHistory.dayTooltip': '{date}: {sessions, number} relácie, {duration}',
    'workshop.readingHistory.weekHourTooltip': '{day} na {hour}: {sessions, number} relácie, {duration}',
  ...
  `,
    ...
    'workshop.monetization.arcPricingHelp': 'Nastavte individuálne ceny pre každý príbehový oblúk. Každý príbehový oblúk je v službe Stripe samostatným produktom a pri uložení sa automaticky synchronizuje.',
    'workshop.monetization.arcPricingTitle': 'Ceny oblúka',
    'workshop.monetization.currencies': 'Meny',
    'workshop.monetization.defaultCurrencies': 'Predvolené meny pre tento jazyk: {currencies}.',
    'workshop.monetization.errorNoPrice': 'Nastavte aspoň jednu cenu.',
    'workshop.monetization.freePreview': 'Bezplatný náhľad',
    'workshop.monetization.freePreviewChapters': 'Bezplatný náhľad kapitol',
    ...
    'workshop.monetization.percentageFee': 'Percentuálne rozdelenie aktívnych.',
    'workshop.monetization.priceBounds': 'Minimálne {min}. Maximum {max}. Štandardný rez plošiny: {platformCut, number}% po prekročení nízkocenového paušálneho poplatku.',
    'workshop.monetization.priceEstimate': '{feeMode} Bazén tvorcov: {payout}. Poplatok za platformu: {platformFee}. Odhadovaný poplatok Stripe v rámci tohto poplatku za platformu: {stripeFee}. Odhadovaný poplatok za platformu po Stripe: {platformNet}.',
    ...
    'workshop.monetization.pricingHelp': 'Nastavte ceny v menách, ktoré chcete podporovať. Ceny sa zadávajú v zobrazovacom formáte, napríklad 4,99 alebo 500 pre meny s nulovou desatinnou čiarkou.',
    'workshop.monetization.purchaseMode': 'Režim nákupu',
    'workshop.monetization.purchaseModeArc': 'Na jeden oblúk',
    'workshop.monetization.purchaseModeBoth': 'Obe stránky',
    'workshop.monetization.purchaseModeFull': 'Celý príbeh',
    'workshop.monetization.purchaseModeHelp': 'Vyberte si, ako si čitatelia môžu kúpiť váš príbeh. Celý príbeh predáva celý príbeh. Per-arc umožňuje čitateľom kúpiť si jednotlivé príbehové oblúky. Obe možnosti umožňujú ktorúkoľvek z nich.',
    'workshop.monetization.purchaseModeLabel': 'Režim nákupu',
    'workshop.monetization.saveArcPricing': 'Uloženie cien oblúka',
    'workshop.monetization.saveError': 'Chyba pri ukladaní nastavení cien',
    'workshop.monetization.splitHelp': 'Rozdelenie výplat sa upravuje ako percentuálny podiel hrubého predaja. Riadok platformy je pevne stanovený licenciou na príbeh a zvyšok vyplnia riadky tvorcov.',
    'workshop.monetization.stripeSynced': '✓ Pruh',
    'workshop.monetization.suggestedPrice': 'Navrhované: {price}.',
    'workshop.monetization.tier.shortStory': 'Krátky príbeh',
    'workshop.monetization.tier.novella': 'Novella',
    'workshop.monetization.tier.novel': 'Novinka',
    'workshop.monetization.tier.epic': 'Epic',
    'workshop.monetization.translationPricing': 'Ceny za preklad',
    'workshop.monetization.translationPricingHelp': 'Tento preklad sa predáva ako vlastný produkt spoločnosti Stripe. Čitatelia, ktorí si zakúpia toto vydanie, získajú prístup len k verzii {language}.',
    'workshop.monetization.translationPricingMissing': '{count, plural, one {Preklad {languages} nemá nakonfigurované ceny.} other {{languages} nemajú nakonfigurované ceny.}} Čitatelia si nebudú môcť zakúpiť {count, plural, one {tento preklad} other {tieto preklady}} , kým nebude nastavená cenotvorba.',
    // Revenue share
    'workshop.revShare.allocation': '{username} - {total, number, ::percent}',
    'workshop.revShare.fixed': 'Opravené',
    'workshop.revShare.mustMatchCreatorShare': 'Riadky tvorcov sa musia sčítať {creatorShare, number}%, pretože podiel platformy je pevne stanovený na {platformShare, number}%.',
    'workshop.revShare.owner': 'Vlastník',
    'workshop.revShare.ownerLocked': 'Vlastník príbehu musí zostať súčasťou rozdelenia výplaty.',
    'workshop.revShare.platformFixed': 'Podiel platformy je pre túto licenciu stanovený na {platformShare, number}%. Riadky tvorcov si rozdelia zvyšných {creatorShare, number}%.',
    'workshop.revShare.platformShare': 'Podiel platformy',
    ...
    'workshop.collaborators.monetizedNotice': 'Tento príbeh je spoplatnený. Pred prijatím pozvánky musia pozvaní dokončiť nastavenie výplaty prostredníctvom služby Stripe. Podiel na príjmoch môžete navrhnúť nižšie - bude sa brať z vášho podielu.',
    ...
    'workshop.ai.chat.webSearch': 'Vyhľadávanie na webe',
    'workshop.ai.chat.webSearch.hint': 'Nechajte asistenta vyhľadať túto správu na webe',
