...
export default {
  ...
  'flashnews.onlyDisplayOn':
    'The news is going to be displayed only on the languages selected bellow (if any selected), there will be no news shown in default language in other languages.'
}
