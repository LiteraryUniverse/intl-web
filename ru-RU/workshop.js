export default {
    ...
    'workshop.fictionalTime.formDescription': `Здесь Вы можете создать свое собственное вымышленное время. В настоящее время этот инструмент ограничен и способен создавать только
    ...
    'workshop.fictionalTime.declarationLocation': 'Где должно быть объявлено имя времени?',
  ...
  `,
    ...
    'workshop.statusChangeEmail.cancellationWhy': 'Это произошло потому, что Вы не опубликовали ни одной новой главы в этой истории с тех пор, как она была отменена 6 месяцев назад. После года бездействия мы автоматически переводим истории в статус отмененных, чтобы читатели знали, какие истории активны.',
