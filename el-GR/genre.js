export default {
  'genre.scifi': 'Επιστημονική φαντασία',
  'genre.fantasy': 'Φαντασία',
  'genre.adventure': 'Περιπέτεια',
  'genre.poetry': 'Ποίηση',
  'genre.comedy': 'Κωμωδία',
  'genre.drama': 'Δράμα',
  'genre.nonfiction': 'Μη-φαντασία',
  'genre.fiction': 'Μυθοπλασία',
  'genre.romance': 'Ρομάντζο',
  'genre.satire': 'Σάτιρα',
  'genre.tragedy': 'Τραγωδία',
  'genre.crime': 'Crime',
  'genre.historical': 'Ιστορική μυθοπλασία',
  'genre.horror': 'Τρόμου',
  'genre.mystery': 'Μυστήριο',
  'genre.thriller': 'Θρίλερ',
  'genre.western': 'Γουέστερν',
  'genre.memoir': 'Αυτοβιογραφία',
  'genre.biography': 'Βιογραφία',
  'genre.steampunk': 'Στιμπανκ',
  'genre.mythology': 'Μυθολογία',
  'genre.fairytale': 'Παραμύθι',
  'genre.superhero': 'Υπερήρωας',
  ...
  'genre.fantasy.description':
    'Η φαντασία είναι ένα λογοτεχνικό είδος που περιλαμβάνει στοιχεία μαγείας, υπερφυσικών γεγονότων και μυθικών πλασμάτων, συχνά τοποθετημένο σε φανταστικούς κόσμους. Μπορεί να περιλαμβάνει ήρωες σε αποστολές, μάχες ανάμεσα σε καλό και κακό, και ιστορίες ενηλικίωσης. Η φαντασία μπορεί να κατηγοριοποιηθεί σε υπο-είδη, όπως υψηλή φαντασία, αστική φαντασία, σκοτεινή φαντασία και παραμύθια, μεταξύ άλλων. Συχνά εξετάζει θέματα ηθικής και δεοντολογίας, εξερευνώντας τη φύση του καλού και του κακού.',
  ...
  'genre.isekai.description':
    'Αυτό το υπο-είδος των ιαπωνικών ελαφρών μυθιστορημάτων, μάνγκα και ανιμέ περιστρέφεται γύρω από έναν χαρακτήρα που μεταφέρεται ή αναγεννιέται σε έναν διαφορετικό κόσμο ή εναλλακτικό σύμπαν. Ο πρωταγωνιστής πρέπει να πλοηγηθεί και να προσαρμοστεί στις μοναδικές πολιτιστικές και περιβαλλοντικές συνθήκες του νέου κόσμου, συχνά αποκτώντας νέες ικανότητες και αντιμετωπίζοντας νέους σύμμαχους και εχθρούς κατά τη διάρκεια της πορείας του. Αυτές οι ιστορίες μπορούν να κυμαίνονται από ανέμελες και κωμικές έως σκοτεινές και έντονες, αλλά πάντα προσφέρουν μια φρέσκια και φανταστική άποψη για κλασικά θέματα περιπέτειας.',
}
