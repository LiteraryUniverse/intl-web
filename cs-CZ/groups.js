export default {
  'groups.listing.title': 'Uživatelské skupiny',
  'groups.listing.organizationTitle': 'Týmy',
  'groups.create.title': 'Vytvořit novou skupinu',
  ...
  'groups.type.closedDesc':
    'Uzavřená - Pro připojení do skupiny je zapotřebí schválení majitelem skupiny.',
  ...
  'groups.join.pendingRequest':
    'Váš požadavek pro členství v této skupině čeká na schválení ze strany správců skupiny.',
