export default {
    ...
    'form.submitting.signup': 'Hesap oluşturuluyor...',
    'form.submitting.signin': 'Giriş yapılıyor...',
    'form.submitting.default': 'Gönderiliyor...',
    'form.submitting.sending': 'Gönderiliyor...',
    'form.validator.whitespace': 'Boşluk içermemeli',
    'form.validator.zipCode': 'Geçerli bir posta kodu olmalı',
    'form.validator.isbn': 'Sadece 10 veya 13 haneli ISBN kabul ediyoruz',
    'form.validator.btc': 'Bu geçerli bir BTC adresi değil.',
    'form.validator.eth': 'Bu geçerli bir ETH adresi değil.',
    'form.weakPassword': 'Bu şifre zayıf görünüyor. Lütfen sayılar ve özel karakterler ekleyerek daha güçlü hale getirmeyi düşünün.',
    ...
    'simpleschema.notUnique': '{label} benzersiz olmalı',
