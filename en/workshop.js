export default {
  ...
  'workshop.universe.publishedOn':
    'This universe has been published on {date, date, long} {date, time, short}',
  'workshop.work.deletion.contactUs':
    'If you need help, <contact>contact us</contact>.',
  ...
  'workshop.universe.dangerZone.desc':
    'You can delete this universe only when it has no published stories and was published less than one month ago. If you need to delete it after this limitation period, please contact us.',
  'workshop.universe.delete.modalAria':
    'Confirmation modal for deleting a universe',
  'workshop.universe.delete.warning':
  ...
  'workshop.thema.secondary.max':
    'You can add up to {max} secondary classifications.',
  ...
  'workshop.story.publishing.notice':
    'The story will be published automatically once you publish the first chapter.',
  'workshop.story.published.congratulations.title':
    'Congratulations! Your story is published',
  'workshop.story.published.congratulations.heading':
    'Congratulations! Your story has been published',
  'workshop.story.published.congratulations.description':
    'Your writing journey continues. Your story is now ready to be discovered and enjoyed by readers.',
  'workshop.story.published.congratulations.publicStoryBtn':
    'Go to story page',
  ...
  'workshop.story.dangerZone.desc':
    'These actions affect how your story is organized across universes. Proceed carefully.',
  'workshop.story.universe.assign.missing':
    'Please select a universe to continue.',
  'workshop.story.universe.assignTitle': 'Create or assign a universe',
  'workshop.story.universe.assign.desc':
    'Attach this story to an existing universe, or create a brand-new universe using the story details.',
  'workshop.story.universe.assign.mode': 'Universe option',
  'workshop.story.universe.assign.existing':
    'Assign to an existing universe',
  'workshop.story.universe.assign.create':
    'Create a new universe from this story',
  ...
  'workshop.story.universe.assign.none':
    'You do not have any universes yet. Create a new one to continue.',
  'workshop.story.universe.assign.publishNote':
    'This story is already published, so the new universe will be published too.',
  ...
  'workshop.story.universe.standalone.heading':
    'Move this story out of its universe?',
  'workshop.story.universe.standalone.desc':
    'This story will be removed from the universe and listed as a standalone story.',
  'workshop.story.universe.standalone.current': 'Current universe: {title}',
  'workshop.story.universe.standalone.warning1':
    'Readers browsing the universe will no longer see this story listed there.',
  'workshop.story.universe.standalone.warning2':
    'Existing links that point to the universe version of this story may stop working.',
  'workshop.story.universe.standalone.warning3':
  ...
  'workshop.translation.updatedOrig':
    'Last update of original: {updatedAt, date, long} {updatedAt, time, medium}',
  'workshop.translation.updatedTrs':
    'Last update of translation: {updatedAt, date, long} {updatedAt, time, medium}',
  ...
  'workshop.monetization.fullStoryUnfinishedWarning':
    'You can set a full story price before the story is complete, but the full-story purchase option will not activate until the story is marked as finished.',
  ...
  'workshop.outliner.noChapters':
    'Use "Plan chapter" to plan your story structure, or write your first chapter in the workshop.',
  ...
  'workshop.outliner.addChapterHint':
    'Create a planning chapter. Once a real chapter exists in your story, it will appear here automatically and this placeholder will be replaced.',
  ...
  'workshop.scene.checklist.empty':
  ...
  'workshop.scene.assignments.hint':
    'Assign characters and locations from your encyclopedia.',
  'workshop.collaborators.addRoleForLang': 'Add {role} for {language}',
  'workshop.beta.revisionInfo':
    'This is revision {revision, number}, created on {createdAt, date, long}.',
  ...
  'workshop.story.alternateFormats.externalUrls.secureStorageRequired':
    'External URLs are disabled for Literary Universe licensed stories. Upload files instead so they remain on encrypted storage.',
  ...
  'workshop.translation.premium':
    'In order to add translations, you need to have at least Explorer subscription.',
  ...
  'workshop.fictionalTime.declarationLocation':
    'Where should the time name be declared?',
  ...
  'workshop.shoppingExternal.explainer':
    'If your story is sold elsewhere you can set the links here. The links will then show instead of the content or at the end of the content you choose to preview.',
  ...
  'workshop.shoppingExternal.copyFromOriginalHelp':
    "Pre-fill this translation's links with the values from the original. Review and save to apply.",
  'workshop.shoppingExternal.originalReadOnly':
    "Only collaborators can edit the original story's external sales links. Switch to a translation tab to edit links for your language.",
  ...
  'workshop.writerSidebar.description':
    'Welcome to your story! This sidebar allows you easy access to all resources related to your story. Check the icons above to see latest comments, your notes and much more!',
  'workshop.story.authorsNotesExplained':
  ...
  'workshop.rating.disabled.sexualContent':
    'Rating is locked to Explicit (21+) because you selected Sexual Content in content warnings.',
  'workshop.contentWarnings.title': 'Content Warnings',
  'workshop.contentWarnings.description':
    'Select applicable content warnings to inform readers about potentially sensitive content',
  'workshop.contentWarnings.graphicViolence': 'Graphic Violence',
  'workshop.contentWarnings.graphicViolence.description':
    'Detailed descriptions of violent acts, including but not limited to physical harm, bloodshed, mutilation, or any other explicit depictions of violence that may be considered disturbing or excessively graphic.',
  'workshop.contentWarnings.profanity': 'Profanity',
  'workshop.contentWarnings.profanity.description':
    'Excessive or obscene swearing and cursing.',
  'workshop.contentWarnings.sensitiveContent': 'Sensitive Content',
  'workshop.contentWarnings.sensitiveContent.description':
    'Descriptions of torture, slavery, substance abuse, mental illness, addiction, mentions of rape, self-harm or any other content that may be considered traumatizing or mature that does not fall under the warning tags. This content is not glorified.',
  'workshop.contentWarnings.sexualContent': 'Sexual Content',
  'workshop.contentWarnings.sexualContent.description':
    'Explicit sexual content (text only), descriptive sex scenes. This will automatically set the rating to Explicit (21+).',
  ...
  'workshop.story.isAIGeneratedTooltip':
    'Please let us know if any of the story was generated by or with the help of AI. We use this information for proper labeling and due to how AI programs are generated there might be some limitations and restrictions.',
  'workshop.publicationAgreement.aria': 'Publication agreement for work',
  'workshop.publicationAgreement.intro':
    'We are happy that you have chosen to publish your creative work with us. Before we proceed we just need you to look over our publication agreement, to understand what it means from the legal side of things.',
  ...
  'workshop.statusExplain.hiatus1':
    'Hiatus means that you are stepping away from working on this story for a while for what ever reason. It will tell your readers that they should not expect any new updates in the coming weeks or even up to few months.',
  ...
  'workshop.statusExplain.cancelled2':
    'Cancelling story will let your readers know that they should not expect any new updates.',
  'workshop.statusExplain.cancelled3':
    'You can always revert this by publishing a chapter or changing the status.',
  'workshop.statusExplain.finished1':
    'Congratulations! After all that hard work you have finally reached the end of an incredible journey. While the story might end now, we hope that there will be more stories to tell in the future, but for now, relax and enjoy the well earned rest.',
  ...
  'workshop.statusChangeEmail.hiatusWhy':
    'Has been automatically put on hiatus due to no new chapter being published for over 6 months.',
  'workshop.statusChangeEmail.hiatusWhatFollows':
    "This status will be automatically lifted if you publish a new chapter. If you don't publish a new chapter in the next 6 months we will automatically set the story as cancelled.",

  'workshop.statusChangeEmail.cancellationIntro':
    'Your story status was automatically set to cancelled.',
  'workshop.statusChangeEmail.cancellationWhy':
    "This has happened because you haven't posted any new chapter to the story since it was set to hiatus 6 months ago. After a year of inactivity, we automatically set stories to cancelled so that readers know which stories are active.",
  'workshop.statusChangeEmail.cancellationWhatFollows':
    "This status will be automatically lifted if you publish a new chapter. If you don't plan to work on this story anymore there is nothing else that you need to do.",
  ...
  'workshop.story.showChapterNumbersInListing':
    'Show chapter numbers in chapter listing',
  'workshop.story.showChapterNumbersInListingTooltip':
    'When enabled, chapter numbers are visible to readers in story chapter listings.',
  ...
  'workshop.story.delete.modalAria':
    'Confirmation modal for deleting a story',
  ...
  'workshop.ai.assistant.llms.description':
    'These endpoints provide your universe content in a format optimized for Large Language Models and AI systems.',
  'workshop.ai.assistant.universe.info': 'Universe Information',
  'workshop.ai.assistant.universe.info.description':
    'Basic universe information including title, description, language, and statistics.',
  'workshop.ai.assistant.encyclopedia.listing': 'Encyclopedia Listing',
  'workshop.ai.assistant.encyclopedia.listing.description':
    'Complete encyclopedia with all entries organized by categories and links to detailed content.',
  'workshop.ai.assistant.access.title': 'AI Access Settings',
  'workshop.ai.assistant.access.description':
    'Choose how AI systems can reach your LLMs.txt endpoints.',
  'workshop.ai.assistant.access.denied':
    'Only collaborators can change AI access levels.',
  ...
  'workshop.ai.chat.noKey':
    'Add an API key for OpenAI, Anthropic, xAI, or Google in your settings to use the AI assistant.',
  'workshop.ai.chat.noKeyLink': 'Go to Settings',
  'workshop.ai.chat.noAccess':
    'Only the story author and collaborators can use the AI assistant.',
  ...
  'workshop.ai.chat.webSearch': 'Search the web',
  'workshop.ai.chat.webSearch.hint':
    'Let the assistant search the web for this message',
  ...
  'workshop.ai.proposal.reviewHint':
    'Confirm to add this as a WIP encyclopedia draft. You can change the name or category first.',
