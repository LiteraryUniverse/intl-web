...
export default {
  ...
  'site.description':
    'Literary Universe je komplexná tvorivá a vydavateľská platforma pre veľké príbehové vesmíry.',
  'site.keywords':
    'tvorivé písanie, scifi, sci-fi, fantasy, písanie, publikovanie, príbeh, príbehy, vesmír, web novel, webnovel',
  ...
  'common.accessdenied.msg':
    'Nedostali ste povolenie ísť sem. Ak by ste sem mali mať prístup, kontaktujte majiteľa a povedzte mu, aby prekontroloval nastavenia.',
  ...
  'common.futurefeature.text':
    'Je nám veľmi ľúto, ale táto funkcia momentálne nie je k dispozícii. Usilovne pracujeme na tom, aby bola k dispozícii čo najskôr.',
  ...
  'common.legal.newVersionAvailable':
    'Nová verzia ({newVersion}) tohto dokumentu nadobudne účinnosť dňa {effectiveAt, date}.',
  ...
  'premium.only.msg':
    'Ospravedlňujeme sa, vaša členská hodnosť nie je dostatočne vysoká na prístup k tejto funkcii.',
  'premium.only.join':
    'Ponúkame rôzne plány pre každého, kto chce získať čo najviac z Literary Universe.',
  ...
  // for beta only
  'beta.notice':
    'Vitajte v Literary Universe BETA. Toto je verejná ukážka a aplikácia je stále vo vývoji. To znamená, že stále môžete očakávať chyby a nedokončené funkcie. Ak narazíte na chybu alebo niečo nefunguje, dajte nám o tom vedieť a buďte trpezliví, kým všetko uvedieme do poriadku.',
  ...
  'errorLoading.explained':
    'Počas načítavania stránky došlo k chybe. Ospravedlňujeme sa za nepríjemnosti. Pokúste sa, prosím, znovu vstúpiť na stránku. Ak problém pretrváva, dajte nám prosím vedieť.',
  ...
  goodbyeForever:
    'Je nám ľúto, že odchádzate. Bolo to niečo, čo sme urobili? Dajte nám prosím vedieť, ak je to tak. Každopádne vám prajeme všetko najlepšie vo vašich ďalších aktivitách a dúfame, že sa ešte stretneme! Žite dlho a úspešne!',
  ...
  'signin.web3.signMessage':
    'Potvrďte, že chcete vstúpiť do Literary Universe s vašou peňaženkou ako metódou overovania. Kód: {code}',
  ...
  create: 'Vytvoriť',
  'banner.support':
    'Literary Universe podporujú používatelia ako vy! Zvážte, prosím, možnosť predplatiť si niektorý z našich predplatiteľských plánov, aby ste zostali nezávislí a zlepšili podujatie Literary Universe!',
  ...
  'console.explain':
    'Toto je funkcia prehliadača určená pre vývojárov. Ak vám niekto povedal, aby ste sem niečo skopírovali, aby ste povolili funkciu Literárneho vesmíru alebo "hackovali" účet niekoho iného, ide o podvod a umožní mu prístup k vášmu účtu v Literárnom vesmíre.',
