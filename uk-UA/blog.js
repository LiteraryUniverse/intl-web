export default {
  ...
  'blog.theme': 'Тема',
  'blog.theme.info':
    'Змінюючи тему, ви зможете змінити вигляд сторінки. Наразі ця функція не готова.',
  ...
  'blog.slug.explained':
    'Гарний URL-адреса поста. Уникайте використання спеціальних символів, крім "-".',
  ...
  'blog.settings.universeSettings':
    'Блоги всесвіту інтегровані на сторінки всесвіту з їх базовими налаштуваннями, взятими з налаштувань всесвіту.',
