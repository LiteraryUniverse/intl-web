export default {
    'universe.authors.title.meta': '{title} రచయితలు',
    'universe.fanfiction.see': 'నాయక నిర్మాత కోసం ! {universe}! సృష్టించబడింది',
    'universe.fanfiction.desc': '{universe}కోసం ఫన్ ఫిక్షన్',
    'universe.fanfiction.for': '{universe} ఫన్ ఫిక్షన్',
    ...
    'universe.authors.title': 'రచయితలు',
    'universe.authors.desc': '{universe}కు రచయితలు మరియు కాంట్రిబ్యూటర్లు',
    'universe.contributors': 'కాంట్రిబ్యూటర్లు',
    'universe.translators': 'అనువాదకులు',
    'universe.authors.notice': 'ప్రతి కథ అదనప్పటికే ఉండవచ్చు వారు. మరిన్ని వివరాలకు కథ వివరాలను చూడండి',
    'universe.createdBy': `ద్వారా {gender, select,
    male {సృష్టించబడింది ద్వారా}
    female {సృష్టించబడింది}
    other {}} `,
    'universe.stories.for': '{universe}కోసం కథలు',
