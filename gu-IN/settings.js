export default {
  ...
  'settings.languages.notice':
    'અંગ્રેજી અને ચેક હાલમાં માત્ર આધિકારિકપણે સમર્થિત ભાષાઓ છે. અન્ય ભાષાઓ મહાન સ્વયંસેવકો અને AI અનુવાદને આભાર આપી ઉપલબ્ધ છે, પરંતુ તે હજી પણ સંપૂર્ણ અને સાચું ન હોઈ શકે છે.',
  'settings.languages.join':
    'જો તમને મદદ કરવામાં આવતી હોય, તો તમે લિટરરી યુનિવર્સને પણ અનુવાદ કરી શકો છો.',
  ...
  'settings.web3.verify.explained':
    'આ સરનામું તમારી પાસે છે તે શરૂ કરવા માટે અમે તમારા વોલેટની માલિકી ખરેખરીતાને યોગ્યતા માટે એક સંદેશ સાઇન કરવામાં આવશે.',
  'settings.web3.verified': 'ચકાસ્યું',
  'settings.web3.verificationMessage':
    'વપરાશકર્તાને ચકાસો {username} માટે Literary Universe માટે. કોડ: {code}',
  'settings.web3.unlink': 'વોલેટ કાઢી નાંખો',
  'settings.web3.linkingMessage':
    'કૃપા કરીને ખરેખરીતાને તમારા વોલેટને Literary Universe સાથે લિંક કરવાની પુષ્ટિ કરો. કોડ: {code}',
  ...
  'settings.accessibility.paragraphHighlighting':
    'તમે હોવર કરી રહ્યા છો તે વર્તમાન પેરાગ્રાફને હાઇલાઇટ કરો',
