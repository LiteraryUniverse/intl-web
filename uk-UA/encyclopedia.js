export default {
    ...
    'encyclopedia.container.desc': 'Зробити цей запис контейнером для нової групи записів. Це приховає його від списку категорій.',
    'encyclopedia.entry.name': 'Назва запису',
    'encyclopedia.summary': 'Опис',
    'encyclopedia.summary.desc': 'Це опис, який буде єдиною початковою інформацією, відображеною для читача.',
