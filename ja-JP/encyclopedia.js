export default {
  ...
  'encyclopedia.help.text':
    '左側のメニューを使って、百科事典の項目間を移動することができます。項目を選択すると、この文章の代わりに項目が表示されます。',
  'encyclopedia.help.sidebar': 'サイドバーのツールバー',
  'encyclopedia.help.sidebar.text':
    'あなたの物語へようこそ このサイドバーでは、あなたの物語に関連するすべてのリソースに簡単にアクセスできます。上のアイコンをチェックすると、最新のコメント、自分のメモ、百科事典の検索、閲覧、百科事典への新しいエントリの追加ができます。物語のテキストからエントリに接続を追加したい場合は、配置したいテキストを選択してから接続ボタンをクリックします。すると、項目を探して選択するように促されます。',
  ...
  'encyclopedia.translation.desc':
    'この百科事典のインターフェースは{language}への翻訳に使われます。左側のリストから既存の項目を選ぶと、その翻訳が始まります。',
  ...
  'encyclopedia.settings.templateDescription':
    'この百科事典の内容を他の宇宙にコピーすることを許可します。これは、物語を持っていない代わりに他の人が使用するためのテンプレートを作成する場合に最適です。',
