...
export default {
    ...
    'contentSelector.noSelection': 'ఎటువంటి వస్తువులు ఎంపిక చేయబడలేదు',
    'contentSelector.selectedItems': 'ఎంపిక చేసిన వస్తువులు',
    'contentSelector.entireSite': 'సైట్‌లో వెతకండి',
    'contentSelector.tabsLabel': 'శోధన ఎంపికలు',
    'contentSelector.title': 'కంటెంట్‌ను ఎంచుకోండి',
