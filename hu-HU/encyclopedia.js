export default {
  ...
  'encyclopedia.help.text':
    'Használja az oldalsávban található menüt az enciklopédia elemek közötti navigáláshoz. Amint kiválaszt egy elemet, az megjelenik ezen szöveg helyett.',
  'encyclopedia.help.sidebar': 'Oldalsáv Eszköztár',
  'encyclopedia.help.sidebar.text':
    'Üdvözöljük a történetében! Ez az oldalsáv könnyű hozzáférést biztosít minden az Ön történetével kapcsolatos erőforráshoz. Ellenőrizze a fenti ikonokat a legújabb hozzászólások megtekintéséhez, a jegyzeteihez, az enciklopédia kereséséhez, új bejegyzések böngészéséhez és hozzáadásához az enciklopédiához. Ha kapcsolatot szeretne hozzáadni egy bejegyzéshez a történet szövegéből, válassza ki a szöveget, ahol el szeretné helyezni, majd kattintson a kapcsolódás gombra. Ezután felkérjük, hogy találja meg és válasszon ki egy elemet.',
  ...
  'encyclopedia.container.desc':
    'Tegye ezt a bejegyzést tartályként egy új bejegyzéscsoport számára. Ez elrejti azt a kategóriák listájáról.',
  'encyclopedia.entry.name': 'A bejegyzés neve',
  'encyclopedia.summary': 'Összefoglaló',
  'encyclopedia.summary.desc':
    'Ez egy összefoglaló, amely csak kezdeti információként jelenik meg az olvasón.',
  ...
  'encyclopedia.translation.desc':
    'Ez az enciklopédia felület a {language}nyelvre való fordításra szolgál. Válassza ki a bal oldalon található listából a meglévő bejegyzéseket, hogy elkezdje a fordításukat.',
  ...
  'encyclopedia.settings.categoriesDesc':
    'Kapcsolja be és ki a kategóriákat, amelyeket szeretne használni az enciklopédiájában.',
  ...
  'enc.entries.limitReached':
    'Elérted a megengedett maximális számú enciklopédia bejegyzést a jelenlegi előfizetésedben.',
  ...
  'encyclopedia.settings.templateDescription':
    'Engedélyezze ennek az enciklopédiának a más univerzumokba való másolását. Ez a legjobb választás, ha nincsenek történetek, és csak egy sablont hoz létre mások számára.',
  ...
  'encyclopedia.templateCopy.description':
    'Másolja ennek az enciklopédiának a tartalmát az univerzumába, hogy gazdagítsa azt.',
