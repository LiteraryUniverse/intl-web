export default {
  ...
  'encyclopedia.help.text':
    '왼쪽 메뉴를 사용하여 백과사전의 항목 사이를 이동하세요. 항목을 선택하면 이 텍스트 대신에 표시됩니다.',
  'encyclopedia.help.sidebar': '사이드바 도구상자',
  'encyclopedia.help.sidebar.text':
    '당신의 이야기에 오신 것을 환영합니다! 이 사이드바를 통해 이야기와 관련된 모든 자원에 쉽게 접근할 수 있습니다. 최신 댓글, 메모, 백과사전 검색, 새로운 항목을 찾아 추가하는 아이콘을 확인하려면 위의 아이콘을 확인하세요. 이야기 텍스트에서 항목과의 연결을 추가하려면, 연결을 배치하려는 텍스트를 선택한 후에 연결 버튼을 클릭하세요. 그럼 항목을 찾아 선택하라는 메시지가 나타납니다.',
  ...
  'encyclopedia.container.desc':
    '이 항목을 새로운 항목 그룹의 컨테이너로 만듭니다. 이로 인해 카테고리 목록에서 숨겨집니다.',
  'encyclopedia.entry.name': '항목의 이름',
  'encyclopedia.summary': '요약',
  'encyclopedia.summary.desc': '이 요약은 독자에게 표시되는 초기 정보입니다.',
  ...
  'encyclopedia.settings.templateDescription':
    '이 백과의 내용을 다른 우주로 복사할 수 있도록 허용합니다. 이는 당신이 이야기가 없고 다른 사람들이 사용할 템플릿을 만드는 경우에 가장 적합합니다.',
  ...
  'encyclopedia.templateCopy.description':
    '이 백과의 내용을 복사하여 당신의 우주를 풍부하게 만드세요.',
