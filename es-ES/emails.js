...
export default {
  ...
  'email.enrollAccount.messageHtml':
    '¡Nos gustaría invitarte a Literary Universe! ¡Te hemos preparado una cuenta personal para ti en la que puedes acceder a todas las funciones de Literary Universe! ¡Únete a nosotros para crear la generación futura de lectura y escritura creativas!',
  ...
  'email.resetPassword.messageHtml':
    'Hemos recibido una solicitud para restablecer la contraseña de tu cuenta. Por favor, haz clic en el botón de abajo para continuar con el procedimiento. Si no lo has solicitado ignora este mensaje, aunque te convendría revisar tu configuración de seguridad.',
  'email.resetPassword.button': 'Restablecer contraseña',
  // E-mail verification
  'email.verifyEmail.messageHtml':
    '¡Nos complace tenerte a bordo! Por favor, haz clic en el botón de abajo para verificar tu dirección de e-mail.',
