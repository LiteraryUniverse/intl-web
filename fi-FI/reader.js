export default {
  ...
  'reader.externalSale.description':
    'Tätä tarinaa ei ole saatavilla Literary Universessa, mutta voit löytää sen muualta.',
  'reader.storyTBC.heading': 'Jatketaan...',
  'reader.storyTBC.description':
    'Tämä on kaikki mitä tällä hetkellä on tarinasta, mutta seikkailu jatkuu tulevaisuudessa. Tarkista uudelleen pian!',
  ...
  'reader.nextRelease.scheduled':
    'Seuraava luku saapuu {nextReleaseAt, date} {nextReleaseAt, time}!',
  'reader.storyContinues': 'Tarina jatkuu...',
  'reader.storyOnHiatus':
    'Kirjailija pitää tällä hetkellä taukoa tästä tarinasta, ja tarina on toistaiseksi tauolla. Tarkista uudelleen kuukauden tai kahden kuluttua.',
  'reader.storyCancelled':
    'Valitettavasti tämä on kaikki. Tarina on peruutettu, joten uutta sisältöä ei todennäköisesti tule.',
  ...
  'reader.nextChapterEstimation.notEnoughChapters':
    'Kun tarinalla on enemmän kuin yksi luku, annamme myös arvion siitä, milloin seuraava luku saattaisi ilmestyä.',
}
