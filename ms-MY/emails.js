...
export default {
  ...
  'email.enrollAccount.messageHtml':
    'Kami ingin menjemput anda ke Alam Sastera! Kami telah menyediakan akaun peribadi khas untuk anda di mana anda boleh mengakses semua ciri-ciri Alam Sastera! Sila sertai kami dalam mencipta generasi seterusnya penulisan kreatif dan membaca!',
  'email.enrollAccount.button': 'Akses akaun anda',
  'email.enrollAccount.signature':
    'Kami menantikan untuk berjumpa dengan anda, pasukan Literary Universe<br />',
  // Reset password
  'email.resetPassword.messageHtml':
    'Kami telah menerima permintaan untuk menetapkan semula kata laluan akaun anda, sila klik pada butang di bawah untuk meneruskan proses ini. Jika anda tidak membuat permintaan ini, anda boleh mengabaikan e-mel ini, tetapi ini mungkin adalah masa yang baik untuk mengkaji semula tetapan keselamatan anda.',
  'email.resetPassword.button': 'Tetapkan semula kata laluan',
  // E-mail verification
  'email.verifyEmail.messageHtml':
    'Kami gembira mempunyai anda bersama kami! Sila klik butang di bawah untuk mengesahkan alamat e-mel ini.',
  ...
  'email.adminUpgrade.messageHtml': `Kami telah meningkat taraf akaun anda kepada {plan, select,
    explorer {Penjelajah}
    adventurer {Pengembara}
    storyteller {Pencerita}
    other {}
  } untuk {days} hari seterusnya. Nikmati!`,
  'email.verification': 'Pengesahan E-mel',
  'email.verifying': 'Sedang mengesahkan e-mel anda. Ini hanya akan mengambil seketika...',
  'email.verified': 'Berita baik! E-mel anda telah disahkan!',
