export default {
  ...
  'reader.externalSale.description':
    '此故事在Literary Universe上無法取得，但您可以在其他地方找到它。',
  'reader.storyTBC.heading': '待續⋯⋯',
  'reader.storyTBC.description':
    '這是我們目前所擁有的故事內容，但冒險將在未來繼續，請稍後再回來查看！',
  ...
  'reader.nextRelease.scheduled':
    '下一章将在 {nextReleaseAt, date} 当中发布于 {nextReleaseAt, time}!',
  ...
  'reader.nextChapterEstimation.verySoon':
    '基於最近 {chaptersCount, number} 章節的發布日期，下一章預計很快就會發布。',
  'reader.nextChapterEstimation.days':
    '基於最近 {chaptersCount, number} 章節的發布日期，下一章預計在大約 {daysLeft, plural, one {1天} other {天}}後可用。',
  'reader.nextChapterEstimation.notEnoughChapters':
    '一旦這個故事有超過一章時，我們也會提供下一章可能發布的一個估計。',
}
