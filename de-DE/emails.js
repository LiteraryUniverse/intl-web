...
export default {
  ...
  'email.enrollAccount.messageHtml':
    'Wir möchten Sie zu Literary Universe einladen! Wir haben ein persönliches Konto für Sie eingerichtet, mit dem Sie auf alle Funktionen von Literary Universe zugreifen können! Bitte schließen Sie sich uns an, um die nächste Generation des kreativen Schreibens und Lesens zu schaffen!',
  ...
  'email.verifyEmail.messageHtml':
    'Wir freuen uns, Sie an Bord zu haben! Bitte klicken Sie auf die Schaltfläche unten, um diese E-Mail-Adresse zu verifizieren.',
