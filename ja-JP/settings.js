export default {
  ...
  'settings.languages.notice':
    '英語とチェコ語は現在、公式にサポートされている言語です。その他の言語は、素晴らしいボランティアとAI翻訳のおかげで利用可能ですが、場所によってはまだ完璧でなく、正確ではない可能性があります。',
  'settings.languages.join':
    'サポートいただけるようであれば、Lieterary Universeの翻訳をお願いいたします。',
  ...
  'settings.export.explain':
    'これにより、私たちのデータベースに保存されているすべてのデータをjson形式で取得することができます。',
  ...
  'settings.legal.export.gathering':
    'あなたのデータを収集しています。しばらく時間がかかる場合があります。',
  'settings.gender.title': '性別',
  'settings.gender.usage':
    'この情報は非公開となります。このデータは、プラットフォームの分析や、クリエーターのストーリを読んだ際、匿名で分析に使用します。',
  'settings.age.title': 'あなたの年齢',
  'settings.age.explicit': '露骨な内容の表示（評価年齢21以上）',
  'settings.age.usage':
    'この情報は非公開です。当社では、お客様の年齢をお伺いすることが法的に義務付けられています。当社はこのデータを、プラットフォーム分析、評価に基づくコンテンツの表示、およびお客様がクリエイターのストーリーを読んだときの匿名化された分析に使用します。',
  'settings.country.title': 'あなたの国',
  'settings.country.usage':
    '当社は、政府からの問い合わせに対応するために、お客様の国を尋ねることが法的に義務付けられています。当社は、このデータをプラットフォーム分析や、クリエイターがストーリーを読んだ際の匿名化された分析に使用します。ご希望であれば、この情報をご自身のプロフィールに表示することができます。',
  ...
  'settings.2fa.explained':
    '二要素認証は、ログイン時に追加の認証ステップを設けることで、お客様のアカウントのセキュリティをさらに強化します。これにより、最初のログインステップが侵害された場合、悪意のある行為者がお客様のアカウントにアクセスするのを防ぐことができます。',
  'settings.2fa.otpTitle': 'OTP',
  'settings.2fa.otpExplained':
    'OTPコードによる二要素認証は、ログイン時に入力する認証アプリケーション（Authy、Google/Microsoft Authenticatorなど）によりワンタイムパスワードを作成します。',
  ...
  'settings.2fa.codeHeading':
    'QRコードが読み取れない場合は、以下のコードを手動で入力してください。',
  'settings.2fa.instructionsTitle': '説明書',
  'settings.2fa.instructions1':
    'お好みの認証アプリケーション（Authy、Google/Microsoft Authenticator、FreeOTPなど）をインストールし、開いてください。',
  'settings.2fa.instructions2':
    '「アカウントの追加」を選択します（「+」アイコンが表示されるか、メニューに隠れている場合があります）',
  'settings.2fa.instructions3':
    '画面上に表示されたQRコードを読み取るか、それができない場合は以下のコードを入力してください。',
  ...
  'settings.web3.explained':
    'Web3暗号ウォレットをLeterary Universeのアカウントに接続することができます。一度接続すると、あなたのウォレットでログインすることができ、今後、私たちがWeb3で提供するものを拡大することで、将来的にはもっと多くのことができるようになります。',
  ...
  'settings.web3.verify.explained':
    'このアドレスがお客様のものであることを検証するにあたり、このウォレットの所有者があなたかどうかを確認するための署名をお願いしています。',
  'settings.web3.verified': '確認されました。',
  'settings.web3.verificationMessage':
    'Lieterary Universeのユーザー{username}を検証しています。コード：　{code}',
  'settings.web3.unlink': 'ウォレットの削除',
  'settings.web3.linkingMessage':
    'Lieterary Universeにウォレットを接続することを確認してください。コード：　{code}',
  'settings.web3.linkError':
    'このアドレスはすでに私たちのデータベースに登録されており、割り当てることができません。',
  // Reader settings
