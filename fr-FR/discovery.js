export default {
  ...
  'story.estimatedReadingTime.explained':
    'Basé sur une vitesse de lecture moyenne de {avgReadingNum, number} mots par minute.',
  ...
  'discover.includesAds':
    "Cette œuvre comporte un placement de produit ou inclut d'autres formes de publicité.",
