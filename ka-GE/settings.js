export default {
    ...
    'settings.export.explain': 'ეს საშუალებას მოგცემთ, მიიღოთ თქვენი ყველა მონაცემი, რომელიც ჩვენს მონაცემთა ბაზაშია შენახული json ფორმატში.',
    'settings.export.submit': 'მონაცემების ექსპორტი',
    'settings.delete.title': 'ანგარიშის წაშლა',
    'settings.delete.warning': `გაფრთხილება: ანგარიშის წაშლით თქვენ დაკარგავთ წვდომას ამ ანგარიშზე და მისამართზე
    . მისი აღდგენის საშუალება არ არსებობს. გაითვალისწინეთ, რომ ეს შეიძლება ავტომატურად არ წაშალოს თქვენი გამოქვეყნებული ნამუშევრები,
    კომენტარები და ა.შ. დეტალებისთვის, გთხოვთ, იხილოთ მომსახურების პირობები.`,
