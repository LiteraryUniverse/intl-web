export default {
  ...
  'settings.languages.notice':
    'ਅੰਗਰੇਜ਼ੀ ਅਤੇ ਚੈਕ ਹੁਣ ਤੱਕ ਮਾਨਿਆ ਗਿਆ ਹੀ ਸਮਰਥਿਤ ਭਾਸ਼ਾਵਾਂ ਹਨ। ਹੋਰ ਭਾਸ਼ਾਵਾਂ ਦੀ ਉਪਲਬਧਤਾ ਮਹਾਨ ਸਵੈ-ਸੇਵਕਾਂ ਅਤੇ ਐਚਆਈ ਅਨੁਵਾਦ ਦੇ ਕਾਰਨ ਹੈ, ਪਰ ਇਹ ਹਾਲਾਤ ਵਿੱਚ ਅਧੂਰੇ ਅਤੇ ਗਲਤ ਵੀ ਹੋ ਸਕਦੀਆਂ ਹਨ।',
  'settings.languages.join':
    'ਜੇ ਤੁਸੀਂ ਸਾਨੂੰ ਮਦਦ ਕਰਨਾ ਚਾਹੁੰਦੇ ਹੋ, ਤਾਂ ਤੁਸੀਂ ਲਿਟਰੇਰੀ ਯੂਨੀਵਰਸ ਨੂੰ ਵੀ ਅਨੁਵਾਦਿਤ ਕਰ ਸਕਦੇ ਹੋ।',
  ...
  'settings.web3.verify.explained':
    'ਇਹ ਪਤਾ ਤੁਹਾਡੇ ਨਾਲ ਸਬੰਧਿਤ ਹੈ ਜੋ ਤੁਹਾਡੇ ਵਾਲੇ ਦੀ ਮਾਲਕੀ ਦਾ ਯਕੀਨ ਕਰਨ ਲਈ ਸਨੈਕ ਕਰਨ ਲਈ ਸਵਾਲ ਕਰੇਗਾ।',
  'settings.web3.verified': 'ਪੁਸ਼ਟੀ ਕੀਤੀ',
  'settings.web3.verificationMessage':
    'ਲਿਟਰੇਰੀ ਯੂਨੀਵਰਸ ਲਈ ਯੂਜ਼ਰ {username} ਦੀ ਪੁਸ਼ਟੀ ਕੀਤੀ ਜਾ ਰਹੀ ਹੈ। ਕੋਡ: {code}',
  'settings.web3.unlink': 'ਵਾਲੇਟ ਹਟਾਓ',
  'settings.web3.linkingMessage':
    'ਕਿਰਪਾ ਕਰਕੇ ਪੁਸ਼ਟੀ ਕਰੋ ਕਿ ਤੁਸੀਂ ਆਪਣੇ ਵਾਲੇਟ ਨੂੰ ਲਿਟਰੇਰੀ ਯੂਨੀਵਰਸ ਨਾਲ ਲਿੰਕ ਕਰਨਾ ਚਾਹੁੰਦੇ ਹੋ। ਕੋਡ: {code}',
  'settings.web3.linkError':
    'ਇਹ ਪਤਾ ਪਹਿਲਾਂ ਤੋਂ ਹੀ ਸਾਡੇ ਡਾਟਾਬੇਸ ਵਿੱਚ ਦਰਜ ਕੀਤਾ ਗਿਆ ਹੈ ਅਤੇ ਕਦੇ ਨਹੀਂ ਦਿੱਤਾ ਜਾ ਸਕਦਾ!',
  // Reader settings
