export default {
  ...
  'workshop.universe.publishing.notice':
    'Если вы не опубликуете вселенную, она будет опубликована автоматически, когда будет опубликована первая история, связанная с этой вселенной.',
  'workshop.universe.settings': 'Настройки вселенной {universe}',
  'workshop.universe.publishedOn':
    'Эта вселенная была опубликована {date, date, long} {date, time, short}',
  ...
  'workshop.universe.rating.desc':
    'Истории и фанфики выше этого рейтинга будут скрыты от просмотра на странице вселенной анонимными пользователями и пользователями, не достигшими соответствующего возраста.',
  ...
  'workshop.story.cannon.desc.create':
    'Эта история будет создана как каноническая история во вселенной {universe}.',
  'workshop.story.fanfiction.search':
    'Введите название вселенной (она должна быть в вашей библиотеке). Затем выберите из предложенных вариантов.',
  ...
  'workshop.story.error.fanfiction.selectuniverse':
    'Вы должны выбрать оригинальную вселенную для своего фанфика!',
  ...
  'workshop.story.publishing.notice':
    'История будет опубликована автоматически после публикации первой главы.',
  'workshop.settings.edit': 'Изменить настройки',
  'workshop.story.publishedOn':
    'Эта история была опубликована {date, date, long} {date, time, short}',
  ...
  'workshop.translation.updatedOrig':
    'Последнее обновление оригинала: {updatedAt, date, long} {updatedAt, time, medium}',
  'workshop.translation.updatedTrs':
    'Последнее обновление перевода: {updatedAt, date, long} {updatedAt, time, medium}',
  'workshop.translation.revisionOrig':
    'Последний пересмотр {revision, number}, оригинала: {updatedAt, date, long} {updatedAt, time, medium}',
  'workshop.translation.revisionTrs':
    'Последний пересмотр {revision, number}, перевода: {updatedAt, date, long} {updatedAt, time, medium}',
  ...
  'workshop.fanfic.needUniverseInLibrary':
    'Существует множество вселенных. Пожалуйста, сначала добавьте те, в которых вы хотите писать, в свою библиотеку, чтобы мы могли их найти.',
  ...
  'workshop.beta.revisionInfo':
    'Этот пересмотр {revision, number}, создан {createdAt, date, long}.',
  ...
  'workshop.translation.premium':
    'Для того чтобы добавлять переводы, необходимо иметь как минимум подписку плана «Исследователь».',
  'workshop.story.finished': 'История завершена',
  'workshop.story.publishing.externalSellingNotice':
    'Поскольку вы продаёте за пределами Literary Universe, вы можете опубликовать историю сейчас. Ссылки на листинг вашего магазина появятся в истории или в конце текущей истории, которую вы опубликуете здесь.',
  ...
  'workshop.fictionalTime.linkedToET':
    'Начинается ли это время с земной даты (григорианский календарь)?',
  ...
  'workshop.shoppingExternal.explainer':
    'Если ваша история продаётся в другом месте, вы можете установить ссылки здесь. Тогда ссылки будут отображаться вместо содержания или в конце содержания, которое вы выбрали для предварительного просмотра.',
  ...
  'workshop.writerSidebar.description':
    'Добро пожаловать в вашу историю! Эта боковая панель позволяет вам легко получить доступ ко всем ресурсам, связанным с вашей историей. Отметьте значки выше, чтобы увидеть последние комментарии, ваши заметки и многое другое!',
  ...
  'workshop.webMonetization.explain':
    'Веб-монетизация будет перечислять вам платежи в зависимости от того, сколько времени пользователь тратит на ваш контент. В настройках монетизации вашего профиля вы можете установить свой собственный указатель платежей. Здесь вы можете решить, как разделить оплату с вашими соавторами, у которых включена функция веб-платежей. Literary Universe автоматически забирает 10%.',
  'workshop.webMonetization.revShare':
    'В связи с ограничениями веб-монетизации используется вероятностное распределение доходов. Вероятностное распределение доходов работает путём случайного выбора из списка предопределенных указателей платежей каждый раз, когда посетитель с веб-монетизацией загружает вашу страницу. Посетитель платит по выбранному указателю до тех пор, пока страница не будет перезагружена или закрыта.',
  'workshop.webMonetization.revShareMore':
    'Узнайте больше о вероятностном распределении доходов. Мы используем тот же код, что и на этой странице.',
  'workshop.story.notEligible.licence': `Лицензия истории не позволяет монетизацию.`,
  'workshop.universe.notEligible.licence': `Лицензия вселенной не позволяет монетизацию.`,
  'workshop.story.notEligible.fanFiction': 'Фанфики истории не подлежат монетизации.',
  'workshop.revShare.mustBe100': 'Доля должна равняться 100%',
  'workshop.revShare.LUCut': 'Literary Universe и платёжная система',
  ...
  'workshop.revShare.origLangCreators': 'Авторы оригинального языка',
  ...
  'workshop.universe.forum': 'Внутренний форум {universeName}',
  'workshop.ratingAdjusted':
    'В связи с жалобами нам пришлось изменить ваш рейтинг на тот, который мы считаем подходящим. В связи с этим изменение рейтинга теперь отключено.',
  ...
  'workshop.universe.isAIGeneratedTooltip':
    'Пожалуйста, сообщите нам, если какой-либо контент во вселенной был создан искусственным интеллектом или с его помощью. Мы используем эту информацию для правильной маркировки, и из-за того, как создаются программы искусственного интеллекта, могут существовать некоторые ограничения и запреты.',
  'workshop.story.isAIGenerated': 'Создана ли история искусственным интеллектом?',
  'workshop.story.isAIGeneratedTooltip':
    'Пожалуйста, сообщите нам, если какая-либо из историй была создана искусственным интеллектом или с его помощью. Мы используем эту информацию для правильной маркировки, и в связи с тем, как создаются программы искусственного интеллекта, могут существовать некоторые ограничения и запреты.',
  'workshop.publicationAgreement.aria': 'Соглашение о публикации произведения',
  'workshop.publicationAgreement.intro':
    'Мы рады, что вы решили опубликовать свою творческую работу у нас. Прежде чем мы продолжим, мы просим вас ознакомиться с нашим соглашением о публикации, чтобы понять, что оно означает с юридической стороны.',
  ...
  'workshop.statusExplain.hiatus1':
    'Приостановлено означает, что вы на некоторое время прекращаете работу над этой историей по какой-либо причине. Это означает, что читателям не следует ожидать новых обновлений в ближайшие недели или даже несколько месяцев.',
  'workshop.statusExplain.hiatus2':
    'Приостановленное состояние будет автоматически снято, если вы опубликуете любую главу. Или вы можете изменить его самостоятельно.',
  'workshop.statusExplain.hiatus3':
    'Если вы продержите свою историю в приостановленном состоянии в течение шести месяцев, мы автоматически пометим её как отменённую.',
  'workshop.statusExplain.cancelled1':
    'Мы сожалеем, что вы не можете продолжать работу над историей. С другой стороны, мы рады, что вы готовы сообщить об этом своим читателям.',
  'workshop.statusExplain.cancelled2':
    'Отмена истории даст вашим читателям понять, что им не стоит ожидать новых обновлений.',
  'workshop.statusExplain.cancelled3':
    'Это всегда можно исправить, опубликовав главу или изменив состояние.',
  'workshop.statusExplain.finished1':
    'Поздравляем! После столь напряжённой работы вы наконец-то достигли конца невероятного путешествия. Мы надеемся, что в будущем вас ждут новые истории, а пока расслабьтесь и наслаждайтесь заслуженным отдыхом.',
  'workshop.statusExplain.finished2':
    'Пометка истории как завершённой сообщит читателям, что история закончена. Хотя вам не следует добавлять новые главы, мы не будем вас останавливать, и добавление специальных глав - неплохая идея, например, добавить эпилоги для всех персонажей.',
  'workshop.statusExplain.finished3':
    'Хотя вы всегда можете отменить это состояние, мы настоятельно рекомендуем этого не делать. Если история должна продолжаться, лучше начать новую.',
  ...
  'workshop.statusChangeEmail.hiatusTitle':
    'Состояние вашей истории было автоматически переведено в приостановленное',
  'workshop.statusChangeEmail.hiatusIntro':
    'В связи с неактивностью состояние вашей истории было автоматически переведено в состояние «Приостановлено».',
  'workshop.statusChangeEmail.hiatusWhy':
    'В связи с отсутствием новых глав в течение более 6 месяцев она была автоматически приостановлена.',
  'workshop.statusChangeEmail.hiatusWhatFollows':
    'Это состояние будет автоматически снято, если вы опубликуете новую главу. Если вы не опубликуете новую главу в течение следующих 6 месяцев, мы автоматически поставим истории состояние «Отменено».',
  'workshop.statusChangeEmail.cancellationIntro':
    'Состояние вашей истории было автоматически установлено на отменённую.',
  'workshop.statusChangeEmail.cancellationWhy':
    'Это произошло потому, что вы не разместили ни одной новой главы в истории с тех пор, как она получила состояние «Приостановлено» 6 месяцев назад. Таким образом, после года бездействия мы автоматически переводим истории в разряд отменённых, чтобы читатели знали, какие рассказы истории.',
  'workshop.statusChangeEmail.cancellationWhatFollows':
    'Это состоние будет автоматически снято, если вы опубликуете новую главу. Если вы больше не планируете работать над этой историей, то вам больше ничего не нужно делать.',
  ...
  'workshop.videoTrailer.rumble':
    'Мы также поддерживаем Rumble, но не забудьте скопировать URL IFRAME.',
  'workshop.videoTrailer.suggestPlatforms':
    'Если ваша видеоплатформа отсутствует, дайте нам знать через нашу <a>обратную связь</a>!',
}
