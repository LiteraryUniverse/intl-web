...
export default {
  ...
  'rating.name': '年齢格付け',
  'rating.explained': '年齢格付けと制限',
  'rating.all': 'すべてのために',
  'rating.desc.all': 'すべての年齢やグループにアクセス可能',
  'rating.teens': 'Teens',
  ...
  'payments.changeMethod': 'お支払い方法の変更',
  'plans.subscribed.willNotRenew': ', will not renew at the end of the cycle.',
  'plans.cancel.button': 'サブスクリプションをキャンセルする',
  ...
  'plans.cancel.restoreBtn': 'サブスクリプションを復元する',
  ...
  'feedback.report.submit': '報告する',
  'feedback.report.submitting': '報告...',
  'feedback.report.violationDesc': '詳細',
  'feedback.report.reportSaved': '報告ありがとうございます！ 調査を行い、必要に応じて対応いたします。',
  'feedback.report.copyrightReportSaved': '報告ありがとうございます！ 調査して連絡させていただきます。',
  // Added 2020-11-14
  ...
  // Added 2021-02-18
  'feedback.report.copyrightOwnershipDesc': '所有権声明',
  'feedback.report.copyrightNotice': 'このフォームを使用するには、作品の正当な所有者である必要があることに注意してください。 あなたが所有者でない場合は、所有者に通知するか、「その他」のカテゴリを使用して通知してください。 私たちは著作権侵害を非常に深刻に受け止めており、このフォームの不適切で乱用的な使用にも同じことが当てはまります。',
  'feedback.report.copyrightInternalProperty': 'この作品を文学宇宙に掲載しました。',
  'feedback.reportType.spam': 'スパムまたはフィッシング',
