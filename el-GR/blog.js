export default {
    ...
    'blog.qa.references.title': 'Αναφορές',
    'blog.qa.references.add': 'Προσθήκη αναφοράς',
    'blog.qa.references.sectionTitle': 'Σχετικό περιεχόμενο',
    'blog.qa.reference.encyclopedia': 'Εγκυκλοπαίδεια: {title}',
    'blog.qa.reference.story': 'Ιστορία: {title}{chapter}',
    'blog.qa.reference.chapter': ' (Κεφάλαιο: {chapterTitle})',
    'blog.qa.reference.blogPost': 'Δημοσίευση στο blog: {title}',
    'blog.qa.reference.type.encyclopedia': 'Εγκυκλοπαίδεια',
    'blog.qa.reference.type.story': 'Ιστορία',
    'blog.qa.reference.type.blog': 'Δημοσίευση στο blog',
    'blog.qa.reference.chapter.option': 'Κεφάλαιο {sequence}',
    'blog.qa.reference.chapter.untitled': 'Κεφάλαιο χωρίς τίτλο',
    'blog.qa.reference.chapter.placeholder': 'Επιλέξτε ένα κεφάλαιο...',
    'blog.qa.reference.line': '{typeLabel} - {title}{chapterPart}',
    'blog.qa.reference.type': '{type, select, encyclopedia {📚 Εγκυκλοπαίδεια} story {📖 Ιστορία} blog {📝 Blog} other {Αναφορά}}',
    'blog.qa.outdated.title': 'Ξεπερασμένη κατάσταση',
    'blog.qa.outdated.marked': 'Αυτή η ερώτηση χαρακτηρίζεται ως ξεπερασμένη.',
    'blog.qa.outdated.replacement': 'Αντικαταστάθηκε από ερώτηση:',
    'blog.qa.outdated.unmark': 'Χαρακτηρίστε ως τρέχον',
    'blog.qa.outdated.mark': 'Χαρακτηρίστε ως ξεπερασμένο',
    'blog.qa.outdated.confirm': 'Χαρακτηρίστε ως ξεπερασμένο',
    'blog.qa.outdated.replacementPlaceholder': 'Ερώτηση αντικατάστασης αναζήτησης...',
    'blog.qa.outdated.notice': 'Αυτή η απάντηση μπορεί να είναι ξεπερασμένη.',
    'blog.qa.outdated.seeReplacement': 'Βλέπε ενημερωμένη απάντηση στην ερώτηση {question}.',
    // Q&A Public
