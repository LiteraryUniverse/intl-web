export default {
  ...
  'encyclopedia.help.text':
    'Använd menyn till vänster för att navigera mellan objekten i encyklopedin. När du väljer ett objekt kommer det att visas istället för denna text.',
  ...
  'encyclopedia.container.desc':
    'Gör denna post till en behållare för en ny grupp av poster. Detta kommer att gömma den från kategorilistan.',
  'encyclopedia.entry.name': 'Namn på posten',
  'encyclopedia.summary': 'Sammanfattning',
  'encyclopedia.summary.desc':
    'Detta är en sammanfattning som kommer att vara den enda initiala informationen som visas för läsaren.',
  ...
  'encyclopedia.translation.desc':
    'Detta encyklopedi gränssnitt används för översättning till {language}. Välj befintliga poster i listan till vänster för att börja översätta dem.',
  ...
  'encyclopedia.settings.categoriesDesc':
    'Aktivera och inaktivera kategorier som du vill använda i din encyklopedi.',
  'encyclopedia.settings.introText':
    'Välkomstmeddelande som ska visas efter universums beskrivning.',
  ...
  'enc.entries.limit': `Du har för närvarande {value, number} av {max, plural,
    =0 {obegränsade}
    other {{max, number}}
  } poster.`,
  'enc.entries.limitReached':
    'Du har nått det maximala antalet tillåtna uppslagsverksposter för din nuvarande prenumeration.',
  ...
  'encyclopedia.settings.templateDescription':
    'Tillåt att innehållet i denna encyklopedi kopieras till andra universum. Detta är bäst om du inte har några berättelser och istället bara skapar en mall för andra att använda.',
  ...
  'encyclopedia.templateCopy.description':
    'Kopiera innehållet i denna encyklopedi till ditt universum för att berika det.',
