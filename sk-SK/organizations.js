export default {
  ...
  'org.invitesTileNotice':
    'Boli ste pozvaní do {count, number} {count, plural, one {organizácie} other {organizácií}}',
  ...
  'org.invitePage.ignoring':
    'Túto pozvánku momentálne ignorujete, čo znamená, že je stále aktívna, ale neobťažuje upozorneniami.',
  'org.invitePage.expiresAt':
    'Platnosť tejto pozvánky uplynie v {expiresAt, date, short} {expiresAt, time}',
  ...
  'org.leaveOrg.confirm':
    'Ide o deštruktívnu činnosť. Po odchode stratíte akýkoľvek prístup do tejto organizácie. Ste si istí, že chcete opustiť túto organizáciu?',
