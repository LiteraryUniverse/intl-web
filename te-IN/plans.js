export default {
  ...
  'plans.subscription.title': 'చందావారం',
  ...
  'plans.current.buying':
    'మీ కొనసాగింపుని ధృవీకరించడానికి కొనసాగింపు కొరకు కొంత క్షణాలు పడుతుంది. మేము మీ సహనం కోసం కృతజ్ఞతలు చెబుతాము.',
  'plans.current.heading': 'ప్రస్తుత చందావారం ప్రణాళిక',
  'payment.methods.title': 'చెల్లింపులు & ఆదాయకారణ',
  ...
  'payment.option.description':
    'ఇక్కడ మీ సేవ్ చేసే చెల్లింపు విధుల జాబితా ఉంది. మీరు వాడుక చేయడానికి ఇక్కడ కొత్త చెల్లింపు విధులను జోడించవచ్చు. క్రెడిట్ కార్డ్ సంఖ్యను కొనసాగించడం వంటి మీ చెల్లింపు విధుల నమోదులు లిటరరీ యూనివర్స్‌లు సేవలు చేయనివి లేవు.',
  ...
  'payments.disclaimer':
    'చెల్లింపు సమాచారం మరియు ప్రాసెసింగ్ స్ట్రైప్ ద్వారా చేయబడుతుంది. మా సర్వర్లు క్రెడిట్ కార్డు లేదా బ్యాంకు ఖాతా సమాచారం ఎవరికినైనా ఉండుకోలేవు.',
  ...
  'payment.webMonetization.explained':
    'వెబ్ మోనెటైజేషన్ వెబ్ చెల్లనిపై చెల్లింపుల కోసం ఒక స్టాండర్డ్ ప్రస్తావితం ఉంది. ఇక్కడ మీరు మీ చెల్లని పాయింటర్ జోడించాలనుకుంటారు, అప్పుడు ఈ పాయింటర్ మీ ప్రొఫైల్ పేజీ, బ్లాగ్, యూనివర్స్ మరియు కథలకు వెబ్ మోనెటైజేషన్ ద్వారా ఉపయోగించబడినట్లయినది.',
  ...
  'stripeConnect.settings.ongoing':
    'మీ ఖాతాపై స్ట్రిప్ నుండి మీకు తిరిగి వినండి కోసం మాకు వేచించడం కావచ్చు. ఇది కొంచెం సమయం పడుతుంది. ఇది చాలా కాలం పడుతుందాన్ని అనుకుంటే క్రింది బటన్‌ను క్లిక్ చేయండి, అది మీకు తిరిగి స్ట్రిప్‌కు తీసుకోగలదు.',
  ...
  'payment.donations.payNowUSD':
    '{donation, number, ::compact-short currency/USD} కు దానం చేయండి {username}కు',
  'payment.donations.payNowJPY':
    '{donation, number, ::compact-short currency/JPY} కు దానం చేయండి {username}కు',
  'payment.donations.payNowEUR':
    '{donation, number, ::compact-short currency/EUR} కు దానం చేయండి {username}కు',
  ...
  'payment.universe.haveFans':
    'మీకు ప్రాముఖ్యత ఉందానారో వారిని మీరు మీ పనిని ఆకర్షించడం సులభం. 100 అభిమానాలు మీ యూనివర్స్‌ను తమ లైబ్రరీకి జోడించడం ప్రారంభ రేఖ.',
  ...
  'payment.fanClub.priceBreakdown':
    'సభ్యుడు చెల్లించినది: {amount}। ప్లాట్‌ఫారం ఫీ {fee} ఉంది, మీరు పొందుతారు: {net}',
  'payment.feeNotice':
    'దయచేసి గమనించండి, ఇది ఒక అందించడం మాత్రమే మరియు వాస్తవంగా ఫీ వివరము విభిన్న చెల్లని పేమెంట్ రకం మరియు పే గేట్ నుండి వచ్చే అదనపు ధరల ఆధారంగా మారవచ్చు.',
