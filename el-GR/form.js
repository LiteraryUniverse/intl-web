export default {
  ...
  'form.weakPassword':
    'Αυτός ο κωδικός φαίνεται αδύναμος. Παρακαλώ λάβετε υπόψη να τον κάνετε πιο ισχυρό προσθέτοντας αριθμούς και ειδικούς χαρακτήρες.',
  ...
  'simpleschema.maxString':
    'To πεδίο {label} δεν μπορεί να υπερβαίνει τους {max, number} χαρακτήρες',
  ...
  'simpleschema.minNumberExclusive':
    'To πεδίο {label} πρέπει να είναι μεγαλύτερο από {min, number}',
