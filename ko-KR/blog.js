export default {
    ...
    'blog.qa.references.title': '참조',
    'blog.qa.references.add': '참조 추가',
    'blog.qa.references.sectionTitle': '관련 콘텐츠',
    'blog.qa.reference.encyclopedia': '백과사전 항목: {title}',
    'blog.qa.reference.story': '스토리: {title}{chapter}',
    'blog.qa.reference.chapter': ' (챕터: {chapterTitle})',
    'blog.qa.reference.blogPost': '블로그 게시물: {title}',
    'blog.qa.reference.type.encyclopedia': '백과사전 항목',
    'blog.qa.reference.type.story': '스토리',
    'blog.qa.reference.type.blog': '블로그 게시물',
    'blog.qa.reference.chapter.option': 'Chapter {sequence}',
    'blog.qa.reference.chapter.untitled': '제목 없는 장',
    'blog.qa.reference.chapter.placeholder': '챕터 선택...',
    'blog.qa.reference.line': '{typeLabel} - {title}{chapterPart}',
    'blog.qa.reference.type': '{type, select, encyclopedia {📚 백과사전} story {📖 스토리} blog {📝 블로그} other {참고자료}}',
    'blog.qa.outdated.title': '오래된 상태',
    'blog.qa.outdated.marked': '이 질문은 오래된 질문으로 표시되어 있습니다.',
    'blog.qa.outdated.replacement': '질문으로 대체되었습니다:',
    'blog.qa.outdated.unmark': '현재로 표시',
    'blog.qa.outdated.mark': '오래된 것으로 표시',
    'blog.qa.outdated.confirm': '오래된 것으로 표시',
    'blog.qa.outdated.replacementPlaceholder': '대체 질문 검색...',
    'blog.qa.outdated.notice': '이 답변은 오래되었을 수 있습니다.',
    'blog.qa.outdated.seeReplacement': '질문의 업데이트된 답변 참조 {question}.',
    // Q&A Public
    'blog.qa.title': '질문',
