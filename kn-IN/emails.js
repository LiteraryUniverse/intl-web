...
export default {
  ...
  'email.resetPassword.messageHtml':
    'ನಿಮ್ಮ ಖಾತೆಗೆ ನಿಮ್ಮ ಪಾಸ್ವರ್ಡ್ ಮರುಹೊಂದಿಸಲು ಒಂದು ವಿನಂತಿ ಬಂದಿದೆ, ಈ ಪ್ರಕ್ರಿಯೆಯನ್ನು ಮುಂದುವರಿಸಲು ದಯವಿಟ್ಟು ಕೆಳಗಿನ ಬಟನ್ ಕ್ಲಿಕ್ ಮಾಡಿ. ಈ ವಿನಂತಿಯನ್ನು ನೀವು ಮಾಡಿಲ್ಲದಿದ್ದರೆ, ಈ ಇಮೇಲ್ ಅನದಿಕ್ಕು ಬಿಡಿಬಿಡಿಯಿರಲು ಸಮಯವಿದೆಯೇ ಎಂದು ನೋಡುವುದು ಒಳ್ಳೆಯದಿರಬಹುದು.',
  'email.resetPassword.button': 'ಪಾಸ್ವರ್ಡ್ ಮರುಹೊಂದಿಸಿ',
  // E-mail verification
  'email.verifyEmail.messageHtml':
    'ನಮ್ಮಲ್ಲಿ ನೀವು ಇರುವುದಕ್ಕೆ ಸಂತೋಷವಾಗಿದೆ! ದಯವಿಟ್ಟು ಈ ಇಮೇಲ್ ವಿಳಾಸವನ್ನು ಪರಿಶೀಲಿಸಲು ಕೆಳಗಿನ ಬಟನ್ ಕ್ಲಿಕ್ ಮಾಡಿ.',
