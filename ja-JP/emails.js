...
Literary Universeチーム`,
    'email.adminUpgrade.messageHtml': `お客様のアカウントを次の{days, number}日間、{plan, select,
    explorer {Explorer}
    adventurer {Adventurer}
    storyteller {Storyteller}
    other {}
  } プランにアップグレードしました。お楽しみください！`,
    'email.verification': 'メールアドレスの認証',
    'email.verifying': 'メールアドレスを確認しています。しばらくお待ちください...',
    'email.verified': '良いお知らせです。あなたのメールアドレスが確認されました！',
    // The Way (Author Level Up)
    'theWay.levelUp.emailSubject': 'おめでとうございます！Literary Universeで著者レベル{level, number}に到達しました！',
    ...
    'email.notifications.collabInvite.subject': '{inviterName} {role} として、"{targetTitle}"でのコラボレーションに招待された。',
    'email.notifications.collabInvite.title': 'コラボレーションにご招待します！',
    'email.notifications.collabInvite.details': '招待者 {inviterName} - 役割 {role} - {targetType}: {targetTitle}',
    'email.notifications.collabInvite.cta': 'レビュー招待',
    // Notifications - Organization invitation
    'email.notifications.orgInvite.subject': '{inviterName}{orgName} " に招待された。',
    'email.notifications.orgInvite.title': '{orgName} ！',
    'email.notifications.orgInvite.details': '招待者 {inviterName}',
