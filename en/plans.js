export default {
  ...
  'plans.subscription.pendingSetup':
    'Creator setup in progress. Please try again later.',
  ...
  'payment.author.directivesPersonalBlog':
    'Keep a personal blog to engage readers with regular updates.',
  'payment.author.fansCount': 'Have some fans that you can reach out to. {fans, number}/100',
  'payment.fanClub.qa.extraQuestionsLabel':
    'Extra Q&A questions for members',
  'payment.fanClub.qa.extraQuestionsDescription':
    'Members of this tier can ask additional questions on your blog Q&A beyond their default allowance.',
  'plans.benefits.qa.extraQuestionsTitle': 'Extra Q&A questions',
  'plans.benefits.qa.extraQuestionsCount':
    '{count, plural, one {# extra question per year} other {# extra questions per year}}',
  'plans.benefits.blogPostsQueued': 'Exclusive blog posts waiting',
  'plans.benefits.blogPostsQueuedCount':
    '{count, plural, one {# post ready to read} other {# posts ready to read}}',
  ...
  'plans.fanClub.thankYou.subtitle':
    'Your membership helps this creator dedicate more time to worldbuilding, stories, and community events.',
  'plans.fanClub.thankYou.intro':
    'Welcome aboard! Every contribution keeps the creative lights on and brings new chapters, art, and behind-the-scenes moments to life.',
  ...
  'plans.fanClub.access.subtitle':
    'Everything your current membership in this fan club unlocks right now.',
  ...
  'plans.fanClub.settings.subtitle':
    "See every fan club you support or have supported, jump into current member access, and keep each subscription's status in view from one place.",
  ...
  'plans.fanClub.settings.emptyText':
    "When you join a creator's fan club, it will appear here with quick access to the club page, your member benefits, and its current status.",
  'plans.fanClub.settings.ownerFallback': '{type} fan club',
  'plans.fanClub.settings.tierFallback':
    'Your current tier for this fan club.',
  ...
  'plans.benefits.earlyAccess.description':
    'Allow subscribers of this tier to access chapters earlier than the public.',
  ...
  'plans.benefits.earlyAccess.scopeHelp':
    'Leave empty to apply to all your stories. Selecting any stories limits early access only to those.',
  ...
  'plans.benefits.storyAccess.description':
    'Grant subscribers of this tier access to selected paid or private stories.',
  ...
  'plans.benefits.storyAccess.selectStoriesHelp':
    'Only paid and private stories are shown. Select which stories this tier grants access to.',
  'plans.benefits.storyAccess.accessMode': 'Access mode',
  'plans.benefits.storyAccess.temporary': 'Temporary access',
  'plans.benefits.storyAccess.temporaryDescription':
    'Subscriber can read while their subscription is active. Access ends when subscription expires.',
  'plans.benefits.storyAccess.earnedPermanent': 'Earned permanent access',
  'plans.benefits.storyAccess.earnedPermanentDescription':
    "Access starts as temporary. After continuous subscription for the specified months, the story is permanently added to the subscriber's library.",
  'plans.benefits.storyAccess.immediatePermanent': 'Immediate permanent access',
  'plans.benefits.storyAccess.immediatePermanentDescription':
    "Story is permanently added to the subscriber's library upon joining this tier.",
  'plans.benefits.storyAccess.earnedAfterMonthsLabel': 'Months until permanent',
  'plans.benefits.storyAccess.earnedAfterMonthsHelp':
    "After this many months of continuous subscription, the story is permanently added to the subscriber's library.",
  ...
  'plans.fanClub.access.storyAccessSubtitle':
    'Paid and private stories your membership gives you access to.',
  ...
  'plans.fanClub.access.emptyStoryAccess':
    'No story access benefits are attached to your membership yet.',
