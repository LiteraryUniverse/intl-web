export default {
  'genre.scifi': 'സയന്‍സ് ഫിക്ഷന്‍',
  'genre.fantasy': 'ഫാന്‍റസി',
  'genre.adventure': 'അഡ്വെഞ്ചര്‍',
  'genre.poetry': 'കവിത',
  'genre.comedy': 'കോമഡി',
  'genre.drama': 'നാടകം',
  'genre.nonfiction': 'അനുഭവഗ്രന്ഥം',
  'genre.fiction': 'കഥാപാത്രം',
  'genre.romance': 'റൊമാന്‍സ്',
  'genre.satire': 'സാതിര്‍',
  'genre.tragedy': 'ത്രാജിഡി',
  'genre.crime': 'Crime',
  'genre.historical': 'ഐതിഹ്യം ചരിത്രകഥ',
  'genre.horror': 'ഹൊററിന്‍',
  'genre.mystery': 'രഹസ്യകഥ',
  'genre.thriller': 'ത്രില്ലര്‍',
  'genre.western': 'പശ്ചിമഘട്ടം',
  'genre.memoir': 'നിസ്മരണകഥ',
  'genre.biography': 'ജീവചരിത്രം',
  'genre.steampunk': 'സ്റ്റീംപങ്ക്',
  'genre.mythology': 'മിഥോളജി',
  'genre.fairytale': 'പിടിയുകഥ',
  'genre.superhero': 'സൂപ്പര്‍ഹീരോ',
  ...
  'genre.fantasy.description':
    'മാന്ത്രികം, അസാധാരണ ഘടനകൾ, മിഥ്യാവസ്തുക്കൾ എന്നിവയെ ഉൾപ്പെടെയുള്ള ഒരു സാഹിത്യ ജാന്രമാണ് പ്രകടിപ്പിക്കുന്നത്, അനന്തമായ ലോകങ്ങളിൽ സജീവമായിരിക്കുന്നു. അതിനാൽ അതിന് ക്വെസ്റ്റുകൾക്കും നല്ലവരുടെ പോരാട്ടങ്ങൾക്കും വേണ്ടിയുള്ള കഥകൾ അതിനുള്ളതാണ്. മനുഷ്യർക്ക് നല്ലവരുടെ പോരാട്ടം, നല്ലവരുടെയും മനുഷ്യന്മാരുടെയും മനോഹരമായ പുതിയ രൂപങ്ങൾ അതിനുള്ളതാണ്. മനോനൈതികതയും നീതിയും പ്രധാനപ്പെട്ട വിഷയങ്ങളാണ് മാന്ത്രികം.',
  ...
  'genre.isekai.description':
    'ഈ ജാപാനീസ് ലൈറ്റ് നോവലുകളും, മാംഗയും, ആനിമേഷനുകളും അന്യലോകത്തേക്ക് അല്ലെങ്കിൽ വിവിധ ലോകത്തേക്ക് മാറിയതാണ് കഥാപാത്രം അടിമയാക്കിയത്. പ്രധാനപ്പെട്ടവയായി, പ്രതികളുടെ പുതിയ ലോകത്തുള്ള അനുഭവങ്ങളും പരിചയങ്ങളും നാവിഗേറ്റുചെയ്യാൻ ആഗ്രഹിക്കുന്ന പ്രതിരോധങ്ങൾക്കും ബന്ധപ്പെട്ട് പ്രധാനപ്പെട്ടവയാണ്. ഇവ കഥാപാത്രങ്ങളുടെ വിശേഷികളും പരിചയങ്ങളും പുതിയ കഥകളും വരുന്നുണ്ടാക്കുന്നുണ്ട്. ഇവ ഹാസ്യപ്രധാനമായാണ് അല്ലെങ്കിൽ കഠിനവും ആകാവുന്നത്, പക്ഷേ എല്ലാവർക്കും ക്ലാസിക് ആവന്റർ തീമകളുടെ പുതിയ മനോഹരമായ രൂപങ്ങളായി അഭിവർത്തിക്കുന്നു.',
}
