export default {
  ...
  'encyclopedia.help.text':
    '使用左側的菜單在百科全書的項目之間切換。一旦您選擇了一個項目，它將顯示在這段文字的位置。',
  'encyclopedia.help.sidebar': '側邊欄工具箱',
  'encyclopedia.help.sidebar.text':
    '歡迎來到您的故事！此側邊欄可讓您輕鬆存取與您的故事相關的所有資源。請查看上方的圖示以查看最新評論、您的筆記、搜尋百科全書、瀏覽並新增百科全書條目。如果您想要在故事文本中添加連結到一個條目，請選取您想要放置連結的文本，然後點擊連結按鈕。然後，您將被提示找到並選擇一個項目。',
  ...
  'encyclopedia.translation.desc':
    '此百科全書介面用於翻譯成 {language}。請在左側的列表中選擇現有條目開始翻譯。',
  ...
  'encyclopedia.settings.templateDescription':
    '允許將此百科全書的內容複製到其他宇宙中。如果您沒有任何故事，只是為他人創建一個範本，這是最好的選擇。',
