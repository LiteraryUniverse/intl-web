export default {
    ...
    'form.validator.email': 'Érvényes e-mail címnek kell lennie',
    'form.validator.url': 'Érvényes URL címnek kell lennie',
    'form.validator.slug': 'Érvényes résznek kell lennie az URL-ben',
    'form.submitting.signup': 'Fiók létrehozása...',
    'form.submitting.signin': 'Bejelentkezés...',
    'form.submitting.default': 'Küldés...',
    'form.submitting.sending': 'Küldés...',
    'form.validator.whitespace': 'Nem lehet szóköz',
    'form.validator.zipCode': 'Érvényes irányítószámnak kell lennie',
    'form.validator.isbn': 'Csak a 10 vagy 13 verziók elfogadottak az ISBN-nél',
    'form.validator.btc': 'Ez nem érvényes BTC cím.',
    'form.validator.eth': 'Ez nem érvényes ETH cím.',
    'form.weakPassword': 'A jelszó gyenge. Kérlek, fontold meg, hogy erősítsd meg a számok és speciális karakterek hozzáadásával.',
    ...
    'simpleschema.notUnique': '{label} egyedinek kell lennie',
