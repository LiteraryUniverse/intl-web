...
export default {
  ...
  'flashnews.onlyDisplayOn':
    'Správy sa budú zobrazovať len v jazykoch vybraných nižšie (ak sú vybrané), v iných jazykoch sa nebudú zobrazovať žiadne správy, dokonca ani v predvolenom jazyku.',
  ...
  'notification.workshopStoryStatus.toHiatus':
    'Vaša poviedka {storyName} bola automaticky nastavená na hiatus po 6 mesiacoch nečinnosti.',
  'notification.workshopStoryStatus.toCancelled':
    'Vaša príbeh {storyName} bol automaticky zrušený po jednom roku nečinnosti.',
