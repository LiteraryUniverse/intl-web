export default {
    ...
    'blog.qa.references.title': 'Referanslar',
    'blog.qa.references.add': 'Referans Ekle',
    'blog.qa.references.sectionTitle': 'İlgili İçerik',
    'blog.qa.reference.encyclopedia': 'Ansiklopedi maddesi: {title}',
    'blog.qa.reference.story': 'Hikaye: {title}{chapter}',
    'blog.qa.reference.chapter': ' (Bölüm: {chapterTitle})',
    'blog.qa.reference.blogPost': 'Blog Yazısı: {title}',
    'blog.qa.reference.type.encyclopedia': 'Ansiklopedi Girişi',
    'blog.qa.reference.type.story': 'Hikaye',
    'blog.qa.reference.type.blog': 'Blog Gönderisi',
    'blog.qa.reference.chapter.option': 'Bölüm {sequence}',
    'blog.qa.reference.chapter.untitled': 'İsimsiz bölüm',
    'blog.qa.reference.chapter.placeholder': 'Bir bölüm seçin...',
    'blog.qa.reference.line': '{typeLabel} - {title}{chapterPart}',
    'blog.qa.reference.type': '{type, select, encyclopedia {📚 Ansiklopedi} story {📖 Hikaye} blog {📝 Blog} other {Referans}}',
    'blog.qa.outdated.title': 'Güncel Olmayan Durum',
    'blog.qa.outdated.marked': 'Bu soru güncel değil olarak işaretlenmiştir.',
    'blog.qa.outdated.replacement': 'Soru ile değiştirildi:',
    'blog.qa.outdated.unmark': 'Güncel Olarak İşaretle',
    'blog.qa.outdated.mark': 'Güncel Değil Olarak İşaretle',
    'blog.qa.outdated.confirm': 'Güncel Değil Olarak İşaretle',
    'blog.qa.outdated.replacementPlaceholder': 'Yedek soruyu arayın...',
    'blog.qa.outdated.notice': 'Bu cevap güncelliğini yitirmiş olabilir.',
    'blog.qa.outdated.seeReplacement': '{question} sorusundaki güncellenmiş cevaba bakınız.',
    // Q&A Public
