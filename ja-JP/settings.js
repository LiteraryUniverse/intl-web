export default {
    ...
    'settings.export.explain': 'データベースに保存されているすべての個人データをJSONファイルとしてエクスポートします。これには、あなたのプロフィール、ストーリー、読書履歴、日記、個人メモ、執筆統計、ブックマーク、読書リスト、コミュニティ活動、メンバーシップ、その他あなたのアカウントに関連するすべてのデータが含まれます。',
    'settings.export.submit': 'データのエクスポート',
    'settings.delete.title': 'アカウントの削除',
    'settings.delete.warning': '警告: アカウントを削除することで、このアカウントへのアクセスは永久に失われ、回復する方法はありません。日記のエントリー、個人的なメモ、読書履歴、執筆統計を含むすべてのプライベートデータは永久に削除されます。',
    'settings.delete.published': 'あなたはプラットフォーム上でコンテンツを公開しています。アカウントを削除すると、公開された作品が削除されるのではなく、匿名化されます（名前とプロフィール情報が削除されます）。あなたのコメントは"[削除しました]"に置き換えられます。作品の公開を解除したい場合は、アカウントを削除する前に解除してください。',
    ...
    'settings.delete.error': 'アカウント削除でエラーが発生しました。問題が解決しない場合は、サポートにお問い合わせください。',
