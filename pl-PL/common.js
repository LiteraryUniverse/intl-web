...
export default {
  ...
  'site.description':
    'Literary Universe to platforma kreatywna i wydawnicza typu all-in-one dla wielkich uniwersów opowieści.',
  'site.keywords':
    'kreatywne pisanie, nauka, nauka, fantazja, pisanie, wydawanie, historia, historie, wszechświat, novel, powieść internetowa',
  ...
  'common.accessdenied.msg':
    'Nie otrzymałeś pozwolenia, aby tu wejść. Jeśli powinieneś mieć tutaj dostęp, skontaktuj się z właścicielem i powiedz mu, żeby sprawdził ustawienia.',
  ...
  'common.futurefeature.text':
    'Bardzo nam przykro, ale ta funkcja nie jest dostępna w tej chwili. Pracujemy nad tym, aby udostępnić ją tak szybko, jak to możliwe.',
  ...
  'common.legal.newVersionAvailable':
    'Nowa wersja ({newVersion}) niniejszego dokumentu wejdzie w życie w dniu {effectiveAt, date}.',
  'common.legal.disclaimer':
    '© {year} Wszelkie prawa zastrzeżone, wszystkie teksty są własnością ich autorów.',
  'premium.only.title': 'Niewystarczająco wysoka ranga członkowska',
  'premium.only.msg':
    'Przepraszamy, Twoja ranga członkowska nie jest wystarczająco wysoka, aby uzyskać dostęp do tej funkcji.',
  'premium.only.join':
    'Oferujemy różne plany dla każdego, aby uzyskać jak najwięcej korzyści z Literary Universe.',
  ...
  // for beta only
  'beta.notice':
    'Witamy w Literary Universe BETA. To jest publiczny podgląd i jako taki aplikacja jest wciąż w toku. Oznacza to, że możesz spodziewać się błędów i niedokończonych funkcji. Jeśli napotkasz jakiś błąd lub coś nie działa, daj nam znać i prosimy o cierpliwość, podczas gdy my będziemy mieć wszystko na miejscu.',
  ...
  'errorLoading.explained':
    'Wystąpił błąd podczas ładowania strony. Przepraszamy za niedogodności. Prosimy o ponowną próbę wejścia na stronę. Jeśli problem będzie się powtarzał, prosimy o poinformowanie nas o tym.',
  ...
  goodbyeForever:
    'Przykro nam, że odchodzisz. Czy to było coś z naszej winy? Proszę daj nam znać, jeśli tak było. Tak czy inaczej życzymy Ci wszystkiego najlepszego w Twoich przyszłych przedsięwzięciach i mamy nadzieję, że jeszcze się spotkamy! Żyj długo i pomyślnie!',
  ...
  'common.2faCodeIntro':
    'Wprowadź swój jednorazowy kod wygenerowany przez aplikację uwierzytelniającą.',
  ...
  'signin.web3.signMessage':
    'Potwierdź, że chcesz wejść do Literary Universe, używając swojego portfela jako metody uwierzytelniania. Kod: {code}',
  ...
  create: 'Utwórz',
  'banner.support':
    'Literary Universe jest wspierane przez użytkowników takich jak Ty! Prosimy rozważ subskrypcję jednego z naszych planów, aby pozostać niezależnym i uczynić Literary Universe jeszcze lepszym miejscem!',
  ...
  'console.explain':
    'To jest funkcja przeglądarki przeznaczona dla programistów. Jeśli ktoś kazał ci skopiować coś tutaj, aby włączyć funkcję Uniwersum Literackiego lub "zhakować" czyjeś konto, to oszustwo i da mu dostęp do twojego konta Uniwersum Literackiego.',
