export default {
  ...
  'feedback.report.copyrightNotice':
    'ଦୟାକରି ଧ୍ୟାନ ଦିଅନ୍ତୁ ଯେ ଆପଣ ଏହି ଫର୍ମଟି ବ୍ୟବହାର କରିବା ପାଇଁ ସହୀତ ମାଲିକ ହେବା ଆବଶ୍ୟକ। ଯଦି ଆପଣ ମାଲିକ ନାହିଁଥିବା ହେବା, ଦୟାକରି ମାଲିକଙ୍କୁ ଜାଣାଇବା କିମ୍ବା ଅନ୍ୟ ବିଭାଗ ବ୍ୟବହାର କରିବା ପାଇଁ ଆମେ ଜଣାଇବୁ। ଆମେ କୋପିରାଇଟ ଲଙ୍ଘନ ଖୁବ ଗମ୍ଭୀରତା ସହିତ ନିଯୁକ୍ତି ନିଯୁକ୍ତି ନେଇଥାଏ।',
  ...
  'faq.section.guilds': 'ଗୁଲ୍ଡଗୁଡ଼ିକ',
  // About us questions
  'faq.question.about.whatIsLU': 'ଲିଟେରରୀ ବିଶ୍ଵବିଦ୍ୟାଳୟ କେଉଁ ଅଛି?',
  ...
  'faq.answer.about.dataLocation':
    'Literary Universe ଡାଟା ମେରାକୁ ଇଉଏସ୍ ମେରାକୁ ଇଉଏସ୍-ଇଷ୍ଟ-୧ ଅଞ୍ଚଳରେ ସ୍ଥିତ ସର୍ଭରଗୁଡ଼ିକୁ ସଂଗ୍ରହିତ ଅଛି।',
