...
export default {
  ...
  'email.enrollAccount.messageHtml':
    'Kami ingin mengundang Anda ke Literary Universe! Kami telah menyiapkan akun pribadi untuk Anda di mana Anda dapat mengakses semua fitur dari Literary Universe! Silakan bergabung dengan kami dalam menciptakan generasi berikutnya dari menulis dan membaca yang kreatif!',
  'email.enrollAccount.button': 'Akses akun Anda',
  'email.enrollAccount.signature':
    'Kami sangat menantikan untuk bertemu dengan Anda, tim Literary Universe<br />',
  // Reset password
  'email.resetPassword.messageHtml':
    'Kami telah menerima permintaan untuk mengatur ulang kata sandi akun Anda, silakan klik tombol di bawah ini untuk melanjutkan proses. Jika Anda tidak melakukan permintaan ini, Anda dapat mengabaikan email ini, tetapi ini mungkin saat yang tepat untuk meninjau pengaturan keamanan Anda.',
  'email.resetPassword.button': 'Atur ulang kata sandi',
  // E-mail verification
  'email.verifyEmail.messageHtml':
    'Kami senang memiliki Anda bergabung! Silakan klik tombol di bawah ini untuk memverifikasi alamat email ini.',
