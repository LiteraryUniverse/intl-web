...
export default {
  ...
  'email.enrollAccount.messageHtml':
    'We willen je graag uitnodigen voor het Literair Universum! We hebben alvast een persoonlijk account voor je aangemaakt waar je toegang hebt tot alle functies van het Literair Universum! Doe met ons mee in het creëren van de volgende generatie creatief schrijven en lezen!',
  ...
  'email.resetPassword.messageHtml':
    'We hebben een verzoek ontvangen om je wachtwoord voor je account te resetten, klik op de knop hieronder om het proces voort te zetten. Als je dit verzoek niet hebt gedaan, kun je deze e-mail negeren, maar het is misschien een goed moment om je beveiligingsinstellingen te controleren.',
  'email.resetPassword.button': 'Wachtwoord resetten',
  // E-mail verification
  'email.verifyEmail.messageHtml':
    'We zijn blij dat je aan boord bent! Klik op de knop hieronder om dit e-mailadres te verifiëren.',
