export default {
  ...
  'feedback.report.copyrightNotice':
    'โปรดทราบว่าคุณจำเป็นต้องเป็นเจ้าของสิ่งงานเพื่อใช้แบบฟอร์มนี้ หากคุณไม่ใช่เจ้าของ โปรดแจ้งเจ้าของหรือใช้หมวดหมู่อื่นเพื่อแจ้งให้เรารับทราบ การละเมิดลิขสิทธิ์เป็นเรื่องที่เราใส่ใจอย่างยิ่งและเราใช้วิธีการเดียวกันเมื่อมีการใช้แบบฟอร์มนี้อย่างไม่ถูกต้องและเป็นการละเมิด',
  ...
  'faq.answer.about.dataLocation':
    'ข้อมูล Literary Universe ถูกเก็บไว้บนเซิร์ฟเวอร์ในสหรัฐอเมริกา โดยเฉพาะในภูมิภาค AWS us-east-1',
  ...
  'faq.answer.about.roadmap':
    'สิ่งนี้เปลี่ยนแปลงอยู่เสมอ คุณสามารถดู <a href="/roadmap">roadmap</a> เพื่อดูรายละเอียดเพิ่มเติม',
  // Settings questions
