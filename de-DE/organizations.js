export default {
  ...
  'org.invitesTileNotice':
    'Du wurdest zu {count, number} {count, plural, one {Organisation} other {Organisationen}}',
  ...
  'org.invitePage.ignoring':
    'Sie ignorieren diese Einladung zur Zeit, d. h. sie ist noch aktiv, stört aber nicht mit Benachrichtigungen.',
  'org.invitePage.expiresAt':
    'Diese Einladung läuft am {expiresAt, date, short} {expiresAt, time} ab',
  ...
  'org.leaveOrg.confirm':
    'Dies ist eine zerstörerische Handlung. Wenn Sie gehen, verlieren Sie jeden Zugang zu dieser Organisation. Sind Sie sicher, dass Sie die Organisation verlassen wollen?',
  'org.confirmRemove.aria': 'Bestätigen Sie die Entfernung des Benutzers',
  'org.confirmRemove.confirm':
    'Sind Sie sicher, dass Sie {username} aus {organization} entfernen möchten?',
