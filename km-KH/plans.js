export default {
  ...
  'payments.disclaimer':
    'ព័ត៌មានការទូទាត់និងការដោះដុលត្រូវបានធ្វើឡើងតាមរយៈ Stripe។ យើងមិនរក្សាទុកព័ត៌មានកាតឥណទានឬគណនីធនាគារណាមួយនៅលើម៉ាស៊ីនបម្រើរបស់យើងទេ។',
  ...
  'payment.webMonetization.explained':
    'ការបង់ប្រាក់តាមអ៊ីនធឺណិតជាជម្រើសស្តង់ដាមសម្រាប់ការបង់ប្រាក់លើបណ្តោយវេបសាយ។ នៅទីនេះអ្នកអាចបន្ថែមផ្ទៃតាប្លើកនេះទៅលើទំព័រប្រវត្តិរបស់អ្នក ការនិងរឿងពិភពលោកដើម្បីប្រើប្រាស់ដោយការបង់ប្រាក់តាមអ៊ីនធឺណិតជាជម្រើសស្តង់ដាមសម្រាប់ការបង់ប្រាក់លើបណ្តោយវេបសាយ។',
  'payment.webMonetization.learnMore':
    'ស្វែងយល់បន្ថែមអំពីការបង់ប្រាក់តាមអ៊ីនធឺណិតជាជម្រើសស្តង់ដាមសម្រាប់ការបង់ប្រាក់លើបណ្តោយវេបសាយ',
  ...
  'stripeConnect.settings.ongoing':
    'យើងកំពុងរង់ចាំការឆ្លើយតបដោយ Stripe អោយក្នុងការគណនីរបស់អ្នក។ វាអាចចំណាយពេលប៉ុន្មានបន្ទាន។ បើនេះចំពោះពេលវេលាធ្វើសកម្មភាពពេញនិយមពិនិត្យមិនសូវទេ សូមចុចលើប៊ូតុងខាងក្រោមដែលនឹងផ្តល់ជូនអ្នកទៅកាន់ Stripe។',
  ...
  'payment.donations.payNowUSD':
    'បង់ប្រាក់ {donation, number, ::compact-short currency/USD} ទៅកាន់ {username}',
  'payment.donations.payNowJPY':
    'បង់ប្រាក់ {donation, number, ::compact-short currency/JPY} ទៅកាន់ {username}',
  'payment.donations.payNowEUR':
    'បង់ប្រាក់ {donation, number, ::compact-short currency/EUR} ទៅកាន់ {username}',
  ...
  'payment.universe.haveFans':
    'ស្វែងយល់ជាងថ្នាក់ទីមួយដើម្បីទទួលបានអ្នកជំនុំអតិបរមាដែលមានចំនួនសមាជិកដែលមានចំណេះដឹងប្រឹក្សានៅលើអ្វីដែលអ្នកកំពុងធ្វើ។ ការបន្ថែមជំនុំរបស់អ្នកទៅកាន់បណ្ដាញសម្រាប់ទិញសៀវភៅនេះគឺជាជំនួយក្នុងការចាប់ផ្តើម។',
  ...
  'payment.fanClub.priceBreakdown':
    'អ្នកជាអតិថិជននឹងបង់ប្រាក់: {amount}។ ថ្លៃប្រតិបត្តិការគឺ {fee} អ្នកនឹងទទួលបាន: {net}',
  'payment.feeNotice':
    'សូមបញ្ចូលចំនួននេះជាកំណត់ត្រា ហើយថ្លៃប្រតិបត្តិការពិតជាអាចផ្លាស់ប្តូរតាមប្រភេទបង់ប្រាក់របស់អតិថិជននិងថ្លៃបន្ថែមពីការបង់ប្រាក់ផ្សេងៗពីផ្ទេរប្រតិបត្តិការ។',
