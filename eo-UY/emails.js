...
export default {
  ...
  'email.enrollAccount.signature':
    'Ni antaŭenrigardas por vidi vin, teamo de<br />Literatura Universo',
  // Reset password
  'email.resetPassword.messageHtml':
    'Ni ricevis peton por rekomenci vian pasvorton por via konto, bonvolu klaki sur la butonon sube por daŭrigi la proceson. Se vi ne petis tion, vi povas ignori ĉi tiun retpoŝton, sed estus bona tempo revizii viajn sekurecajn agordojn.',
  'email.resetPassword.button': 'Rekomenci pasvorton',
  // E-mail verification
  'email.verifyEmail.messageHtml':
    'Ni ĝojas havi vin surŝipe! Bonvolu klaki la butonon sube por verifi ĉi tiun retpoŝtan adreson.',
