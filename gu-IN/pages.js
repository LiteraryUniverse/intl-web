export default {
  ...
  'gdpr.processing.desc':
    'સાહિત્યિક વિશ્વ પૂરી પ્રમાણે બ્રાઉઝર સેટિંગ્સને આદર આપે છે, જેમાં "ટ્રેક ન કરો" વિનંતીઓ છે, માટે અમારી Matomo આંકડા સર્વરને રિપોર્ટ કરવા માટે.',
  ...
  'dmca.step2.desc1':
    'તમારી રિપોર્ટ મેળવવા પછી અમે તમારી ખાતરીઓ અને માલિકી દાવોને ચકાસીશ કરીશું. જો તમામ સારી રીતે હોય તો અમે દાવોને તપાસીશ કરીશું. જો અમે દાવોને સાચું માનીશું તો અમે અપત્ર સંપત્તિને અપ્રાપ્ય બનાવીશું જેની પછી કાઉન્ટર-નોટિસની નિર્ધારણ થઇ જશે અથવા 14 દિવસ પછી તેને કાઢી દીશું.',
  'dmca.step3.desc1':
    'એક ટકાવાર ફરિયાદ મેળવવામાં આવે તે નિયમિત સંપત્તિના માલિક માટે 14 દિવસ હશે કેઉંટર નોટિસ દાખલ કરવાની મુદત. તેનથી પછી નિયમિત એજેન્ટ વિવાદની તપસ્થા પર છાંટ કરશે. આ સ્તરે ડિઝાઇનેટેડ એજેન્ટની કોઈપણ નિર્ણય અંતિમ હશે.',
  ...
  'about.attributionsIntro':
    'સાહિત્યિક યુનિવર્સ મહેરબાની કરીને ઘણા ઓપન સોર્સ પ્રોજેક્ટ્સ અને મુક્ત સાધનો પર આધાર રાખે છે. નીચે તેમની યાદી આપેલી છે.',
  'about.attributionsMatomo':
    'અમારા વિશ્લેષણમાં આપત્તિ નો ઉપયોગ આપતું માટોમો સાથે સ્વ-હોસ્ટેડ છે, જેમાં IP2Location LITE માહિતી https://lite.ip2location.com પર ઉપલબ્ધ છે.',
