...
export default {
    ...
    'common.back': 'Назад',
    'console.stop': 'Стоп!',
    'console.explain': 'Это функция браузера, предназначенная для разработчиков. Если кто-то попросил вас скопировать-вставить что-то сюда, чтобы включить функцию Литературной Вселенной или "взломать" чей-то аккаунт, это мошенничество и позволит им получить доступ к вашему аккаунту Литературной Вселенной.'
