export default {
  ...
  'encyclopedia.help.text':
    'Brug menuen til venstre til at navigere mellem emnerne i encyklopædien. Når du vælger et emne, vil det blive vist i stedet for denne tekst.',
  'encyclopedia.help.sidebar': 'Sidebar Værktøjskasse',
  'encyclopedia.help.sidebar.text':
    'Velkommen til din historie! Denne sidebjælke giver dig nem adgang til alle ressourcer, der er relateret til din historie. Tjek ikonerne ovenfor for at se de seneste kommentarer, dine noter, søge i din encyklopædi, gennemse og tilføje nye indgange til din encyklopædi. Hvis du vil tilføje forbindelse til en indgang fra historieteksten, skal du vælge den tekst, hvor du vil placere den, og klik derefter på forbind-knappen. Du bliver derefter bedt om at finde og vælge et element.',
  ...
  'encyclopedia.container.desc':
    'Gør denne indgang til en beholder for en ny gruppe af indgange. Dette vil skjule den fra kategorilisten.',
  'encyclopedia.entry.name': 'Navn på indgangen',
  'encyclopedia.summary': 'Resumé',
  'encyclopedia.summary.desc':
    'Dette er et resumé, der vil være den eneste indledende information, der vises for læseren.',
  ...
  'encyclopedia.translation.desc':
    'Dette encyklopædi-interface bruges til oversættelse til {language}. Vælg eksisterende indgange på listen til venstre for at begynde deres oversættelse.',
  ...
  'encyclopedia.settings.categoriesDesc':
    'Tænd og sluk for kategorier, som du vil bruge i din encyklopædi.',
  ...
  'enc.entries.limitReached':
    'Du har nået det maksimale antal tilladte opslag i encyklopædien for dit nuværende abonnement.',
  ...
  'encyclopedia.settings.templateDescription':
    'Tillad indholdet af denne encyklopædi at blive kopieret til andre universer. Dette er bedst, hvis du ikke har nogen historier og i stedet bare opretter en skabelon, som andre kan bruge.',
  ...
  'encyclopedia.templateCopy.description':
    'Kopier indholdet af denne encyklopædi ind i dit univers for at berige det.',
