...
export default {
  ...
  'licenses.lu-c':
    'સ્ટાન્ડર્ડ પૂર્ણ કૉપિરાઇટ લાયસન્સ જે તમને તમારું કામ વેચવા અને પ્રકાશિત કરવાની મંજૂરી આપે છે અને તમારા અધિકારોને સંરક્ષિત રાખે છે. આ લાયસન્સ તમને લિટરેરી યુનિવર્સમાં તમારી કથાઓને વેચવાની વિકલ્પની પણ આપે છે.',
  'licenses.name.cc0': 'કોઈ હક સંરક્ષિત નથી - CC0 1.0',
  'licenses.cc0':
    'તમારું કામ સાર્વજનિક ડોમેનમાં મૂકો. CC ના લાયસન્સોથી વાપરતા કૉપિરાઇટ ધારકોને તેમજ તેમની કૉપિરાઇટ સાથે જુદાજુદા પરવાનગીઓને પસંદ કરવાની મંજૂરી આપે છે, CC0 કૉપિરાઇટ અને ડેટાબેઝ સંરક્ષણની પસંદગીને અવશ્યકતાને બાદ છોડી આપે છે અને સર્જકોને આપેલા અનન્ય હકો - "કોઈ હક સંરક્ષિત નથી" આ આપતું વિકલ્પ આપે છે.',
}
