export default {
    ...
    'settings.export.explain': 'Tím se vyexportují všechny vaše osobní údaje uložené v naší databázi jako soubor JSON. To zahrnuje váš profil, příběhy, historii čtení, záznamy v deníku, osobní poznámky, statistiky psaní, záložky, seznamy čtení, aktivity v komunitě, členství a všechna další data spojená s vaším účtem.',
    'settings.export.submit': 'Exportovat data',
    'settings.delete.title': 'Smazat účet',
    'settings.delete.warning': 'UPOZORNĚNÍ: Odstraněním účtu trvale ztratíte přístup k tomuto účtu a není možné jej obnovit. Všechna soukromá data včetně záznamů v deníku, osobních poznámek, historie čtení a statistik psaní budou trvale odstraněna.',
    'settings.delete.published': 'Na platformě jste zveřejnili obsah. Odstraněním vašeho účtu se vaše publikovaná díla spíše anonymizují (odstraní se vaše jméno a informace o profilu), než aby se vymazala. Vaše komentáře budou nahrazeny textem "[smazáno]". Pokud chcete svá díla nejprve zrušit, učiňte tak před smazáním svého účtu.',
    ...
    'settings.delete.error': 'Při mazání účtu došlo k chybě. Pokud problém přetrvává, kontaktujte prosím podporu.',
    ...
    'settings.userType.title': 'Typ uživatele',
    'settings.userType.select': 'Vyberte primární roli',
    ...
    // Keys (combined page)
    'settings.keys.title': 'API & Servisní klíče',
    // API Keys
    ...
    'settings.externalKeys.title': 'Klíče externích služeb',
    'settings.externalKeys.description': 'Přidejte vlastní API klíče pro externí AI služby. Klíče jsou šifrovány a bezpečně ukládány. Používají se pouze v případě, že výslovně spustíte funkci, která je vyžaduje.',
    'settings.externalKeys.securityNote': 'Zacházejte s API klíči, jako s hesli. Nikdy je nesdílejte.',
    'settings.externalKeys.add': 'Přidat klíč',
    'settings.externalKeys.update': 'Aktualizovat',
    'settings.externalKeys.configured': 'Nastaveno',
    'settings.externalKeys.remove': 'Odstranit klíč',
    'settings.externalKeys.delete.confirm': 'Odstranit uložený API klíč pro tuto službu? Můžete jej znovu přidat později.',
    'settings.externalKeys.getKey': 'Získejte API klíč od {name}',
    'settings.externalKeys.keyLabel': 'API klíč',
    'settings.externalKeys.keyPlaceholder': 'Sem vložte Váš API klíč',
    // Web3
    ...
    'settings.tracking.title': 'Sledování a statistiky',
    'settings.tracking.description': 'Sledujte čas strávený čtením a psaním a získejte podrobné statistiky o svých čtenářských návycích a pokroku v psaní. Tyto statistiky si můžete zobrazit v knihovně a v dílně.',
    'settings.tracking.reading.title': 'Doba čtení',
    'settings.tracking.reading.description': 'Sledujte čas strávený čtením příběhů a kapitol. Tyto údaje vám pomohou pochopit vaše čtenářské návyky a jsou anonymně sdíleny s autory příběhů, aby jim ukázaly, jak jsou čtenáři zaujati jejich dílem.',
