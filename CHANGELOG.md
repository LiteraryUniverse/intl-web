...
* Additional strings for story page
...
* Removed languages and countries files as they
  are [no longer needed](https://github.com/formatjs/react-intl/blob/master/docs/API.md#formatdisplayname)
