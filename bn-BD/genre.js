export default {
  'genre.scifi': 'বিজ্ঞান কল্পকাহিনী',
  'genre.fantasy': 'মহাভারত',
  'genre.adventure': 'সাহসিক',
  'genre.poetry': 'কবিতা',
  'genre.comedy': 'কমেডি',
  'genre.drama': 'নাটক',
  'genre.nonfiction': 'অনন্য গবেষণামূলক',
  'genre.fiction': 'কল্পকাহিনী',
  'genre.romance': 'রোমান্স',
  'genre.satire': 'হাস্যরস',
  'genre.tragedy': 'বিপদ',
  'genre.crime': 'Crime',
  'genre.historical': 'ঐতিহ্যবাদী কল্পকাহিনী',
  'genre.horror': 'ভয়ঙ্কর',
  'genre.mystery': 'মহাকাব্য',
  'genre.thriller': 'থ্রিলার',
  'genre.western': 'পশ্চিম',
  'genre.memoir': 'জীবনী',
  'genre.biography': 'জীবনীলেখ',
  'genre.steampunk': 'স্টিমপাঙ্ক',
  'genre.mythology': 'পুরাণ',
  'genre.fairytale': 'পরীকথা',
  ...
  'genre.fantasy.description':
    'কাল্পনিক বিশ্বগুলির মধ্যে যেমন যৌক্তিক ঘটনা, মিথ্যা ঘটনা, এবং পৌরাণিক প্রাণীর উপাদানগুলির উপস্থিতি রয়েছে, তার মধ্যে যেমন হিরোদের অনুসন্ধান, ভাল এবং খারাপের মধ্যে যুদ্ধ, এবং বয়স বাড়ানোর গল্প রয়েছে। ফ্যান্টাসি হাই ফ্যান্টাসি, শহর ফ্যান্টাসি, ডার্ক ফ্যান্টাসি, এবং পরী গল্প ইত্যাদির মতো উপ-জানরে বিভক্ত করা যেতে পারে। এটি সাধারণত নৈতিকতা এবং নৈতিকতার বিষয়ে উপস্থিতির মতো বিষয়বস্তু সংযোজন করে, যা ভাল এবং খারাপের স্বাভাবিকতা অনুসন্ধান করে।',
  ...
  'genre.isekai.description':
    'এই জাপানি লাইট নভেল, মাঙ্গা, এবং অ্যানিমে সাব-জানরের মধ্যে একটি উপ-জানর রয়েছে যেখানে একটি চরিত্রকে একটি নতুন বিশ্ব বা বিকল্প বিশ্বে পরিবর্তিত বা পুনর্জন্ম করা হয়। প্রধান অভিনয়গুলি নতুন বিশ্বের অনন্য সংস্কৃতি এবং পরিবেশের সাথে সমন্বয় করতে হবে, যাতে সাধারণত নতুন ক্ষমতা অর্জন করতে হয় এবং সময়ের সাথে নতুন সহযোগী এবং শত্রুদের সম্মুখীন হয়। এই গল্পগুলি সাধারণত হাসিখুশি এবং কৌতুহলময় থেকে অন্ধকার এবং তীব্র পর্যায়ের মধ্যে পরিণত হতে পারে, কিন্তু সর্বদাই ক্লান্তিশীল এবং সৃজনশীল অভিজ্ঞতা দেয় ক্লাসিক প্রয়াণ্ড ভ্রমণ মূলতে।',
}
