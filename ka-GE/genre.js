export default {
  'genre.scifi': 'მცენარე ფანტასტიკა',
  'genre.fantasy': 'ფანტასტიკა',
  'genre.adventure': 'სათავგადასავლო',
  'genre.poetry': 'პოეზია',
  'genre.comedy': 'კომედია',
  'genre.drama': 'დრამა',
  'genre.nonfiction': 'არა-ფიქცია',
  'genre.fiction': 'ფიქცია',
  'genre.romance': 'რომანი',
  'genre.satire': 'სატირი',
  'genre.tragedy': 'ტრაგედია',
  'genre.crime': 'Crime',
  'genre.historical': 'ისტორიული ფიქცია',
  'genre.horror': 'საშინელება',
  'genre.mystery': 'მისტერი',
  'genre.thriller': 'თრილერი',
  'genre.western': 'ვესტერნი',
  'genre.memoir': 'მემუარი',
  'genre.biography': 'ბიოგრაფია',
  'genre.steampunk': 'სტიმპანკი',
  'genre.mythology': 'მითოლოგია',
  'genre.fairytale': 'ცხენის საათი',
  'genre.superhero': 'სუპერგმყრილები',
  ...
  'genre.fantasy.description':
    'ფანტასტიკა არის ლიტერატურული ჟანრი, რომელშიც მოხდება მაგიური, სუპერნატურალური მოვლენებისა და მითითებული ცრემლების გამოყენებით განსაზღვრული მსოფლიოებებში. ის შეიცავს გმირებს მოქმედებებზე, ბოროტისთვის ბრძოლებზე და სიბრალულის მოთხრობებზე. ფანტასტიკა შეიძლება კატეგორიზებული იყოს ქვემოთხედური ფანტასტიკა, ურბანული ფანტასტიკა, ბნელი ფანტასტიკა და სახალისო მოთავსებები, შესაბამისად. ის ხანდაზმულად შეიცავს მორალისა და ეთიკის თემებს, რომელიც აცდენს კეთილსა და ბორბალს.',
  ...
  'genre.isekai.description':
    'ეს იაპონური ლაითნოველების, მანგების და ანიმების ქვემოთხედვის ქვეყანაში ან ალტერნატიულ უნივერსუმში დატრენსფორმირებული ან ახალ სამყაროში მყარად მოქმედებების შესახებ. პროტაგონისტმა უნდა მართავდეს ახალ სამყაროს უნიკალურ კულტურებსა და გარემოებას, ხოლო მარადიულად მიიღებს ახალ უნარებს და შეხვედრისას შეხვედრისას ახალ მეგობრებსა და მტრებს. ამ მოთხრობები შეიძლება იყოს გასართობი და კომიკური, მწარმოებელი და ინტენსიური, მაგრამ ყოველთვის გთავაზობთ განახლებულ და გამოცემულ კლასიკურ სათავგადასავლო თემებზე.',
}
