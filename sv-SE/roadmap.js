export default {
  'roadmap.meta.description': 'Planer för utveckling av Literary Universe.',
  'roadmap.ariaTimeOptions': 'Val för vägkarteelement baserat på deras status.',
  'roadmap.state.backlog': 'Backlog',
  'roadmap.state.inprogress': 'Pågående',
  'roadmap.state.preview': 'Förhandsgranskning',
  'roadmap.state.beta': 'Beta',
  'roadmap.state.ga': 'Allmän tillgänglighet',
  'roadmap.eta.q1.short': 'Q1',
  'roadmap.eta.q2.short': 'Q2',
  'roadmap.eta.q3.short': 'Q3',
  'roadmap.eta.q4.short': 'Q4',
  'roadmap.eta.q1.long': 'Första kvartalet',
  'roadmap.eta.q2.long': 'Andra kvartalet',
  'roadmap.eta.q3.long': 'Tredje kvartalet',
  'roadmap.eta.q4.long': 'Fjärde kvartalet',
  'roadmap.backlog': 'Backlog',
  'roadmap.history': 'Utvecklingshistorik',
