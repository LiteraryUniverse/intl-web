 ...
 */
export default {
    'licenses.about': 'লাইসেন্স সম্পর্কে',
    'licenses.more': 'আরও তথ্য',
    'licenses.legal': 'আইনি দলিল',
    'licenses.name.cc-by': 'ক্রিয়েটিভ কমন্স অ্যাট্রিবিউশন ৪.০',
    'licenses.cc-by': 'এই লাইসেন্স অন্যদের আপনার কাজ বিতরণ, রিমিক্স, সামান্য পরিবর্তন এবং বাণিজ্যিকভাবেও এর উপর ভিত্তি করে নতুন কিছু তৈরি করতে দেয়, যতক্ষণ তারা মূল সৃষ্টির জন্য আপনাকে ক্রেডিট দেয়। এটি প্রস্তাবিত লাইসেন্সগুলির মধ্যে সবচেয়ে উদার। লাইসেন্সকৃত সামগ্রীর সর্বোচ্চ প্রচার ও ব্যবহারের জন্য এটি সুপারিশ করা হয়।',
    'licenses.name.cc-by-sa': 'ক্রিয়েটিভ কমন্স অ্যাট্রিবিউশন-শেয়ারঅ্যালাইক ৪.০',
    ...
    'licenses.name.cc-by-nd': 'ক্রিয়েটিভ কমন্স অ্যাট্রিবিউশন-নোডেরাইভস ৪.০',
    'licenses.cc-by-nd': 'এই লাইসেন্সটি বাণিজ্যিক ও অ-বাণিজ্যিক উভয় ক্ষেত্রে পুনর্বিতরণ করার অনুমতি দেয়, যতক্ষণ এটি অপরিবর্তিত ও সম্পূর্ণরূপে আপনার ক্রেডিটসহ বিতরণ করা হয়।',
    'licenses.name.cc-by-nc': 'ক্রিয়েটিভ কমন্স অ্যাট্রিবিউশন-নন-কمر্শিয়াল ৪.০',
    ...
    'licenses.name.cc-by-nc-sa': 'ক্রিয়েটিভ কমন্স অ্যাট্রিবিউশন-নন-কমার্শিয়াল-শেয়ারঅ্যালাইক ৪.০',
    'licenses.cc-by-nc-sa': 'এই লাইসেন্স অন্যদের আপনার কাজ অ-বাণিজ্যিকভাবে রিমিক্স, সামান্য পরিবর্তন এবং আরও গড়ে তুলতে দেয়, যদি তারা আপনাকে ক্রেডিট করে এবং তাদের নতুন সৃষ্টিগুলোকে একই শর্তে লাইসেন্স করে।',
    'licenses.name.cc-by-nc-nd': 'ক্রিয়েটিভ কমন্স অ্যাট্রিবিউশন-নন-কمر্শিয়াল-নোডেরাইভস ৪.০',
    ...
    'licenses.name.lu-c': 'সাহিত্যিক মহাবিশ্বের কপিরাইট',
