...
export default {
  ...
  'email.enrollAccount.messageHtml':
    "Sizi Edebi Evrene davet etmek istiyoruz! Özel bir hesap oluşturduk, bu hesap aracılığıyla Edebi Evren'in tüm özelliklerine erişebilirsiniz! Lütfen, yaratıcı yazma ve okuma araçlarının gelecek neslini oluşturmak için bize katılın!",
  'email.enrollAccount.button': 'Hesabınıza erişin',
  'email.enrollAccount.signature':
    'Sizi görmek için sabırsızlanıyoruz,<br />Literary Universe ekibi',
  // Reset password
  'email.resetPassword.messageHtml':
    'Hesabınızın şifresini sıfırlamak için bir talep aldık, işlemi devam ettirmek için lütfen aşağıdaki düğmeye tıklayın. Eğer bu talebi siz yapmadıysanız bu e-postayı görmezden gelebilirsiniz, ancak güvenlik ayarlarınızı gözden geçirmek için iyi bir zaman olabilir.',
  'email.resetPassword.button': 'Şifreyi sıfırla',
  // E-mail verification
  'email.verifyEmail.messageHtml':
    'Sizi aramızda görmekten mutluluk duyuyoruz! Lütfen bu e-posta adresini doğrulamak için aşağıdaki düğmeye tıklayın.',
