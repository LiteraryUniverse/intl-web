export default {
  ...
  'roadmap.state.preview': 'Προεπισκόπηση',
  'roadmap.state.beta': 'Βήτα',
  'roadmap.state.ga': 'Γενική διαθεσιμότητα',
  'roadmap.eta.q1.short': 'Τ1',
  'roadmap.eta.q2.short': 'Τ2',
  'roadmap.eta.q3.short': 'Τ3',
  'roadmap.eta.q4.short': 'Τ4',
  'roadmap.eta.q1.long': 'Πρώτο τρίμηνο',
  'roadmap.eta.q2.long': 'Δεύτερο τρίμηνο',
  'roadmap.eta.q3.long': 'Τρίτο τρίμηνο',
  'roadmap.eta.q4.long': 'Τέταρτο τρίμηνο',
  'roadmap.backlog': 'Ουρά εργασιών',
  'roadmap.history': 'Ιστορία ανάπτυξης',
