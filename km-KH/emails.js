...
export default {
  ...
  'email.resetPassword.messageHtml':
    'យើងបានទទួលការស្នើសុំកំណើតឡើងដើម្បីកំណត់ពាក្យសម្ងាត់របស់អ្នកសម្រាប់គណនីរបស់អ្នក, សូមចុចលើប៊ូតុងខាងក្រោមដើម្បីបន្តបន្ទាប់ពីវិញ។ ប្រសិនបើអ្នកមិនបានស្នើសុំការស្នើសុំនេះសូមមេត្តាប្រាប់ពួកគេបន្តិចម្បងនេះទេ, ប៉ុន្តែនេះគឺជាព័ត៌មានល្អប្រសើរសំរាប់អ្នកក្នុងការពិនិត្យការកំណត់សុវត្ថិភាពរបស់អ្នក។',
  'email.resetPassword.button': 'កំណត់ពាក្យសម្ងាត់ឡើងវិញ',
  // E-mail verification
  'email.verifyEmail.messageHtml':
    'យើងរីករាយដោយមិនចេញពីកន្លែងផ្សេងទៀតទេ! សូមចុចលើប៊ូតុងខាងក្រោមដើម្បីផ្ទៀងផ្ទាត់អាសយដ្ឋានអ៊ីម៉ែលនេះ។',
