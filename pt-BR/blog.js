export default {
  ...
  'blog.theme': 'Tema',
  'blog.theme.info':
    'Ajustando o tema você será capaz de mudar o visual da página. Este recurso não está pronto neste momento.',
  ...
  'blog.slug.explained':
    'Belo visual url para o posto. Evite usar caracteres especiais, exceto "-".',
