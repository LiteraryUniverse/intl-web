...
export default {
    ...
    'common.save': 'บันทึก',
    'common.email': 'อีเมล์',
    'common.anonymous': 'ไม่ประสงค์ออกนาม',
    ...
    'error.oops': 'อุ๊ย! เกิดข้อผิดพลาดร้ายแรง!',
    'error.apologies': 'ขออภัยในความไม่สะดวก เราจะพยายามแก้ไขให้เร็วที่สุด',
    'error.400.text': 'ข้อผิดพลาด 400: {errorMessage}',
    ...
    'common.swUpdate.ready.title': 'อัปเดตพร้อมแล้ว',
    'common.swUpdate.ready.description': 'เวอร์ชันใหม่พร้อมใช้งานแล้ว คุณสามารถนำไปใช้ได้ทันที',
    'common.swUpdate.ready.writerDescription': 'เวอร์ชันใหม่พร้อมใช้งานแล้ว กรุณาติดตั้งเมื่อคุณแก้ไขงานเขียนปัจจุบันเสร็จสิ้น',
    'common.swUpdate.apply': 'อัปเดตตอนนี้',
    ...
    'notVerified.verify': `กรุณาตรวจสอบ {option, select,
    email {อีเมล}
    wallet {กระเป๋าเงิน}
    other {อีเมล}
    } ของคุณ`,
    ...
    'common.publishNow': 'เผยแพร่ตอนนี้',
    'common.publishLater': 'เผยแพร่ภายหลัง',
    ...
    'story.notes.audienceAgeGroup': 'กลุ่มเป้าหมายตามช่วงอายุ',
    'story.notes.audienceSex': 'กลุ่มเป้าหมายเพศ',
    ...
    'common.forum': 'ฟอรัม',
    'common.2faCode': 'รหัส 2FA',
    'common.2faCodeIntro': 'กรุณากรอกรหัสครั้งเดียวที่สร้างโดยแอปพลิเคชันยืนยันตัวตนของคุณ',
    'common.2faCodeAria': 'แบบฟอร์มป้อนรหัส 2FA',
    ...
    'common.flashnews': 'ข่าวด่วน',
    'common.defaultLanguage': 'ภาษาเริ่มต้น',
    'signin.web3.signMessage': 'กรุณายืนยันว่าคุณต้องการเข้าสู่ Literary Universe โดยใช้กระเป๋าเงินของคุณเป็นวิธีการยืนยันตัวตน รหัส: {code}',
    'common.web3.confirmationCode': 'รหัสยืนยัน: {code}',
    'common.roadmap': 'แผนที่ทาง',
    ...
    'contentSelector.noSelection': 'ไม่มีรายการที่เลือก',
    'contentSelector.selectedItems': 'รายการที่เลือก',
    'contentSelector.entireSite': 'ค้นหาเว็บไซต์',
    'contentSelector.tabsLabel': 'ตัวเลือกการค้นหา',
    'contentSelector.title': 'เลือกเนื้อหา',
    recommended: 'แนะนำ',
    'select.typeToCreate': 'พิมพ์เพื่อสร้างรายการ',
    'select.noSearchResults': 'ไม่พบผลลัพธ์สำหรับ "{search}"',
    'select.removeOption': 'ลบ {option}',
    create: 'สร้าง',
    'banner.support': 'จักรวาลวรรณกรรมเกิดขึ้นได้ด้วยการสนับสนุนจากผู้ใช้เช่นคุณ เพื่อช่วยให้เราคงความเป็นอิสระและพัฒนาแพลตฟอร์มต่อไป โปรดพิจารณาสมัครสมาชิกหนึ่งในแผนของเรา',
    ...
    'common.noSelection': 'ไม่มีการคัดเลือก',
    'common.content': 'Content',
    'common.theWayOfTheAuthor': 'วิถีของนักเขียน',
    ...
    'actions.sendToKindle': 'ส่งไปยัง Kindle',
    ...
    'invitation.page.title': 'คำเชิญ',
    'invitation.title': 'คุณได้รับเชิญ!',
    'invitation.detail.invitedBy': 'ได้รับเชิญโดย',
    'invitation.detail.to': 'เข้าร่วม',
    'invitation.detail.role': 'บทบาท',
    'invitation.role.member': 'สมาชิก',
    'invitation.role.collaborator': 'ผู้ร่วมงาน',
    'invitation.role.translator': 'นักแปล',
    'invitation.role.beta': 'ผู้อ่านเบต้า',
    'invitation.objectType.organization': 'องค์กร',
    'invitation.objectType.story': 'เรื่องราว',
    'invitation.objectType.universe': 'จักรวาล',
    'invitation.accept': 'ยอมรับคำเชิญ',
    'invitation.accepting': 'ยอมรับ...',
    'invitation.decline': 'การลดลง',
    'invitation.loginRequired': 'กรุณาเข้าสู่ระบบหรือสร้างบัญชีเพื่อตอบรับคำเชิญนี้',
    'invitation.haveAccount': 'ฉันมีบัญชี',
    'invitation.newHere': 'ฉันเพิ่งมาที่นี่',
    'invitation.registerPrompt': 'สร้างบัญชีฟรีเพื่อรับคำเชิญนี้',
    'invitation.register': 'สร้างบัญชี',
    'invitation.goToDashboard': 'ไปที่แดชบอร์ด',
    'invitation.alreadyAccepted.title': 'คำเชิญได้รับการตอบรับแล้ว',
    'invitation.alreadyAccepted.message': 'คำเชิญนี้ได้รับการตอบรับแล้ว',
    'invitation.alreadyDeclined.title': 'คำเชิญถูกปฏิเสธ',
    'invitation.alreadyDeclined.message': 'คำเชิญนี้ถูกปฏิเสธแล้ว',
    'invitation.declined.title': 'คำเชิญถูกปฏิเสธ',
    'invitation.declined.message': 'คุณได้ปฏิเสธคำเชิญแล้ว',
    'invitation.cancelled.title': 'ยกเลิกคำเชิญ',
    'invitation.cancelled.message': 'คำเชิญนี้ถูกยกเลิกโดยผู้ส่ง',
