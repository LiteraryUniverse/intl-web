...
export default {
  ...
  'email.enrollAccount.messageHtml':
    'Vi vil gerne invitere dig til Literary Universe! Vi har allerede oprettet en personlig konto til dig, hvor du kan få adgang til alle funktioner i Literary Universe! Vær med til at skabe næste generation af kreativ skrivning og læsning!',
  ...
  'email.resetPassword.messageHtml':
    'Vi har modtaget en anmodning om at nulstille din adgangskode til din konto. Klik venligst på knappen nedenfor for at fortsætte processen. Hvis du ikke har foretaget denne anmodning, kan du ignorere denne e-mail, men det kan være en god idé at gennemgå dine sikkerhedsindstillinger.',
  'email.resetPassword.button': 'Nulstil adgangskode',
  // E-mail verification
  'email.verifyEmail.messageHtml':
    'Vi er glade for at have dig med om bord! Klik venligst på knappen nedenfor for at verificere denne e-mail-adresse.',
