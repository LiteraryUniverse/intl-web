...
export default {
  ...
  'email.enrollAccount.messageHtml':
    'Chúng tôi muốn mời bạn đến Vũ trụ Văn học! Chúng tôi đã chuẩn bị sẵn một tài khoản cá nhân cho bạn, nơi bạn có thể truy cập vào tất cả các tính năng của Vũ trụ Văn học! Hãy tham gia cùng chúng tôi trong việc tạo ra thế hệ tiếp theo của viết và đọc sáng tạo!',
  'email.enrollAccount.button': 'Truy cập tài khoản của bạn',
  'email.enrollAccount.signature':
    'Chúng tôi rất mong được gặp bạn, đội ngũ Literary Universe<br />',
  // Reset password
  'email.resetPassword.messageHtml':
    'Chúng tôi đã nhận được yêu cầu đặt lại mật khẩu cho tài khoản của bạn, vui lòng nhấp vào nút bên dưới để tiếp tục quá trình. Nếu bạn không thực hiện yêu cầu này, bạn có thể bỏ qua email này, nhưng đây có thể là thời điểm tốt để xem lại cài đặt bảo mật của bạn.',
  'email.resetPassword.button': 'Đặt lại mật khẩu',
  // E-mail verification
  'email.verifyEmail.messageHtml':
    'Chúng tôi rất vui khi có bạn tham gia! Vui lòng nhấp vào nút bên dưới để xác minh địa chỉ email này.',
