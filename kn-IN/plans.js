export default {
  ...
  'plans.current.buying':
    'ನಿಮ್ಮ ಖರೀದಿಯನ್ನು ಪರಿಶೀಲಿಸುವುದು ಕೆಲವು ಕ್ಷಣಗಳನ್ನು ಹೊಂದಬಹುದು. ನಿಮ್ಮ ಧೈರ್ಯಕ್ಕೆ ನಾವು ಕೃತಜ್ಞರಾಗಿದ್ದೇವೆ',
  'plans.current.heading': 'ಪ್ರಸ್ತುತ ಚಂದಾ ಯೋಜನೆ',
  'payment.methods.title': 'ಪಾವತಿಗಳು ಮತ್ತು ನಾಣಿಕೆಗಳು',
  ...
  'payment.option.description':
    'ಇಲ್ಲಿ ನಿಮ್ಮ ಉಳಿದ ಪಾವತಿ ವಿಧಾನಗಳ ಪಟ್ಟಿ ಇದೆ. ನೀವು ಹೊಸ ಚೆಕ್‌ಆಉಟ್‌ಗೆ ಇಲ್ಲಿ ಹೊಸ ಚೆಕ್‌ಆಉಟ್ ವಿಧಾನಗಳನ್ನು ಉಳಿಸಬಹುದು. ಲಿಟರರಿ ಯೂನಿವರ್ಸ್‌ನಲ್ಲಿ ಕ್ರೆಡಿಟ್ ಕಾರ್ಡ್ ಸಂಖ್ಯೆ ಮೊದಲಾದ ನಿಮ್ಮ ಪಾವತಿ ಮಾಹಿತಿಯನ್ನು ಉಳಿಸುವುದಿಲ್ಲ ಮತ್ತು ಕೆಲಸ ಮಾಡಿಸುವುದಿಲ್ಲ',
  ...
  'payments.disclaimer':
    'ಪಾವತಿ ಮಾಹಿತಿ ಮತ್ತು ಪ್ರಕ್ರಿಯೆ ಸ್ಟ್ರೈಪ್ ಮೂಲಕ ನಡೆಸಲಾಗುತ್ತದೆ. ನಮ್ಮ ಪರಿಚಾರಕರ ಪರವಾನಗಿ ಕಾರ್ಡ್ ಅಥವಾ ಬ್ಯಾಂಕ್ ಖಾತೆಗಳ ಮಾಹಿತಿಯನ್ನು ನಾವು ಉಳಿಸುವುದಿಲ್ಲ.',
  ...
  'payment.webMonetization.explained':
    'ವೆಬ್ ಮೊನೆಟಿಜೇಶನ್ ವೆಬ್ ಪಾವತಿಗಾಗಿ ಒಂದು ಸ್ಥಾನಕ್ಕೆ ಸೂಚಿತ ಮಾನದಂಡ. ಇಲ್ಲಿ ನೀವು ನಿಮ್ಮ ಪಾವತಿ ಪಾಯಂಟರ್ ಅನ್ನು ಸೇರಿಸಬಹುದು, ಮುಂತಾದವು ನಿಮ್ಮ ಪ್ರೊಫೈಲ್ ಪುಟ, ಬ್ಲಾಗ್, ಯೂನಿವರ್ಸ್ ಮತ್ತು ಕಥೆಗಳಲ್ಲಿ ಬಳಸಲು ವೆಬ್ ಮೊನೆಟಿಜೇಶನ್ ದ್ವಾರಾ ಬಳಸಲಾಗುತ್ತದೆ.',
  ...
  'stripeConnect.settings.ongoing':
    'ನಿಮ್ಮ ಖಾತೆಯ ಬಗ್ಗೆ ಸ್ಟ್ರೈಪ್ ನಿಂದ ನಾವು ಹೊಂದಿಕೊಳ್ಳಲು ಕಾಯುತ್ತಿದ್ದೇವೆ. ಇದು ಕೆಲವು ಸಮಯ ತೆಗೆದುಕೊಳ್ಳಬಹುದು. ಇದು ಹೆಚ್ಚು ಹೊತ್ತಿನಷ್ಟು ಕೆಡುಕು ತೆಗೆದುಕೊಳ್ಳುತ್ತಿದ್ದರೆ ಸ್ಟ್ರೈಪ್ ಗೆ ಹಿಂತಿರುಗಿ ಹೋಗುವ ಬಟನ್ ಕ್ಲಿಕ್ ಮಾಡಿ',
  ...
  'payment.donations.payNowUSD':
    '{donation, number, ::compact-short currency/USD} ಗೆ ದಾನ ನೀಡಿ {username}ಗೆ',
  'payment.donations.payNowJPY':
    '{donation, number, ::compact-short currency/JPY} ಗೆ ದಾನ ನೀಡಿ {username}ಗೆ',
  'payment.donations.payNowEUR':
    '{donation, number, ::compact-short currency/EUR} ಗೆ ದಾನ ನೀಡಿ {username}ಗೆ',
  ...
  'payment.universe.haveFans':
    'ನೀವು ಮಾಡುವ ಕೆಲಸಕ್ಕೆ ಮೊದಲು ಆಸಕ್ತರಾಗಿರುವ ಜನರು ನಿಮಗೆ ಸ್ಪಾನ್ಸರ್ ಆಗುವುದು ಸುಲಭ. 100 ರಸಾಯನಗಳನ್ನು ಅವರ ಲೈಬ್ರರಿಗೆ ಸೇರಿಸುವುದು ಪ್ರಾರಂಭ ರೇಖೆ.',
  ...
  'payment.fanClub.priceBreakdown':
    'ಅಭಿನಂದನೆಗಳು, ಗ್ರಾಹಕರು ಪಾವತಿ ಮಾಡುವಾಗ: {amount}. ಪ್ಲಾಟ್‌ಫಾರಂ ಶುಲ್ಕ {fee}, ನೀವು ಪಡೆಯುವುದು: {net}',
  'payment.feeNotice':
    'ದಯವಿಟ್ಟು ಗಮನಿಸಿ, ಇದು ಒಂದು ಅಂಕಿತ ಮೂಲಕ ಮಾತ್ರವೇ ಮತ್ತು ವಾಸ್ತವಿಕ ಶುಲ್ಕ ಗ್ರಾಹಕರ ಪಾವತಿ ಪ್ರಕಾರ ಮತ್ತು ಪಾವತಿ ಗೇಟ್‌ನಿಂದ ಹೆಚ್ಚು ಶುಲ್ಕಗಳ ಆಧಾರದ ಮೇಲೆ ಬೇರೆಯಾಗಬಹುದು.',
