...
export default {
  ...
  'email.enrollAccount.messageHtml':
    'Radi by sme vás pozvali do Literary Universe! Pripravili sme pre vás osobný účet, kde máte prístup ku všetkým funkciám Literárneho vesmíru! Pridajte sa k nám pri vytváraní novej generácie tvorivého písania a čítania!',
  ...
  'email.resetPassword.messageHtml':
    'Dostali sme žiadosť o obnovenie hesla k vášmu účtu, kliknite na tlačidlo nižšie a pokračujte v procese. Ak ste túto žiadosť nepodali, môžete tento e-mail ignorovať, ale možno je vhodný čas skontrolovať svoje bezpečnostné nastavenia.',
  'email.resetPassword.button': 'Obnovenie hesla',
  // E-mail verification
  'email.verifyEmail.messageHtml':
    'Sme radi, že ste sa k nám pripojili! Kliknutím na tlačidlo nižšie overíte túto e-mailovú adresu.',
