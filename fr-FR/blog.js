export default {
    ...
    'blog.literaryCommentary': 'Commentaire littéraire',
    'blog.literaryCommentary.checkbox': 'Il s\'agit d\'un commentaire littéraire',
    'blog.literaryCommentary.description': 'Sélectionnez une histoire ou un univers dans votre bibliothèque pour en faire un commentaire littéraire :',
    'blog.literaryCommentary.rating': 'Classement (facultatif)',
    'blog.literaryCommentary.empty': 'Aucun commentaire littéraire n\'est encore disponible.',
    ...
    'blog.qa.references.title': 'Références',
    'blog.qa.references.add': 'Ajouter une référence',
    'blog.qa.references.sectionTitle': 'Contenu connexe',
    'blog.qa.reference.encyclopedia': 'Entrée dans l\'encyclopédie : {title}',
    'blog.qa.reference.story': 'Histoire : {title}{chapter}',
    'blog.qa.reference.chapter': ' (Chapitre : {chapterTitle})',
    'blog.qa.reference.blogPost': 'Blog Post : {title}',
    'blog.qa.reference.type.encyclopedia': 'Entrée dans l\'encyclopédie',
    'blog.qa.reference.type.story': 'Histoire',
    'blog.qa.reference.type.blog': 'Article de blog',
    'blog.qa.reference.chapter.option': 'Chapitre {sequence}',
    'blog.qa.reference.chapter.untitled': 'Chapitre sans titre',
    'blog.qa.reference.chapter.placeholder': 'Sélectionnez un chapitre...',
    'blog.qa.reference.line': '{typeLabel} - {title}{chapterPart}',
    'blog.qa.reference.type': '{type, select, encyclopedia {📚 Encyclopédie} story {📖 Histoire} blog {📝 Blog} other {Référence}}',
    'blog.qa.outdated.title': 'Statut dépassé',
    'blog.qa.outdated.marked': 'Cette question est considérée comme dépassée.',
    'blog.qa.outdated.replacement': 'Remplacée par une question :',
    'blog.qa.outdated.unmark': 'Marquer comme courant',
    'blog.qa.outdated.mark': 'Marquer comme dépassé',
    'blog.qa.outdated.confirm': 'Marquer comme dépassé',
    'blog.qa.outdated.replacementPlaceholder': 'Rechercher une question de remplacement...',
    'blog.qa.outdated.notice': 'Cette réponse peut être dépassée.',
    'blog.qa.outdated.seeReplacement': 'Voir la réponse actualisée à la question {question}.',
    // Q&A Public
