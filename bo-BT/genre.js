export default {
  'genre.scifi': 'རིགས་བཞིན་པའི་སྤྱོད།',
  'genre.fantasy': 'རྒྱལ་པོ།',
  'genre.adventure': 'འགོ་བཙུགས།',
  'genre.poetry': 'བསྩམས།',
  'genre.comedy': 'བརྩོན་འགྱུར།',
  'genre.drama': 'དྲི་མེད།',
  'genre.nonfiction': 'མི་གནས་སྤྱོད།',
  'genre.fiction': 'བརྗོད།',
  'genre.romance': 'རོང་སྐད།',
  'genre.satire': 'བརྗོད་བརྗེད།',
  'genre.tragedy': 'བརྒྱུད།',
  'genre.crime': 'Crime',
  'genre.historical': 'རྩོམ་པར་རྒྱུད།',
  'genre.horror': 'བརྡ་རྗེའི།',
  'genre.mystery': 'གནས་ཚད།',
  'genre.thriller': 'དཔེ་སྐྲུན།',
  'genre.western': 'རྩོམ་པར།',
  'genre.memoir': 'བརྩོན་འགྲུལ།',
  'genre.biography': 'རྩོམ་རིམ།',
  'genre.steampunk': 'སེར་པར་པོནཀ།',
  'genre.mythology': 'སྨོན་ལམ།',
  'genre.fairytale': 'སྒྲོལ་མེད།',
  'genre.superhero': 'མི་གསལ་པ།',
