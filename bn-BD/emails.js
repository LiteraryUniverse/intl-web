...
export default {
  ...
  'email.enrollAccount.messageHtml':
    'আমরা আপনাকে সাহিত্যিক বিশ্বে আমন্ত্রণ জানাতে চাই! আমরা আগে থেকেই আপনার জন্য একটি ব্যক্তিগত অ্যাকাউন্ট তৈরি করেছি যেখানে আপনি সাহিত্যিক বিশ্বের সমস্ত বৈশিষ্ট্য অ্যাক্সেস করতে পারবেন! অনুগ্রহ করে আমাদের সাহিত্যিক লেখা এবং পঠনের পরবর্তী প্রজন্মে আমাদের সঙ্গে যোগ দিন!',
  ...
  'email.resetPassword.messageHtml':
    'আপনার অ্যাকাউন্টের পাসওয়ার্ড রিসেট করতে আমরা একটি অনুরোধ পেয়েছি, প্রক্রিয়াটি চালিয়ে যেতে নিচের বাটনে ক্লিক করুন। যদি আপনি এই অনুরোধটি না করে থাকেন তবে আপনি এই ইমেলটি উপেক্ষা করতে পারেন, তবে এটি আপনার নিরাপত্তা সেটিংস পর্যালোচনার একটি ভালো সময় হতে পারে।',
  'email.resetPassword.button': 'পাসওয়ার্ড রিসেট করুন',
  // E-mail verification
  'email.verifyEmail.messageHtml':
    'আমরা আপনাকে স্বাগত জানাচ্ছি! দয়া করে এই ইমেল ঠিকানাটি যাচাই করতে নিচের বাটনে ক্লিক করুন।',
