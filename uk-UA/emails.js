...
export default {
  'email.enrollAccount.subject':
    'Запрошення приєднатися до спільноти Літературного Всесвіту для {username}',
  ...
  'email.enrollAccount.signature':
    'З нетерпінням чекаємо на вас,<br />команда Літературного Всесвіту',
  // Reset password
  'email.resetPassword.messageHtml':
    'Ми отримали запит на зміну паролю до вашого облікового запису, будь ласка, натисніть на кнопку нижче, щоб продовжити. Якщо ви не робили такого запиту, ви можете проігнорувати цей лист та рекомендуємо переглянути ваші налаштування безпеки.',
  'email.resetPassword.button': 'Змінити пароль',
  // E-mail verification
  'email.verifyEmail.messageHtml':
    'Ми раді бачити вас на борту! Будь ласка, натисніть кнопку нижче, щоб підтвердити цю адресу електронної пошти.',
