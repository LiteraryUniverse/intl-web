...
export default {
  ...
  'flashnews.onlyDisplayOn':
    'Οι ειδήσεις θα εμφανίζονται μόνο στις επιλεγμένες παρακάτω γλώσσες (εάν έχουν επιλεγεί), δεν θα εμφανίζονται καθόλου ειδήσεις, ακόμα και στην προεπιλεγμένη γλώσσα, σε άλλες γλώσσες.',
  ...
  'notification.workshopStoryStatus.toHiatus':
    'Η ιστορία σας {storyName} πήρε αυτόματα μία παύση μετά από 6 μήνες αδράνειας.',
  'notification.workshopStoryStatus.toCancelled':
    'Η ιστορία σας {storyName} πήρε αυτόματα ακύρωση μετά από ένα χρόνο αδράνειας.',
