export default {
  ...
  'blog.theme': 'Motyw',
  'blog.theme.info':
    'Dostosowanie motywu umożliwi Ci zmianę wyglądu tej strony. Ta funkcja nie jest jeszcze gotowa.',
  ...
  'blog.slug.explained':
    'Ładnie wyglądający odnośnik do wpisu. Unikaj używania znaków specjalnych z wyjątkiem "-".',
  ...
  'blog.settings.universeSettings':
    'Blogi wszechświata są zintegrowane ze stronami wszechświata, a ich podstawowe ustawienia są pobierane z ustawień wszechświata.',
  'blog.settings.organizationSettings':
    'Blogi organizacji są zintegrowane ze stronami organizacji.',
