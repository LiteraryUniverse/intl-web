...
export default {
  ...
  'email.enrollAccount.messageHtml':
    'Gostaríamos de convidá-los a visitar o Universo Literário! Fomos adiante e preparamos uma conta pessoal para você, onde você poderá acessar todas as características do Universo Literário! Junte-se a nós para criar a próxima geração de escrita e leitura criativa!',
  ...
  'email.resetPassword.messageHtml':
    'Recebemos uma solicitação para redefinir sua senha para sua conta, por favor clique no botão abaixo para continuar o processo. Se você não fez esta solicitação, você pode ignorar este e-mail, mas pode ser um bom momento para rever suas configurações de segurança.',
  'email.resetPassword.button': 'Redefinir senha',
  // E-mail verification
  'email.verifyEmail.messageHtml':
    'Estamos felizes em tê-lo a bordo! Favor clicar no botão abaixo para verificar este endereço de e-mail.',
