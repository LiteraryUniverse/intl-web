export default {
  ...
  'feedback.report.reportSaved':
    'റിപ്പോർട്ട് ചെയ്തതിന് നന്ദി! ഞങ്ങൾ പരിശോധിക്കുംവിചാരിക്കുംവന്നാൽ ആക്ഷൻ എടുക്കുംവരുന്നതാണ്.',
  'feedback.report.copyrightReportSaved':
    'റിപ്പോർട്ട് ചെയ്തതിന് നന്ദി! ഞങ്ങൾ പരിശോധിക്കുംവിചാരിക്കുംവന്നാൽ ഞങ്ങൾ ബന്ധപ്പെടുംവരുന്നതാണ്.',
  'feedback.report.copyrightOwnershipDesc': 'ഉടമസ്ഥത പ്രസ്താവന',
  'feedback.report.copyrightNotice':
    'ദയവായി ശ്രദ്ധിക്കുക: ഈ ഫോം ഉപയോക്താവിനെയാണ് അനുവദിക്കുന്നത്. ഉപയോക്താവിനല്ലെങ്കിൽ, ദയവായി ഉപയോക്താവിനെ അറിയിപ്പ് നല്‍കുക അല്ലെങ്കിൽ മറ്റ് വിഭാഗം ഉപയോഗിക്കുകയുംചെയ്യുക. ഞങ്ങൾ കോപിറൈറ്റ് ഉല്ലംഘനങ്ങളെ ഗുരുതിക്കുന്നുവല്ലോപ്പേഴ്‌സ് ഉപയോഗിക്കുന്നതും തീവ്രവാദിതമായ ഉപയോഗം ഉപയോഗിക്കുന്നതും തന്നെ ഗുരുതിക്കുന്നു.',
  ...
  'faq.section.guilds': 'ഗിൽഡുകൾ',
  // About us questions
  'faq.question.about.whatIsLU': 'സാഹിത്യ പ്രപഞ്ചം എന്താണ്?',
  ...
  'faq.answer.about.dataLocation':
    'ലിറ്റററി യൂണിവേർസ് ഡാറ്റ യുണൈറ്റഡ് സ്റ്റേറ്റ്സ് ഓഫ് അമേരിക്കയിൽ സെർവർകൾലെയിലും, പ്രത്യേകിച്ചും AWS us-east-1 പ്രദേശത്തിൽ സ്റ്റോർ ചെയ്യപ്പെടുന്നു.',
