...
export default {
  ...
  'flashnews.onlyDisplayOn':
    'Die nuus sal slegs op die onderstaande gekose tale vertoon word (as enige gekies), geen nuus sal vertoon word, selfs nie in die verstektaal nie, in ander tale nie.',
  ...
  'notification.workshopStoryStatus.toHiatus':
    'Jou storie {storyName} het outomaties op hiatus gesit na 6 maande van inaktiwiteit.',
  'notification.workshopStoryStatus.toCancelled':
    'Jou storie {storyName} het outomaties gekanselleer na een jaar van inaktiwiteit.',
