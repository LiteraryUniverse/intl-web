...
export default {
  ...
  'email.enrollAccount.messageHtml':
    'Мы хотели бы пригласить вас в Literary Universe! Мы подготовили для вас личную учётную запись, где вы сможете получить доступ ко всем возможностям Literary Universe! Пожалуйста, присоединяйтесь к нам в создании нового поколения творческого письма и чтения!',
  'email.enrollAccount.button': 'Перейти к учётной записи',
  'email.enrollAccount.signature':
    'Мы с нетерпением ждём встречи с вами,<br />команда Literary Universe',
  // Reset password
  'email.resetPassword.messageHtml':
    'Мы получили запрос на сброс пароля для вашей учётной записи, пожалуйста, нажмите на кнопку ниже, чтобы продолжить процесс. Если вы не делали этого запроса, вы можете проигнорировать это письмо, но, возможно, сейчас самое время пересмотреть настройки безопасности.',
  'email.resetPassword.button': 'Сбросить пароль',
  // E-mail verification
  'email.verifyEmail.messageHtml':
    'Мы рады видеть вас на борту! Пожалуйста, нажмите на кнопку ниже, чтобы подтвердить этот адрес электронной почты.',
