export default {
  ...
  'settings.languages.notice':
    'ಇಂಗ್ಲೀಷ್ ಮತ್ತು ಚೆಕ್ ಪ್ರಸ್ತುತವಾಗಿ ಯಾವುದೇ ಆಧಾರವಾಗಿ ಬೇಕಾಗಿರುವ ಭಾಷೆಗಳು. ಇತರ ಭಾಷೆಗಳು ಅದ್ಭುತ ಸ್ವಯಂಸೇವಕರು ಮತ್ತು ಏನಾದರೂ ಪೂರ್ತಿಯಾಗಿ ಮತ್ತು ಸರಿಯಾಗಿ ಇಲ್ಲಿರಬಹುದು ಎಂದು ಆರ್ಥಿಕ ಸಹಾಯದಿಂದ ಲಭ್ಯವಿದೆ.',
  ...
  'settings.web3.verify.explained':
    'ಈ ವಿಳಾಸವು ನಿಮ್ಮದೇ ಎಂದು ನಿರ್ಧರಿಸಲು ನಾವು ನಿಮ್ಮಿಂದ ಒಂದು ಸಂದೇಶವನ್ನು ಸಹಿ ಮಾಡಲು ಕೇಳುತ್ತೇವೆ. ಇದು ನಿಮ್ಮ ವಾಲೆಟ್ ಯಲ್ಲಿರುವ ಮಾಲಿಕತ್ವವನ್ನು ಖಚಿತಪಡಿಸುವುದಕ್ಕಾಗಿದೆ.',
  ...
  'settings.web3.linkingMessage':
    'ದಯವಿಟ್ಟು ನೀವು ನಿಮ್ಮ ವಾಲೆಟ್ ಸಾಹಿತ್ಯ ಯೂನಿವರ್ಸ್ ಗೆ ಲಿಂಕ್ ಮಾಡಲು ಬಯಸುವುದನ್ನು ದೃಢಪಡಿಸಿ. ಕೋಡ್: {code}',
  ...
  'settings.accessibility.paragraphHighlighting':
    'ನೀವು ಹೊರಗೆಡುವ ಪದರದ ಮೇಲೆ ಹಾರಿಹೋಗುವಾಗ ಪ್ರಸ್ತುತ ಪದರವನ್ನು ಗುರುತಿಸು',
