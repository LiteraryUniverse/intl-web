...
export default {
    ...
    // for beta only
    'beta.notice': 'Добро пожаловать в литературную вселенную БЕТА. Это общедоступная предварительная версия, и поэтому приложение всё ещё находится в разработке. Это означает, что вы всё ещё можете ожидать ошибок и незавершённых функций. Если вы столкнулись с ошибкой или что-то не работает, сообщите нам об этом и проявите терпение, пока мы всё исправим.',
