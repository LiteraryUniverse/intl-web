export default {
  ...
  'encyclopedia.container.desc':
    'Vytvořit kontejner pro novou skupinu položek. Skryje jej z výpisu kategorií.',
  'encyclopedia.entry.name': 'Jméno záznamu',
  'encyclopedia.summary': 'Shrnutí',
  'encyclopedia.summary.desc':
    'Krátké shrnutí článku. Toto bude standardně zobrazeno jako jediné pole bude-li článek zobrazen ve čtečce.',
  ...
  'encyclopedia.translation.desc':
    'Toto rozhraní encyklopedie se používá pro překlad do {language}. Chcete-li začít překládat, vyberte existující položky v levém menu.',
  ...
  'encyclopedia.settings.categoriesDesc':
    'Zapněte a vypněte kategorie, které chcete použít v encyklopedii.',
  'encyclopedia.settings.introText':
    'Uvítací zpráva, která bude zobrazena hned po popisku vesmíru.',
  ...
  'enc.entries.limitReached':
    'Dosáhli jste maximálního povoleného počtu položek pro aktuální předplatné.',
  ...
  'encyclopedia.settings.templateDescription':
    'Povolit kopírování obsahu této encyklopedie do jiných vesmírů. Toto je nejlepší volba, pokud nemáte žádné příběhy a místo toho jen vytváříte šablonu pro ostatní.',
  ...
  'encyclopedia.templateCopy.description':
    'Zkopírujte obsah této encyklopedie do svého vesmíru, aby jste ho obohatili.',
