export default {
  ...
  'universe.authors.notice':
    'Κάθε ιστορία μπορεί να έχει επιπλέον προσωπικό που έχει εργαστεί πάνω της. Για περισσότερες λεπτομέρειες δείτε τα στοιχεία της ιστορίας.',
  ...
  'universe.fanFiction.notAllowed':
    'Αυτό το Σύμπαν δεν επιτρέπει την εμφάνιση φανταστικής λογοτεχνίας.',
}
