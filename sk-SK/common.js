...
export default {
    ...
    'site.description': 'Literárny vesmír je komplexná platforma na tvorivé písanie a publikovanie veľkých príbehových vesmírov.',
    ...
    'error.oops': 'Ups! Niečo sa vážne pokazilo!',
    'error.apologies': 'Ospravedlňujeme sa za nepríjemnosti a urobíme všetko pre to, aby sme to čoskoro napravili.',
    ...
    'common.swUpdate.ready.title': 'Pripravená aktualizácia',
    'common.swUpdate.ready.description': 'Nová verzia je pripravená. Môžete ju použiť teraz.',
    'common.swUpdate.ready.writerDescription': 'Nová verzia je pripravená. Použite ju, keď dokončíte aktuálne úpravy písania.',
    'common.swUpdate.apply': 'Aktualizovať teraz',
    ...
    'common.publishNow': 'Publikovať teraz',
    'common.publishLater': 'Publikovať neskôr',
    ...
    'story.notes.audienceAgeGroup': 'Veková skupina cieľového publika',
    'story.notes.audienceSex': 'Pohlaví cieľového publika',
    ...
    'common.done': 'Hotovo',
    'contentSelector.noSelection': 'Žiadne vybrané položky',
    'contentSelector.selectedItems': 'Vybrané položky',
    'contentSelector.entireSite': 'Vyhľadávanie na webe',
    'contentSelector.tabsLabel': 'Možnosti vyhľadávania',
    'contentSelector.title': 'Vyberte obsah',
    ...
    create: 'Vytvoriť',
    'banner.support': 'Literary Universe je možný vďaka podpore používateľov, ako ste vy. Ak nám chcete pomôcť zostať nezávislí a zlepšovať platformu, zvážte, či si nepredplatíte niektorý z našich plánov.',
    ...
    'actions.sendToKindle': 'Odoslať do Kindle',
    ...
    'common.creating': 'Vytváranie...',
    // Invitation landing page
    'invitation.page.title': 'Pozvánka',
    'invitation.title': 'Boli ste pozvaní!',
    'invitation.detail.invitedBy': 'Pozval',
    'invitation.detail.to': 'Ak sa chcete pripojiť',
    'invitation.detail.role': 'Úloha',
    'invitation.role.member': 'Člen',
    'invitation.role.collaborator': 'Spolupracujúci subjekt',
    'invitation.role.translator': 'Prekladateľ',
    'invitation.role.beta': 'Beta čitateľ',
    'invitation.objectType.organization': 'organizácia',
    'invitation.objectType.story': 'príbeh',
    'invitation.objectType.universe': 'vesmír',
    'invitation.accept': 'Prijať pozvanie',
    'invitation.accepting': 'Prijímanie...',
    'invitation.decline': 'Pokles',
    'invitation.loginRequired': 'Ak chcete odpovedať na túto výzvu, prihláste sa alebo si vytvorte konto.',
    'invitation.haveAccount': 'Mám účet',
    'invitation.newHere': 'Som tu nový',
    'invitation.registerPrompt': 'Ak chcete prijať túto pozvánku, vytvorte si bezplatné konto.',
    'invitation.register': 'Vytvorenie konta',
    'invitation.goToDashboard': 'Prejsť na prístrojový panel',
    'invitation.alreadyAccepted.title': 'Pozvanie už bolo prijaté',
    'invitation.alreadyAccepted.message': 'Toto pozvanie už bolo prijaté.',
    'invitation.alreadyDeclined.title': 'Pozvanie bolo odmietnuté',
    'invitation.alreadyDeclined.message': 'Toto pozvanie bolo odmietnuté.',
    'invitation.declined.title': 'Pozvanie bolo odmietnuté',
    'invitation.declined.message': 'Pozvanie ste odmietli.',
    'invitation.cancelled.title': 'Pozvánka zrušená',
    'invitation.cancelled.message': 'Odosielateľ túto pozvánku zrušil.',
