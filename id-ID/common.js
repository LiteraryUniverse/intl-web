...
export default {
    ...
    'common.swUpdate.ready.title': 'Pembaruan siap',
    'common.swUpdate.ready.description': 'Versi baru sudah siap. Anda dapat menerapkannya sekarang.',
    'common.swUpdate.ready.writerDescription': 'Versi baru sudah siap. Terapkan setelah Anda menyelesaikan pengeditan tulisan Anda saat ini.',
    'common.swUpdate.apply': 'Perbarui sekarang',
    ...
    'dashboard.writerResume': 'Resume Penulis',
    ...
    'common.done': 'Selesai',
    'contentSelector.noSelection': 'Tidak ada item yang dipilih',
    'contentSelector.selectedItems': 'Item yang dipilih',
    'contentSelector.entireSite': 'Situs Pencarian',
    'contentSelector.tabsLabel': 'Opsi pencarian',
    'contentSelector.title': 'Pilih Konten',
    ...
    'invitation.page.title': 'Undangan',
    'invitation.title': 'Anda telah diundang!',
    'invitation.detail.invitedBy': 'Diundang oleh',
    'invitation.detail.to': 'Untuk bergabung',
    'invitation.detail.role': 'Peran',
    'invitation.role.member': 'Anggota',
    'invitation.role.collaborator': 'Kolaborator',
    ...
    'invitation.accept': 'Menerima undangan',
    'invitation.accepting': 'Menerima...',
    'invitation.decline': 'Menolak',
    'invitation.loginRequired': 'Silakan masuk atau buat akun untuk merespons undangan ini.',
    'invitation.haveAccount': 'Saya memiliki akun',
    'invitation.newHere': 'Aku baru di sini.',
    'invitation.registerPrompt': 'Buat akun gratis untuk menerima undangan ini.',
    'invitation.register': 'Membuat akun',
    'invitation.goToDashboard': 'Buka Dasbor',
    'invitation.alreadyAccepted.title': 'Undangan sudah diterima',
    'invitation.alreadyAccepted.message': 'Undangan ini telah diterima.',
    'invitation.alreadyDeclined.title': 'Undangan ditolak',
    'invitation.alreadyDeclined.message': 'Undangan ini telah ditolak.',
    'invitation.declined.title': 'Undangan ditolak',
    'invitation.declined.message': 'Anda telah menolak undangan tersebut.',
    'invitation.cancelled.title': 'Undangan dibatalkan',
    'invitation.cancelled.message': 'Undangan ini telah dibatalkan oleh pengirim.',
