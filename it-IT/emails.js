...
export default {
  ...
  'email.enrollAccount.messageHtml':
    'Ti invitiamo a Literary Universe! Abbiamo creato il tuo speciale account personale dove puoi accedere a tutte le funzionalità di Literary Universe! Unisciti a noi per dare vita alla prossima generazione di scrittura creativa e strumenti di lettura!',
  'email.enrollAccount.button': 'Accedi al tuo account',
  'email.enrollAccount.signature':
    "Non vediamo l'ora di vederti,<br />il team di Literary Universe",
  // Reset password
  'email.resetPassword.messageHtml':
    'Abbiamo ricevuto una richiesta per reimpostare la password del tuo account, clicca sul pulsante qui sotto per continuare il processo. Se non hai effettuato la richiesta, puoi ignorare questa e-mail, ma potrebbe essere una buona occasione per rivedere le tue impostazioni di sicurezza.',
  'email.resetPassword.button': 'Reimposta password',
  // E-mail verification
  'email.verifyEmail.messageHtml':
    'Siamo felici di averti con noi! Clicca il pulsante qui sotto per verificare questo indirizzo e-mail.',
