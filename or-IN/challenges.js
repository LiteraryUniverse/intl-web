export default {
  ...
  'challenges.future.wordcount':
    'ଶବ୍ଦଗଣନା ଚାଲଞ୍ଚରେ ପ୍ରାରମ୍ଭ ହେଉଛି {startDate, date, short} ଏବଂ ଲକ୍ଷ୍ୟ ହେଉଛି {target, number} ଶବ୍ଦ ଦ୍ୱାରା {endDate, date, short}ପାଇଁ ।',
  ...
  'challenges.wordcount.desc': `ଏହି {type, select,
    story {କାହାଣୀ}
    universe {ଜଗତ୍ରୁଟି}
    other {ପାଇଁ ୨ୟ ମାସରେ ଆପଣ କତି ଶବ୍ଦ ଲେଖିବାର ଲକ୍ଷ୍ୟ ରଖନ୍ତୁ}
  }।`,
  ...
  'nanowrimo.error.wordcount':
    'NaNoWrimo ରେ wordcount ନିର୍ଧାରଣ କରିବାକୁ ଅସମର୍ଥ, ଦୟାକରି ଆପଣଙ୍କର ସତ୍ୟାପାତ୍ରତା ଦ୍ୱିତୀୟ ଚେକ କରନ୍ତୁ ଏବଂ ପୁନର୍ଚ୍ଚେଷ୍ଟା କରନ୍ତୁ ।',
