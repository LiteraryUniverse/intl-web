...
export default {
  ...
  'email.enrollAccount.messageHtml':
    'نود دعوتك لعالم الأدب! لقد قمنا بإعداد حساب شخصي خاص بك حيث يمكنك الوصول إلى جميع ميزات عالم الأدب! يرجى الانضمام إلينا في إبداع الكتابة والقراءة في الجيل القادم!',
  ...
  'email.resetPassword.messageHtml':
    'لقد تلقينا طلبًا لإعادة تعيين كلمة المرور الخاصة بحسابك، يرجى النقر على الزر أدناه لمتابعة العملية. إذا لم تقم بطلب ذلك، يمكنك تجاهل هذا البريد الإلكتروني، ولكن قد يكون من الجيد مراجعة إعدادات الأمان الخاصة بك.',
  'email.resetPassword.button': 'إعادة تعيين كلمة المرور',
  // E-mail verification
  'email.verifyEmail.messageHtml':
    'نحن سعداء بوجودك معنا! يرجى النقر على الزر أدناه للتحقق من عنوان البريد الإلكتروني هذا.',
