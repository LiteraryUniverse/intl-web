...
export default {
 ...
 アカウントパスワードリセットリクエストを受け取りました。
  ...
  'email.enrollAccount.messageHtml':
    'Literary Universeにご招待します。Lieterary Universeのすべての機能にアクセスできるようにすでに個人アカウントを用意しました！ 次世代のクリエイティブなライティングとリーディングの作成にぜひご参加ください。',
  'email.enrollAccount.button': 'アカウントにアクセスする',
  'email.enrollAccount.signature':
    'お会いできるのを楽しみにしています,<br />Literary Universeチームより',
  // Reset password
  'email.resetPassword.messageHtml':
    'アカウントのパスワードリセットリクエストを受け取りました。プロセスを続けるには、下のボタンをクリックしてください。 このリクエストをまだ行っていない場合は、このメールはご放念ください。セキュリティ設定のご確認をしていただくことをお勧めします。',
  'email.resetPassword.button': 'パスワードの再設定',
  // E-mail verification
  'email.verifyEmail.messageHtml':
    '皆様のご参加をお待ちしております。 下のボタンをクリックして、このメールアドレスを確認してください。',
