...
export default {
    ...
    'error.oops': '이런! 뭔가 심각한 문제가 발생했습니다!',
    'error.apologies': '불편을 드려 죄송하며, 조속히 문제를 해결할 수 있도록 최선을 다하겠습니다.',
    'error.400.text': '오류 400: {errorMessage}',
    'common.offlineStatus': '현재 오프라인 상태입니다.',
    male: '남성',
    female: '여성',
    'common.legal.effectiveAt': '부터 적용 {date, date, medium}',
    select: '선택하세요',
    'common.statusFailed': '서버에 연결하지 못했습니다.',
    'common.statusConnecting': '서버에 연결하려고 합니다... ({count, number})',
    'common.swUpdate.ready.title': '업데이트 준비 완료',
    'common.swUpdate.ready.description': '새 버전이 준비되었습니다. 지금 바로 적용할 수 있습니다.',
    'common.swUpdate.ready.writerDescription': '새 버전이 준비되었습니다. 현재 글쓰기 편집이 끝나면 적용하세요.',
    'common.swUpdate.apply': '지금 업데이트',
    'slug.checking': '확인 중...',
    ...
    'errorLoading.explained': '페이지가 로드되는 동안 오류가 발생했습니다. 불편을 드려 죄송합니다. 페이지에 다시 접속해 보세요. 문제가 지속되면 알려주시기 바랍니다.',
    ...
    goodbyeForever: '유감입니다. 저희가 잘못한 일이 있나요? 그렇다면 알려주세요. 어느 쪽이든, 앞으로의 노력에 최선을 다하시길 바라며 다시 만날 수 있기를 바랍니다! 오래오래 번영하세요!',
    'goodbyeForever.feedback': '더 잘할 수 있는 부분을 알려주세요.',
    'common.edit': '편집',
    'common.publish': '게시',
    'common.publishAt': '게시 날짜와 시간',
    'common.publishNow': '지금 게시',
    'common.publishLater': '나중에 게시',
    'a11y.user.menu': '사용자 메뉴',
    'a11y.navigation': '탐색',
    'dashboard.profile': '내 프로필',
    'dashboard.writerResume': '저자 이력서',
    ...
    'story.notes.audienceAgeGroup': '타겟 고객 연령대',
    'story.notes.audienceSex': '타겟 고객 성별',
    'common.members': '멤버',
    'common.language': '언어',
    next: '다음',
    previous: '이전',
    ...
    'common.done': '완료',
    'contentSelector.noSelection': '선택한 항목이 없습니다.',
    'contentSelector.selectedItems': '선택한 항목',
    'contentSelector.entireSite': '사이트 검색',
    'contentSelector.tabsLabel': '검색 옵션',
    'contentSelector.title': '콘텐츠 선택',
    recommended: '추천',
    ...
    'invitation.page.title': '초대',
    'invitation.title': '초대되었습니다!',
    'invitation.detail.invitedBy': '초대 대상',
    'invitation.detail.to': '가입하려면',
    'invitation.detail.role': '역할',
    'invitation.role.member': '회원',
    'invitation.role.collaborator': '공동 작업자',
    'invitation.role.translator': '번역기',
    'invitation.role.beta': '베타 리더',
    'invitation.objectType.organization': '조직',
    'invitation.objectType.story': '스토리',
    'invitation.objectType.universe': '유니버스',
    'invitation.accept': '초대 수락',
    'invitation.accepting': '수락...',
    'invitation.decline': '거절',
    'invitation.loginRequired': '이 초대에 응답하려면 로그인하거나 계정을 만드세요.',
    'invitation.haveAccount': '계정이 있습니다.',
    'invitation.newHere': '신규 회원입니다.',
    'invitation.registerPrompt': '이 초대를 수락하려면 무료 계정을 만드세요.',
    'invitation.register': '계정 만들기',
    'invitation.goToDashboard': '대시보드로 이동',
    'invitation.alreadyAccepted.title': '이미 초대 수락',
    'invitation.alreadyAccepted.message': '이 초대는 이미 수락되었습니다.',
    'invitation.alreadyDeclined.title': '초대 거부됨',
    'invitation.alreadyDeclined.message': '이 초대는 거절되었습니다.',
    'invitation.declined.title': '초대 거부됨',
    'invitation.declined.message': '초대를 거절했습니다.',
    'invitation.cancelled.title': '초대 취소됨',
    'invitation.cancelled.message': '발신자가 이 초대를 취소했습니다.',
