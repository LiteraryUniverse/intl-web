export default {
  ...
  'payment.card.details': `{type, select,
    ...
    'payment.fanClub.priceBreakdown': 'സബ്‌സ്‌ക്രൈബർ ചെലവഴിക്കും: {amount}। പ്ലാറ്റ്ഫോം ഫീ {fee} ആണ് ({platformPercentage})، സ്ട്രൈപ്പിൽനിന്നുള്ള അനുമാനിക്കുന്ന ഫീസ്: {stripeFee} ({stripeBaseFee} അടയാള ഇടവഴി വില + പണമുകളുടെ ശതമാനം), നിങ്ങൾക്ക് ലഭിക്കുന്നത് (അനുമാനിക്കുന്നു): {net}',
    'payment.fanClub.learnStripeFees': 'സ്ട്രൈപ് ഫീസ് കുറിച്ചുള്ള കൂടുതൽ അറിയുക.',
    'payment.feeNotice': 'ദയവായി ശ്രദ്ധിക്കുക: ഇത് ഒരു അനുമാനം മാത്രമെന്ന് ഗമനിക്കുക, പുതിയതായിരിക്കാവുന്ന പേയ്മെന്റ് പ്രകാരം സ്ട്രൈപ്പ് ഫീ വ്യത്യസ്തമാകും എന്ന് അറിയാം കസ്റ്റമർമാർ പണത്തിന്റെ ഇടവഴികൾക്കും അതിനു കൂടുതൽ ചാർജുകള്‍ക്കും അനുബന്ധ വിവരങ്ങൾക്കും അടിസ്ഥാനമാക്കാവുന്നു.',
