export default {
  ...
  'encyclopedia.help.text':
    'Use o menu à esquerda para navegar entre os itens na enciclopédia. Depois de selecionar um iten, será exibido no lugar deste texto.',
  'encyclopedia.help.sidebar': 'Caixa de ferramentas da barra lateral',
  'encyclopedia.help.sidebar.text':
    'Bem-vindo à sua história! Esta barra lateral permite acesso fácil a todos os recursos relacionados à sua história. Verifique os ícones acima para ver os comentários mais recentes, suas anotações, pesquisar sua enciclopédia, navegar e adicionar novas entradas à sua enciclopédia. Se você deseja adicionar uma conexão a uma entrada do texto da história, selecione o texto onde deseja colocá-la e clique no botão de conexão. Você será então solicitado a encontrar e selecionar um item.',
  ...
  'encyclopedia.container.desc':
    'Faça desta entrada um container para um novo grupo de entradas. Isso irá ocultá-la da listagem de categorias.',
  'encyclopedia.entry.name': 'Nome da entrada',
  'encyclopedia.summary': 'Sumário',
  'encyclopedia.summary.desc':
    'Esta é um resumo que será a única informação inicial exibida ao leitor.',
  ...
  'encyclopedia.translation.desc':
    'Esta interface da enciclopédia é usada para a tradução para o(a) {language}. Escolha as entradas existentes na lista à esquerda para começar a tradução.',
  ...
  'encyclopedia.settings.categoriesDesc':
    'Ative e desative as categorias que você deseja usar em sua enciclopédia.',
  ...
  'enc.entries.limitReached':
    'Você atingiu o limite máximo de entradas permitidas para a sua assinatura atual.',
  ...
  'encyclopedia.settings.templateDescription':
    'Permitir que o conteúdo desta enciclopédia seja copiado para outros universos. Isso é melhor se você não tiver nenhuma história e, em vez disso, estiver apenas criando um modelo para que outros possam usar.',
