export default {
  ...
  'encyclopedia.container.desc':
    'Convertir esta entrada en un contendor para un nuevo grupo de entradas. Esto lo ocultará del listado de categorías.',
  'encyclopedia.entry.name': 'Nombre de la entrada',
  'encyclopedia.summary': 'Resumen',
  'encyclopedia.summary.desc':
    'Esto es un resumen que será la única información inicial que se muestre al lector.',
  ...
  'encyclopedia.translation.desc':
    'La interfaz de esta enciclopedia se usa para traducir al {language}. Elige entradas existentes en la lista de la izquierda para empezar a traducirlas.',
  ...
  'encyclopedia.settings.categoriesDesc':
    'Activa y desactiva categorías que quieras usar en tu enciclopedia.',
  'encyclopedia.settings.introText':
    'Mensaje de bienvenida para mostrar tras la descripción del universo.',
  ...
  'enc.entries.limitReached':
    'Has alcanzado el máximo de entradas de enciclopedia permitidas para tu suscripción.',
  ...
  'encyclopedia.settings.templateDescription':
    'Permite que el contenido de esta enciclopedia se copie en otros universos. Esto es mejor si no tienes ninguna historia y en su lugar estás creando una plantilla para que otros la usen.',
  ...
  'encyclopedia.templateCopy.description':
    'Copia el contenido de esta enciclopedia en tu universo para enriquecerlo.',
