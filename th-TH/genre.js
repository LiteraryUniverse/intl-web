export default {
  'genre.scifi': 'วิทยาศาสตร์ขนาดใหญ่',
  'genre.fantasy': 'แฟนตาซี',
  'genre.adventure': 'ผจญภัย',
  'genre.poetry': 'บทกวี',
  'genre.comedy': 'ตลก',
  'genre.drama': 'ละคร',
  'genre.nonfiction': 'งานที่ไม่ใช่นิยาย',
  'genre.fiction': 'เรื่องอ่านเล่น',
  'genre.romance': 'โรแมนติก',
  'genre.satire': 'การเขียนตลก',
  'genre.tragedy': 'เรื่องเศร้าโศก',
  'genre.crime': 'Crime',
  'genre.historical': 'นิยายประวัติศาสตร์',
  'genre.horror': 'สยองขวัญ',
  'genre.mystery': 'ความลึกลับ',
  'genre.thriller': 'ระทึกขวัญ',
  'genre.western': 'คนตะวันตก',
  'genre.memoir': 'บันทึกอัจฉริยะ',
  'genre.biography': 'ชีวประวัติ',
  'genre.steampunk': 'สตีมปังก์',
  'genre.mythology': 'ตำนาน',
  'genre.fairytale': 'นิทานเทพนิยาย',
  'genre.superhero': 'ซุปเปอร์ฮีโร่',
  ...
  'genre.fantasy.description':
    'แฟนตาซีเป็นประเภทของวรรณกรรมที่มีองค์ประกอบของเวทมนตร์ เหตุการณ์เหนือธรรมชาติ และสัตว์ที่มีตำนาน โดยทั่วไปจะเกี่ยวข้องกับฮีโร่ที่ออกเดินทาง การต่อสู้ระหว่างความดีและความชั่วร้าย และเรื่องราวเกี่ยวกับการเติบโตของตัวละคร แฟนตาซีสามารถแบ่งออกเป็นประเภทย่อยเช่น แฟนตาซีแฮย์ แฟนตาซีเมือง แฟนตาซีมืด และนิทาน และอื่นๆ อีกมากมาย มักจะนำเสนอเรื่องราวเกี่ยวกับศีลธรรมและจริยธรรม การสำรวจลักษณะของความดีและความชั่วร้าย',
  ...
  'genre.isekai.description':
    'ประเภทย่อยของนวนิยายไลท์โนเวล มังงะ และอนิเมะญี่ปุ่นที่เกี่ยวข้องกับตัวละครที่ถูกส่งผ่านหรือเกิดใหม่ในโลกหรือจักรวาลที่แตกต่างหรือแอลเทอร์เนทีฟ ตัวละครหลักต้องเดินทางและปรับตัวในวัฒนธรรมและสภาพแวดล้อมใหม่ของโลก โดยทั่วไปจะได้รับความสามารถใหม่และพบกับเพื่อนร่วมทางและศัตรูใหม่ในระหว่างการเดินทาง เรื่องราวเหล่านี้สามารถเป็นเรื่องตลกหรือมืดมนเป็นไปได้ แต่ทุกครั้งจะมีการนำเสนอทัศนคติและความจินตนาการใหม่ในกรอบของเรื่องผจญภัยคลาสสิก',
}
