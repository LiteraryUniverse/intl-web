...
export default {
  ...
  'email.enrollAccount.messageHtml':
    'Vi skulle vilja bjuda in dig till Literary Universe! Vi har gått vidare och förberett ett personligt konto för dig där du kan få tillgång till alla funktioner i Literary Universe! Var med oss och skapa nästa generation av kreativt skrivande och läsning!',
  ...
  'email.resetPassword.messageHtml':
    'Vi har fått en begäran om att återställa ditt lösenord för ditt konto, klicka på knappen nedan för att fortsätta processen. Om du inte har gjort denna begäran kan du ignorera detta e-postmeddelande, men det kan vara en bra tid att granska dina säkerhetsinställningar.',
  'email.resetPassword.button': 'Återställ lösenord',
  // E-mail verification
  'email.verifyEmail.messageHtml':
    'Vi är glada att ha dig ombord! Klicka på knappen nedan för att verifiera denna e-postadress.',
