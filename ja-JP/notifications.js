...
export default {
  ...
  'flashnews.onlyDisplayOn':
    'ニュースは、以下で選択された言語（選択されている場合）のみで表示され、他の言語ではデフォルト言語であっても表示されません。',
  ...
  'notification.workshopStoryStatus.toHiatus':
    'あなたの物語 {storyName} は、無活動状態が6か月続いた後、自動的に中断状態に設定されました。',
  'notification.workshopStoryStatus.toCancelled':
    'あなたの物語 {storyName} は、無活動状態が1年間続いた後、自動的にキャンセル状態に設定されました。',
