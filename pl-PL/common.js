...
export default {
    ...
    'common.fanmanager': 'Menedżer kreacji fanów',
    'common.fanarts': 'Fan Arts',
    'common.fanfiction': 'Fanfikcja',
    ...
    'story.hiatusAt': 'Na przerwie od {date, date, medium}.',
    'story.cancelledAt': 'Anulowano na {date, date, medium}.',
    ...
    'error.oops': 'Ups! Coś poszło nie tak!',
    'error.apologies': 'Przepraszamy za niedogodności, dołożymy wszelkich starań, aby wkrótce to naprawić.',
    'error.400.text': 'Błąd 400: {errorMessage}',
    ...
    'common.swUpdate.ready.title': 'Aktualizacja gotowa',
    'common.swUpdate.ready.description': 'Nowa wersja jest już gotowa. Mogą ją Państwo zastosować już teraz.',
    'common.swUpdate.ready.writerDescription': 'Nowa wersja jest gotowa. Proszę ją zastosować po zakończeniu bieżącej edycji tekstu.',
    'common.swUpdate.apply': 'Proszę zaktualizować teraz',
    ...
    'common.publishNow': 'Proszę opublikować teraz',
    'common.publishLater': 'Proszę opublikować później',
    'a11y.user.menu': 'Menu użytkownika',
    'a11y.navigation': 'Nawigacja',
    'dashboard.profile': 'Twój profil',
    'dashboard.writerResume': 'Życiorys pisarza',
    ...
    'story.notes.audienceAgeGroup': 'Docelowa grupa wiekowa odbiorców',
    'story.notes.audienceSex': 'Docelowa płeć odbiorców',
    ...
    'common.done': 'Gotowe',
    'contentSelector.noSelection': 'Nie wybrano żadnych elementów',
    'contentSelector.selectedItems': 'Wybrane pozycje',
    'contentSelector.entireSite': 'Strona wyszukiwania',
    'contentSelector.tabsLabel': 'Opcje wyszukiwania',
    'contentSelector.title': 'Proszę wybrać zawartość',
    ...
    create: 'Utwórz',
    'banner.support': 'Literary Universe jest możliwe dzięki wsparciu użytkowników takich jak Państwo. Aby pomóc nam zachować niezależność i ulepszać platformę, prosimy rozważyć subskrypcję jednego z naszych planów.',
    'banner.seePlans': 'Aby uzyskać więcej informacji, prosimy odwiedzić naszą stronę z planami.',
    ...
    // File upload strings
    'upload.files': 'Przesłane pliki',
    'upload.dropHere': 'Proszę wrzucać pliki tutaj...',
    'upload.dragOrClick': 'Przeciągnij i upuść pliki tutaj lub kliknij, aby wybrać pliki',
    'upload.maxSize': 'Maksymalny rozmiar pliku: {size}',
    ...
    'invitation.page.title': 'Zaproszenie',
    'invitation.title': 'Zostali Państwo zaproszeni!',
    'invitation.detail.invitedBy': 'Na zaproszenie',
    'invitation.detail.to': 'Aby dołączyć',
    'invitation.detail.role': 'Rola',
    'invitation.role.member': 'Członek',
    'invitation.role.collaborator': 'Współpracownik',
    'invitation.role.translator': 'Tłumacz',
    'invitation.role.beta': 'Beta reader',
    'invitation.objectType.organization': 'organizacja',
    'invitation.objectType.story': 'historia',
    'invitation.objectType.universe': 'wszechświat',
    'invitation.accept': 'Proszę przyjąć zaproszenie',
    'invitation.accepting': 'Przyjmując...',
    'invitation.decline': 'Spadek',
    'invitation.loginRequired': 'Proszę się zalogować lub utworzyć konto, aby odpowiedzieć na to zaproszenie.',
    'invitation.haveAccount': 'Mam konto',
    'invitation.newHere': 'Jestem tu nowy',
    'invitation.registerPrompt': 'Proszę utworzyć bezpłatne konto, aby przyjąć to zaproszenie.',
    'invitation.register': 'Proszę utworzyć konto',
    'invitation.goToDashboard': 'Proszę przejść do Panelu',
    'invitation.alreadyAccepted.title': 'Zaproszenie zostało już przyjęte',
    'invitation.alreadyAccepted.message': 'To zaproszenie zostało już przyjęte.',
    'invitation.alreadyDeclined.title': 'Zaproszenie odrzucone',
    'invitation.alreadyDeclined.message': 'To zaproszenie zostało odrzucone.',
    'invitation.declined.title': 'Zaproszenie odrzucone',
    'invitation.declined.message': 'Odrzucił Pan zaproszenie.',
    'invitation.cancelled.title': 'Zaproszenie anulowane',
    'invitation.cancelled.message': 'To zaproszenie zostało anulowane przez nadawcę.',
