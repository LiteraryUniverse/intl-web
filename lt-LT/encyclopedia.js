export default {
  ...
  'encyclopedia.help.text':
    'Naudokite meniu kairėje, kad naviguotumėte tarp elementų enciklopedijoje. Kai pasirinksite elementą, jis bus rodomas vietoj šio teksto.',
  ...
  'encyclopedia.container.desc':
    'Padarykite šį įrašą konteineriu naujai grupės įrašų. Tai paslėps jį nuo kategorijų sąrašo.',
  'encyclopedia.entry.name': 'Įrašo pavadinimas',
  'encyclopedia.summary': 'Santrauka',
  'encyclopedia.summary.desc':
    'Tai yra santrauka, kuri bus vienintelė pradinė informacija, rodoma skaitytojui.',
  ...
  'encyclopedia.translation.desc':
    'Šis enciklopedijos sąsajos naudojamas vertimui į {language}. Pasirinkite esamus įrašus sąraše kairėje, norėdami pradėti jų vertimą.',
  ...
  'encyclopedia.settings.categoriesDesc':
    'Įjunkite ir išjunkite kategorijas, kurias norite naudoti savo enciklopedijoje.',
  'encyclopedia.settings.introText':
    'Sveikinimo pranešimas, kuris bus rodomas po visatos aprašymo.',
  ...
  'enc.entries.limitReached':
    'Jūs pasiekėte maksimalų leistiną enciklopedijos įrašų skaičių jūsų dabartinei prenumeratai.',
  ...
  'encyclopedia.settings.templateDescription':
    'Leisti nukopijuoti šios enciklopedijos turinį į kitas visatas. Tai geriausia, jei neturite jokių pasakojimų ir vietoj to tik kuriate šabloną, kurį kiti galės naudoti.',
  ...
  'encyclopedia.templateCopy.description':
    'Nukopijuokite šios enciklopedijos turinį į savo visatą, kad ją papildytumėte.',
