export default {
    ...
    'feedback.bugs.desc': 'Har du stött på ett fel eller något annat som är fel eller inte på sin plats? Låt oss veta det här!',
    ...
    'feedback.report.copyrightNotice': 'Observera att du måste vara den rättmätiga ägaren till verket för att kunna använda detta formulär. Om du inte är ägaren, vänligen informera ägaren eller använd den andra kategorin för att informera oss. Vi tar brott mot upphovsrätten på största allvar, och detsamma gäller olämplig och kränkande användning av detta formulär.',
    ...
    'feedback.reportType.soliciting': 'Uppmaning',
    'feedback.reportType.aiUnmarked': 'Omärkt AI-genererat innehåll',
