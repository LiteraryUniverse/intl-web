...
export default {
  ...
  'email.enrollAccount.messageHtml':
    'Gostaríamos de convidá-lo a visitar o Universo Literário! Prosseguimos e preparámos para si uma conta pessoal onde pode aceder a todas as funcionalidades do Universo Literário! Junte-se a nós na criação da próxima geração de escrita e leitura criativa!',
  ...
  'email.resetPassword.messageHtml':
    'Recebemos um pedido para reiniciar a palavra passe da sua conta, por favor clique no botão abaixo para continuar o processo. Se não fez este pedido, pode ignorar este email, mas pode ser um bom momento para rever as suas definições de segurança.',
  'email.resetPassword.button': 'Redefinir palavra passe',
  // E-mail verification
  'email.verifyEmail.messageHtml':
    'Estamos felizes por tê-lo a bordo! Por favor clique no botão abaixo para verificar este endereço de email.',
