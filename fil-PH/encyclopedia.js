export default {
  ...
  'encyclopedia.help.text':
    'Gamitin ang menu sa kaliwa upang mag-navigate sa mga item sa ensiklopedya. Kapag pinili mo ang isang item, ito ay ipapakita sa halip ng teksto na ito.',
  ...
  'encyclopedia.add.moresoon':
    'Mas maraming mga kategorya ang darating sa lalong madaling panahon!',
  ...
  'encyclopedia.container.desc':
    'Gawing container ang entry na ito para sa isang bagong grupo ng mga entry. Ito ay magtatago mula sa listahan ng mga kategorya.',
  'encyclopedia.entry.name': 'Pangalan ng entry',
  'encyclopedia.summary': 'Buod',
  'encyclopedia.summary.desc':
    'Ito ay isang buod na magiging tanging unang impormasyon na ipapakita sa mambabasa.',
  ...
  'encyclopedia.translation.desc':
    'Ang interface ng ensiklopedya na ito ay ginagamit para sa pagsasalin sa {language}. Pumili ng umiiral na mga entry sa listahan sa kaliwa para simulan ang kanilang pagsasalin.',
  ...
  'encyclopedia.settings.categoriesDesc':
    'I-on at i-off ang mga kategoryang nais mong gamitin sa iyong ensiklopedya.',
  'encyclopedia.settings.introText':
    'Mensahe ng pagtanggap na ipapakita matapos ang paglalarawan ng universe.',
  ...
  'enc.entries.limitReached':
    'Naratnan mo na ang pinakamataas na pinapayagang mga entry sa ensiklopedya para sa iyong kasalukuyang subscription.',
  ...
  'encyclopedia.settings.templateDescription':
    'Payagan ang nilalaman ng pambansang aklatan na mailipat sa iba pang mga uniberso. Ito ay pinakamahusay kung wala kang anumang mga kwento at sa halip ay gumagawa lamang ng isang template na magagamit ng iba.',
  ...
  'encyclopedia.templateCopy.description':
    'Kopyahin ang nilalaman ng pambansang aklatan na ito sa iyong uniberso upang palawakin ito.',
