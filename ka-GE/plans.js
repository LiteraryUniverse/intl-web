export default {
  ...
  'plans.faq.justification':
    'აქ ლიტერატურულ უნივერსუმეზე ჩვენ მაინც ვერავინარებთ თქვენი პირად მონაცემების გამოყენებას რეკლამისთვის ან სხვა კომპანიებს. ეს ნიშნავს, რომ ჩვენ უნდა შევქმნათ ბევრი რამაც ჩვენივერსუმზე. ეს მრავალი დრო და ხარჯით არის მარტივი. ამიტომ ჩვენ გავაკეთეთ უფასო წევრობა, რომელიც არის მცირე ლიტერატურული უნივერსის პრევიუ (რომელიც კვლავაც თქვენ შეგიძლიათ გააკეთოთ ყველა მნიშვნელობას) რომ მოძებნოთ ყველას საჭირო რესურსი და გაგვიმარტივოთ სერვისის გამართვა და განვათავსოთ მოწყობილობა. თუ გინდათ რაც ჩვენ ვაშენებთ, გთხოვთ გაიაროთ ერთი გადახდის ვარიანტი. გმადლობთ!',
  'plans.limits': 'Limits',
  ...
  'plans.feature.personalNotesStoriesUniverses':
    'პირადი შენიშვნები მოთამაშეებისა და უნივერსების შესახებ',
  ...
  'plans.current.buying':
    'შეიძლება რამდენიმე წუთი განიცდათ თქვენი შესყიდვის დამდების შემოწმება. გაგიმარტივებთ თქვენს მომენტშის მისაღებად.',
  ...
  'payment.option.description':
    'აქ არის თქვენი შენახული გადახდის მეთოდების სია. აქ შეგიძლიათ შეინახოთ ახალი გადახდის მეთოდები სწრაფად შეკვეთისთვის. Literary Universe-ს არ ინახავს და არ გამოიყენებს თქვენს გადახდის ინფორმაციას, მაგალითად ბარათის ნომერს.',
  ...
  'payments.disclaimer':
    'გადახდის ინფორმაცია და გამოყენება ხდება Stripe-ის მეშვეობით. ჩვენ არ შევინახავთ არცერთ კრედიტკარტის ან ბანკის ანგარიშის ინფორმაციას ჩვენი სერვერებზე.',
  ...
  'payment.webMonetization.explained':
    'Web Monetization არის წყაროების სტანდარტი, რომელიც გთავაზობთ ვებ გადახდებისთვის. აქ შეგიძლიათ დაამატოთ თქვენი გადახდის პოინტერი, რომელიც შემატყობინებელია თქვენს პროფილის გვერდზე, ბლოგზე, უნივერსებზე და მოთამაშეებზე დასაკავშირებლად Web Monetization-ის მეშვეობით.',
  ...
  'stripeConnect.settings.ongoing':
    'გვინდა რომ გაგვეცანიან სტრიპის მიერ თქვენი ანგარიშის შესახებ. ეს შეიძლება ცოტა დაიწყოს. თუ ეს დროს ძალიან გაითვალისწინებათ, დააჭირეთ ღილაკს, რომელიც გადაადგილებს თქვენს უკან',
  'stripeConnect.settings.finished':
    'თქვენ ყველაზე მაგარი ხართ Stripe Connect-ის საშუალებით თანხის მიღებისთვის.',
  ...
  'payment.donations.payNowUSD':
    'დააფინანსე {donation, number, ::compact-short currency/USD} {username}',
  'payment.donations.payNowJPY':
    'დააფინანსე {donation, number, ::compact-short currency/JPY} {username}',
  'payment.donations.payNowEUR':
    'დააფინანსე {donation, number, ::compact-short currency/EUR} {username}',
  ...
  'payment.universe.haveFans':
    'ადამიანები უფრო მარტივად შეიძლება გააწიოთ თქვენი სპონსორები, თუ ისინი უკვე ინტერესებს გამოაქვეყნებენ იმას, რაც თქვენ აკეთებთ. 100 ფანსი, რომლებიც დაამატებენ თქვენს უნივერსიტეტს მათი ბიბლიოთეკაში, არის სტარტინგის ხაზი.',
  ...
  'payment.fanClub.priceBreakdown':
    'გამომხმარებელმა გადაიხადათ: {amount}. პლატფორმის გადასახადი არის {fee}, თქვენ მიიღებთ: {net}',
  'payment.feeNotice':
    'გთხოვთ გაიგოთ, რომ ეს არის შეფასება და სამუშაო გადახდის ტიპიდან და დამატებითი ხარჯებიდან დამატებით გადასახადი განიცადება',
