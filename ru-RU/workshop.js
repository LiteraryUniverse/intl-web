export default {
  ...
  `,
    ...
    'workshop.webMonetization.explain': 'Веб-монетизация будет перечислять вам платежи в зависимости от того, сколько времени пользователь тратит на ваш контент. В настройках монетизации вашего профиля вы можете установить свой собственный указатель платежей. Здесь вы можете решить, как разделить оплату с вашими соавторами, у которых включена функция веб-платежей. Literary Universe автоматически забирает 10%.',
    'workshop.webMonetization.revShare': 'В связи с ограничениями веб-монетизации используется вероятностное распределение доходов. Вероятностное распределение доходов работает путём случайного выбора из списка предопределенных указателей платежей каждый раз, когда посетитель с веб-монетизацией загружает вашу страницу. Посетитель платит по выбранному указателю до тех пор, пока страница не будет перезагружена или закрыта.',
    'workshop.webMonetization.revShareMore': 'Узнайте больше о вероятностном распределении доходов. Мы используем тот же код, что и на этой странице.',
