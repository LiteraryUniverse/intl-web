export default {
    ...
    'blog.qa.references.title': 'Referenser',
    'blog.qa.references.add': 'Lägg till referens',
    'blog.qa.references.sectionTitle': 'Relaterat innehåll',
    'blog.qa.reference.encyclopedia': 'Uppslagsord: {title}',
    'blog.qa.reference.story': 'Berättelse: {title}{chapter}',
    'blog.qa.reference.chapter': ' (Kapitel: {chapterTitle})',
    'blog.qa.reference.blogPost': 'Blogginlägg: {title}',
    'blog.qa.reference.type.encyclopedia': 'Uppslagsverk',
    'blog.qa.reference.type.story': 'Berättelse',
    'blog.qa.reference.type.blog': 'Blogginlägg',
    'blog.qa.reference.chapter.option': 'Kapitel {sequence}',
    'blog.qa.reference.chapter.untitled': 'Kapitel utan titel',
    'blog.qa.reference.chapter.placeholder': 'Välj ett kapitel...',
    ...
    'blog.qa.outdated.title': 'Föråldrad status',
    'blog.qa.outdated.marked': 'Denna fråga är markerad som föråldrad.',
    'blog.qa.outdated.replacement': 'Ersätts av fråga:',
    'blog.qa.outdated.unmark': 'Markera som aktuell',
    'blog.qa.outdated.mark': 'Markera som föråldrad',
    'blog.qa.outdated.confirm': 'Markera som föråldrad',
    'blog.qa.outdated.replacementPlaceholder': 'Sök ersättningsfråga...',
    'blog.qa.outdated.notice': 'Detta svar kan vara föråldrat.',
    'blog.qa.outdated.seeReplacement': 'Se uppdaterat svar i fråga {question}.',
    // Q&A Public
