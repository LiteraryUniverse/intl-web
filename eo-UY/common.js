...
export default {
  ...
  'notVerified.verify': `Bonvolu konfirmi vian {option, select,
    ...
    create: 'Krei',
    'banner.support': 'Literary Universe estas subtenata de uzantoj kiel vi! Bonvolu konsideri abonadon al unu el niaj abonplanoj por resti sendependa kaj fari Literary Universe eĉ pli bona!',
