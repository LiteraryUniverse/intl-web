export default {
  ...
  'blog.theme': 'Tema',
  'blog.theme.info':
    'Dengan mengubah tema, Anda akan dapat mengubah tampilan halaman. Fitur ini belum siap saat ini.',
  'blog.posts.total': `Ada {total, plural,
    zero {postingan}
    one {ada satu postingan}
    other {ada # postingan}
  } dalam blog ini.`,
  'blog.post.create': 'Buat postingan baru',
  'blog.post.update': 'Mengedit {title}',
  'blog.post.text': 'Teks postingan',
  'common.slug': 'Alamat yang SEO friendly',
  'blog.slug.explained':
    'URL yang terlihat bagus untuk postingan. Hindari menggunakan karakter khusus kecuali "-".',
