export default {
  ...
  'readingList.ordered.label': 'Lista de classificação',
  'readingList.button.add': 'Adicionar à lista de leitura',
  'readingList.selectList': 'Criar uma nova lista de leitura',
  'readingList.create': 'Criar uma nova lista de leitura',
  'readingList.create.aria': 'Modal com definições para uma nova lista de leitura',
  'readingList.edit.aria': 'Modal para editar as definições da lista de leitura',
  'readingList.library.title': 'As suas listas de leitura',
  ...
  'readingList.addItem.yourOwn': `O seu próprio {type, select,
    universes {universos}
    stories {histórias}
    other {propriedades}
  }`,
  'readingList.addItem.noOwnStories': 'Ainda não tem histórias',
  'readingList.addItem.noOwnUniverses': 'Ainda não tem universos',
