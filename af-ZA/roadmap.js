export default {
  'roadmap.ariaTimeOptions': 'Seleksies vir roete-item gebaseer op hul status.',
  'roadmap.state.backlog': 'Agterstand',
  'roadmap.state.inprogress': 'In uitvoering',
  'roadmap.state.preview': 'Voorskou',
  'roadmap.state.beta': 'Beta',
  'roadmap.state.ga': 'Algemene beskikbaarheid',
  ...
  'roadmap.backlog': 'Agterstand',
  'roadmap.history': 'Geskiedenis van ontwikkeling',
