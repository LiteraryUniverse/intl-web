export default {
  ...
  'reader.externalSale.description':
    'यह कहानी Literary Universe पर उपलब्ध नहीं है, लेकिन आप इसे अन्य स्थानों पर प्राप्त कर सकते हैं।',
  'reader.storyTBC.heading': 'जारी रखें...',
  'reader.storyTBC.description':
    'यही हमारे पास की सब कुछ है, लेकिन भविष्य में आगे की यात्रा जारी रहेगी, जल्दी वापस आएं!',
  ...
  'reader.nextRelease.scheduled':
    'अगला अध्याय {nextReleaseAt, date} को आएगा {nextReleaseAt, time}को  ! पर!',
  'reader.storyContinues': 'कहानी जारी रहती है...',
  'reader.storyOnHiatus':
    'लेखक वर्तमान में इस कहानी से एक ब्रेक ले रहे हैं और यह कहानी अब ठहरी हुई है। एक महीने या दो महीने में फिर से जांचें।',
  'reader.storyCancelled':
    'दुख के साथ यही है। कहानी रद्द कर दी गई है, इसलिए नई कोई चीज़ होने की संभावना नहीं है।',
  'reader.storyCancelled.heading': 'रद्द',
  'reader.nextChapterEstimation.verySoon':
    'पिछले {chaptersCount, number} अध्यायों के प्रकाशन तिथियों के आधार पर, अगला अध्याय बहुत जल्द ही जारी होने की संभावना है।',
  'reader.nextChapterEstimation.days':
    'पिछले {chaptersCount, number} अध्यायों के प्रकाशन तिथियों के आधार पर, अगले अध्याय के लिए लगभग {daysLeft, plural, one {1 दिन} other {दिनों}}में उपलब्ध होना चाहिए।',
  'reader.nextChapterEstimation.notEnoughChapters':
    'जब इस कहानी में एक से अधिक अध्याय हो जाएं तो हम अगले अध्याय के प्रकाशन के लिए एक अनुमान भी प्रदान करेंगे।',
}
