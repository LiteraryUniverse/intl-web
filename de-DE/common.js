...
export default {
  ...
  'site.description':
    'Literary Universe ist eine allumfassende Kreativ- und Veröffentlichungsplattform für große Geschichtenuniversen.',
  'site.keywords':
    'kreatives Schreiben, scifi, sci-fi, Fantasie, Schreiben, Verlag, Geschichten, Universum, Webnovel',
  ...
  'common.accessdenied.msg':
    'Sie haben keine Erlaubnis erhalten, hierher zu gehen. Wenn Sie hier Zugang haben sollten, wenden Sie sich bitte an den Eigentümer und bitten Sie ihn, die Einstellungen zu überprüfen.',
  ...
  'common.futurefeature.text':
    'Es tut uns sehr leid, aber diese Funktion ist zur Zeit nicht verfügbar. Wir arbeiten hart daran, sie so bald wie möglich verfügbar zu machen.',
  ...
  'common.legal.newVersionAvailable':
    'Eine neue Version ({newVersion}) dieses Dokuments tritt am {effectiveAt, date} in Kraft.',
  'common.legal.disclaimer':
    '© {year} Alle Rechte vorbehalten, alle Texte gehören ihren jeweiligen Autoren.',
  'premium.only.title': 'Nicht ausreichend hoher Mitgliedsrang',
  'premium.only.msg':
    'Entschuldigung, Ihr Mitgliedsrang ist nicht hoch genug, um auf diese Funktion zuzugreifen.',
  'premium.only.join':
    'Wir bieten verschiedene Pläne an, damit jeder das Beste aus Literary Universe herausholen kann.',
  ...
  'errorLoading.explained':
    'Beim Laden der Seite ist ein Fehler aufgetreten. Wir entschuldigen uns für die Unannehmlichkeiten. Bitte versuchen Sie erneut, die Seite aufzurufen. Sollte das Problem weiterhin bestehen, teilen Sie uns dies bitte mit.',
  ...
  goodbyeForever:
    'Es tut uns leid, Sie gehen zu sehen. War es etwas, das wir getan haben? Bitte lassen Sie uns wissen, ob das der Fall ist. In jedem Fall wünschen wir Ihnen das Beste für Ihre zukünftigen Unternehmungen und hoffen, dass wir uns wiedersehen! Leben Sie lange und in Frieden!',
  ...
  'common.2faCodeIntro':
    'Bitte geben Sie Ihren einmaligen Code ein, der von Ihrer Authentifizierungsanwendung generiert wurde.',
  ...
  'signin.web3.signMessage':
    'Bitte bestätigen Sie, dass Sie das Literary Universe mit Ihrer Brieftasche als Authentifizierungsmethode betreten möchten. Code: {code}',
  ...
  create: 'Erstelle',
  'banner.support':
    'Literary Universe wird von Nutzern wie Ihnen unterstützt! Bitte denken Sie darüber nach, eines unserer Abonnements abzuschließen, um unabhängig zu bleiben und die Veranstaltungen von Literary Universe zu verbessern!',
