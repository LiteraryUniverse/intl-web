export default {
  ...
  'workshop.story.cannon.desc.create':
    ".i lo kensa cu zbasu lo se cusku be lo si'o fatci be fi lo kensa {universe}",
  'workshop.story.fanfiction.search':
    "Tavla lo cmene be lo kensa (ri'a lonu ri cu zvati lo do kibro tavla). A poi se jbini cu pilno",
  'workshop.story.error.nogenres': 'lo ka pilno lo se cmima cu jdika lo ka pilno lo se cmima',
  'workshop.story.error.toomanygenres':
    'lo ka pilno lo se cmima cu jdika lo ka pilno lo se cmima be fi lo fatci',
  'workshop.story.error.fanfiction.selectuniverse':
    'lo ka pilno lo kensa fatci cu pilno lo do fatci',
  'workshop.story.error.tags.toomany':
    'lo ka pilno lo se cmima cu jdika lo ka pilno lo se cmima be fi lo fatci',
  'workshop.story.new': 'zbasu lo fatci jdini',
  'workshop.story.publishing.notice':
    'lo fatci cu se xamsi lo nu do se xamsi lo se fatci be lo fatci',
  ...
  'workshop.revisions.comments.title':
    '{story}: {chapter} - se finti {revision} - se finti be fi lo fatci',
  ...
  'workshop.revisions.comments.norevision':
    'I do not have enough information to provide a translation.',
  ...
  'workshop.story.authorsNotesExplained':
    '.i do se plixau lo nu do tcidu lo notci pe lo jufra le se tcika be lo jufra.',
  ...
  'workshop.universe.forumSettings':
    'Jikca be lo se jinsa be lo se ctuca be lo se karni be lo terdi',
  'workshop.universe.forum':
    'Jikca be lo se jinsa {universeName} be lo se ctuca be lo se karni be lo terdi',
  'workshop.ratingAdjusted':
    ".ijanai lo nu mi'o jinvi lo ka joi lo nu mi'o zmadu lo ka jinvi lo ka se jalge .i je'e ku'i lo se jalge cu se ganse lo ka se zmadu lo ka jinvi",
  ...
  'workshop.universe.isAIGeneratedTooltip':
    ".i ko catlu lo nu do finti lo se zukte be lo AI lo te zukte be'o se finti kei gi'e jai gau se pluka lo nu zgana fi lo ka catlu lo nu zukte .i mi finti lo te zukte be'o se finti gi'e jai gau se pluka lo nu zgana fi lo ka finti lo se zukte be lo AI .i ji lo nu finti lo se zukte be lo AI cu se zmadu lo ka zukte",
  'workshop.story.isAIGenerated':
    "ca'o se finti lo te lisri be'o se finti kei gi'e jai gau se pluka lo nu zgana fi lo ka finti lo se zukte be lo AI .i mi finti lo te zukte be'o se finti gi'e jai gau se pluka lo nu zgana fi lo ka finti lo se zukte be lo AI .i ji lo nu finti lo se zukte be lo AI cu se zmadu lo ka zukte",
  ...
