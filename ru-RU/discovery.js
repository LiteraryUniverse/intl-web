export default {
  ...
  'story.estimatedReadingTime.explained':
    'На основе средней скорости чтения в {avgReadingNum, number} слов в минуту.',
  ...
  'discover.includesAds':
    'Это произведение имеет размещение продукта или включает в себя другие формы рекламы.',
