...
export default {
  ...
  'site.description':
    'Literary Universe je vše v jednom, tvůrčí a vydavatelská platforma pro velké příběhové vesmíry.',
  'site.keywords':
    'kreativní psaní, scifi, sci-fi, fantasie, psaní, publikace, příběhy, vesmíru, webromán, webnovel',
  ...
  'common.legal.newVersionAvailable':
    'Nová verze ({newVersion}) tohoto dokumentu vstoupí v platnost dne {effectiveAt, date}.',
  'common.legal.disclaimer':
    '© {year} Všechna práva vyhrazena, všechny texty patří jejich příslušným autorům.',
  ...
  // for beta only
  'beta.notice':
    'Vítejte v Literary Universe BETA. Toto je veřejný náhled a aplikace jako taková je stále ve vývoji. To znamená, že stále můžete očekávat chyby a nedokončené funkce. Pokud narazíte na chybu nebo něco nefunguje, dejte nám prosím vědět a buďte prosím trpěliví, mezitím co dáme všechno dohromady.',
  ...
  'errorLoading.explained':
    'Během načítání stránky došlo k chybě. Omlouváme se za nepříjemnosti. Prosím zkuste znovu vstoupit na stránku. Pokud problém přetrvává, dejte nám prosím vědět.',
  ...
  goodbyeForever:
    'Je nám líto že nás opouštíte. Je to kvůli něčemu co jsme udělali? Dejte nám vědět pokud tomu tak je. V každém případě Vám přejeme to nejlepší do budoucna a doufáme, že se naše cesty znovu zkříží!',
  ...
  'signin.web3.signMessage':
    'Potvrďte, že chcete vstoupit do Literary Univese s Vaší peněženkou jako metodu ověření. Kód: {code}',
  ...
  create: 'Vytořit',
  'banner.support':
    'Literární Universe je podporován uživateli, jako jste vy! Zvažte prosím přihlášení k odběru jednoho z našich předplatitelských plánů, abyjsme mohli zůstali nezávislí a dále rozvýjet Literary Univers!',
  ...
  'console.explain':
    'Toto je funkce prohlížeče určená pro vývojáře. Pokud vám někdo řekl, abyste sem něco zkopírovali, abyste povolili funkci Literary Universe nebo "hackovali" něčí účet, jedná se o podvod a tímto získá přístup k vašemu účtu.',
