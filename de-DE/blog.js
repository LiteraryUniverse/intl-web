export default {
  ...
  'blog.post.create': 'Einen neuen Beitrag erstellen',
  'blog.post.update': 'Bearbeitung von {title}',
  'blog.post.text': 'Beitragstext',
  'common.slug': 'SEO-freundliche Adresse',
  'blog.slug.explained':
    'Schön aussehende Url zum Beitrag. Vermeiden Sie die Verwendung von Sonderzeichen außer "-".',
  ...
  'blog.settings.universeSettings':
    'Universe-Blogs sind in Universe-Seiten integriert, deren Grundeinstellungen aus den Universe-Einstellungen übernommen werden.',
  'blog.settings.organizationSettings':
    'Organisationsblogs sind in Organisationsseiten integriert.',
