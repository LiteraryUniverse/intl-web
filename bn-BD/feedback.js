export default {
  ...
  'feedback.features.desc':
    'নতুন বৈশিষ্ট্যের জন্য আপনার কি আইডিয়া আছে বা কিভাবে সাইটটি উন্নত করতে হবে? আমাদের জানান!',
  ...
  'feedback.report.reportSaved':
    'প্রতিবেদনের জন্য আপনাকে ধন্যবাদ! আমরা পরিচিতি নেব এবং প্রয়োজন হলে কার্যবিধি গ্রহণ করব।',
  'feedback.report.copyrightReportSaved':
    'প্রতিবেদনের জন্য আপনাকে ধন্যবাদ! আমরা পরিচিতি নেব এবং যোগাযোগ করব।',
  ...
  'faq.answer.about.dataLocation':
    'Literary Universe data is stored on servers in the United States of America, specifically AWS us-east-1 region.',
  'faq.question.about.incorporation': 'Where are you incorporated?',
  'faq.answer.about.incorporation':
    'লিটারেরি ইউনিভার্স চেক রিপাবলিকে প্রতিষ্ঠিত। আমাদের সম্পর্কের বিস্তারিত জানতে পারেন <a href="/about">আমাদের সম্পর্কে পৃষ্ঠা</a>এ।',
  'faq.question.about.roadmap': 'লিটারেরি ইউনিভার্সের পরবর্তী পদক্ষেপগুলি কী?',
  'faq.answer.about.roadmap':
    'এটা সময়ক্রমে উন্নত হচ্ছে। বিস্তারিত জানতে আমাদের <a href="/roadmap">পথপ্রদর্শন পৃষ্ঠা</a> দেখুন।',
  // Settings questions
  'faq.question.settings.changeTheme': 'লিটারেরি ইউনিভার্সের চেহারা কিভাবে পরিবর্তন করব?',
  'faq.answer.settings.changeTheme':
    'নিবন্ধিত ব্যবহারকারীরা তাদের থিমটি পরিবর্তন করতে পারেন <a href="/user/settings/account">অ্যাকাউন্ট সেটিংস</a> এর "সাইট থিমিং" সেকশনে। আমাদের একটি হালকা এবং একটি গাঢ় থিম উপলব্ধ। আপনি যদি নিবন্ধিত না হন, তবে আমরা আপনার ব্রাউজার এবং অপারেটিং সিস্টেম সেটিংস ভিত্তিক থিম পরিবর্তন করতে চেষ্টা করি।',
  'faq.question.settings.changeAvatar': 'আমি কিভাবে আমার অবতার পরিবর্তন করব?',
  'faq.answer.settings.changeAvatar':
    'আপনি আপনার অবতারটি পরিবর্তন করতে পারেন <a href="/user/settings/profile">প্রোফাইল সেটিংস</a>এ।',
  'faq.question.settings.changeLanguage': 'ভাষা কিভাবে পরিবর্তন করব?',
  'faq.answer.settings.changeLanguage':
    'আপনি লিটারেরি ইউনিভার্সের ভাষা পরিবর্তন করতে পারেন <a href="/user/settings/account">অ্যাকাউন্ট সেটিংস</a>এ।',
  'faq.question.settings.translationMistake':
    'ওয়েবসাইটে পাঠ্যে একটি ভুল খুঁজে পেলাম, এটি কোথায় রিপোর্ট করব?',
  'faq.answer.settings.translationMistake':
    'সমস্ত ভাষা ফাইলগুলি আমাদের জিটহাবে উপলব্ধ। আপনি <a target="_blank" href="https://github.com/LiteraryUniverse/intl-web/issues/new/choose">সেখানে একটি ইস্যু জমা দিতে পারেন</a> অথবা প্রতিক্রিয়ার বাগ বিভাগে বা যদি আপনি ইচ্ছাশক্তিসম্পন্ন হন তবে আপনি নিজে সরাসরি ঠিক করতে পারেন <a href="https://crowdin.com/project/literary-universe" target="_blank">আমাদের ক্রোউডিন পৃষ্ঠা</a>এর মাধ্যমে।',
  // Discovery questions
