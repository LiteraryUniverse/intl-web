...
export default {
    ...
    'common.swUpdate.ready.title': 'تحديث جاهز',
    'common.swUpdate.ready.description': 'الإصدار الجديد جاهز. يمكنك تطبيقه الآن.',
    'common.swUpdate.ready.writerDescription': 'نسخة جديدة جاهزة. قم بتطبيقه عند الانتهاء من تعديلاتك الكتابية الحالية.',
    'common.swUpdate.apply': 'تحديث الآن',
    ...
    'common.done': 'تم',
    'contentSelector.noSelection': 'لم يتم تحديد أي عناصر',
    'contentSelector.selectedItems': 'عناصر مختارة',
    'contentSelector.entireSite': 'موقع البحث',
    'contentSelector.tabsLabel': 'خيارات البحث',
    'contentSelector.title': 'اختر المحتوى',
    recommended: 'موصى به',
    ...
    'common.creating': 'إنشاء...',
    // Invitation landing page
    'invitation.page.title': 'دعوة',
    'invitation.title': 'لقد تمت دعوتك!',
    'invitation.detail.invitedBy': 'مدعو من قبل',
    'invitation.detail.to': 'للانضمام',
    'invitation.detail.role': 'الدور',
    'invitation.role.member': 'عضو',
    'invitation.role.collaborator': 'متعاون',
    'invitation.role.translator': 'المترجم',
    'invitation.role.beta': 'قارئ بيتا',
    'invitation.objectType.organization': 'التنظيم',
    'invitation.objectType.story': 'القصة',
    'invitation.objectType.universe': 'الكون',
    'invitation.accept': 'قبول الدعوة',
    'invitation.accepting': 'قبول...',
    'invitation.decline': 'الانخفاض',
    'invitation.loginRequired': 'يرجى تسجيل الدخول أو إنشاء حساب للرد على هذه الدعوة.',
    'invitation.haveAccount': 'لدي حساب',
    'invitation.newHere': 'أنا جديد هنا',
    'invitation.registerPrompt': 'قم بإنشاء حساب مجاني لقبول هذه الدعوة.',
    'invitation.register': 'إنشاء حساب',
    'invitation.goToDashboard': 'الانتقال إلى لوحة التحكم',
    'invitation.alreadyAccepted.title': 'تم قبول الدعوة بالفعل',
    'invitation.alreadyAccepted.message': 'وقد تم قبول هذه الدعوة بالفعل.',
    'invitation.alreadyDeclined.title': 'تم رفض الدعوة',
    'invitation.alreadyDeclined.message': 'تم رفض هذه الدعوة.',
    'invitation.declined.title': 'تم رفض الدعوة',
    'invitation.declined.message': 'لقد رفضت الدعوة.',
    'invitation.cancelled.title': 'تم إلغاء الدعوة',
    'invitation.cancelled.message': 'تم إلغاء هذه الدعوة من قبل المرسل.',
