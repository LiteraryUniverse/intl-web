 ...
 */
export default {
    'licenses.about': 'ლიცენზიების შესახებ',
    'licenses.more': 'მეტი ინფორმაცია',
    'licenses.legal': 'სამართლებრივი დოკუმენტი',
    'licenses.name.cc-by': 'კრეატივ კომონს საავტორო აღიარება 4.0',
    'licenses.cc-by': 'ეს ლიცენზია სხვებს უფლებას აძლევს, გაავრცელონ, გადააკეთონ, შეცვალონ და დაამატონ თქვენს ნამუშევარს, კომერციული მიზნების ჩათვლით, იმ პირობით, რომ ავტორობას თქვენ მიგიჩენენ. ეს არის ყველაზე თავისუფალი ლიცენზია. რეკომენდებულია ლიცენზირებული მასალების მაქსიმალური გავრცელებისა და გამოყენებისთვის.',
    'licenses.name.cc-by-sa': 'კრეატივ კომონს საავტორო მითითება-იგივე პირობები 4.0',
    ...
    'licenses.name.cc-by-nd': 'კრეატივ კომონს საავტორო მითითება-არაგადამუშავება 4.0',
    'licenses.cc-by-nd': 'ეს ლიცენზია იძლევა ხელახალი გავრცელების, კომერციული და არაკომერციული მიზნებისთვის, უფლებას, იმ პირობით, რომ ის გადაეცემა უცვლელი და სრულად, თქვენი ავტორობის მითითებით.',
    'licenses.name.cc-by-nc': 'კრეატივ კომონს საავტორო მითითება-არაკომერციული 4.0',
    ...
    'licenses.name.cc-by-nc-sa': 'Creative Commons ავტორობის მითითება-არაკომერციული-ანალოგიური პირობები 4.0',
    'licenses.cc-by-nc-sa': 'ეს ლიცენზია სხვებს საშუალებას აძლევს, არაკომერციული მიზნებით გადააკეთონ, შეცვალონ და დაამატონ თქვენს ნამუშევარს, იმ პირობით, რომ ავტორობას მოგაწერენ და მათ ახალ ნამუშევრებსაც იდენტური პირობებით და ლიცენზიით გამოაქვეყნებენ.',
    'licenses.name.cc-by-nc-nd': 'კრეატივ კომონს საავტორო მითითება-არაკომერციული-გარეშე ნაწარმოებები 4.0',
    ...
    'licenses.name.lu-c': 'ლიტერატურული სამყაროს საავტორო უფლებები',
