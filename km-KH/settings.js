export default {
  ...
  'settings.biography.placeholder':
    'ពិតជាអ្នកមួយចំនួនអំពីអ្វីមួយដែលត្រូវបានបង្ហាញនៅលើទំព័រប្រវត្តិរូបសម្រាប់អ្នកប្រើប្រាស់របស់អ្នក។',
  ...
  'settings.languages.notice':
    'អង់គ្លេសនិងឆេកជួយគេបានជាមួយជាមួយគ្នាជាមួយនឹងភាសាអន្តរជាតិដែលបានគាំទ្របច្ចុប្បន្ន។ ភាសាផ្សេងទៀតគឺត្រូវបានផ្តល់ជូនដោយអ្នកវិចិត្រសាលទោលជាមួយនឹងបច្ចុប្បន្នភាសាអក្សរសុខភាពនិងការបកប្រែដែលអាចគ្រប់គ្រងបាន។',
  'settings.languages.join':
    'ប្រសិនបើអ្នកចង់ជួយយើងអានវិទ្យាសាស្ត្រដូចគ្នាអ្នកអាចបកប្រែភាសារបស់ Literary Universe ដែលផ្តល់ជូនដើម្បីយើងបានទៀត។',
  ...
  'settings.web3.verify.explained':
    'ដើម្បីពិនិត្យលទ្ធផលនេះជាមួយអ្នកយើងត្រូវការអ្នកចុះឈ្មោះបញ្ជាក់ដើម្បីបញ្ជាទុកការទំនាក់ទំនងរបស់អ្នកជាមួយប្រសិទ្ធភាពនៃការទុកប្រើប្រាស់របស់អ្នក។',
  ...
  'settings.web3.linkingMessage':
    'សូមបញ្ជាក់ថាអ្នកចង់ភ្ជាប់គណនីរបស់អ្នកទៅក្នុង Literary Universe។ លេខកូដ: {code}',
