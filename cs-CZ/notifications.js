...
export default {
  ...
  'flashnews.onlyDisplayOn':
    'Zprávy budou zobrazeny pouze na jazycích vybraných níže (pokud jsou vybrány). Zpráva nebude zobrazena ve výchozím jazyku pro uživatele s jiným jazykem.',
  ...
  'notification.workshopStoryStatus.toHiatus':
    'Váš příběh {storyName} byl automaticky nastaven na hiatus po 6 měsících nečinnosti.',
  'notification.workshopStoryStatus.toCancelled':
    'Váš příběh {storyName} byl automaticky nastaven na zrušený po roce bez nových kapitol.',
