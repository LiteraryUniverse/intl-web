export default {
  ...
  'encyclopedia.help.text':
    'השתמש בתפריט בצד שמאל כדי לנווט בין הפריטים באנציקלופדיה. לאחר בחירת פריט, הוא יוצג במקום הטקסט הזה.',
  'encyclopedia.help.sidebar': 'סרגל כלים צדדי',
  'encyclopedia.help.sidebar.text':
    'ברוך הבא לסיפור שלך! סרגל הצד הזה מאפשר לך גישה נוחה לכל המשאבים הקשורים לסיפור שלך. בדוק את הסמלים למעלה כדי לראות את התגובות האחרונות, ההערות שלך, לחפש באנציקלופדיה שלך, לעיין ולהוסיף ערכים חדשים לאנציקלופדיה שלך. אם ברצונך להוסיף קישור לערך מתוך הטקסט של הסיפור, סמן את הטקסט במקום שבו ברצונך למקם אותו ולחץ על כפתור החיבור. תתבקש למצוא ולבחור פריט.',
  ...
  'encyclopedia.container.desc':
    'הפוך את הפריט הזה למיכל לקבוצה חדשה של פריטים. זה יסתיר אותו מרשימת הקטגוריות.',
  'encyclopedia.entry.name': 'שם הפריט',
  'encyclopedia.summary': 'סיכום',
  'encyclopedia.summary.desc': 'זהו סיכום שיהיה המידע הראשוני היחיד שיוצג לקורא.',
  ...
  'encyclopedia.translation.desc':
    'ממשק האנציקלופדיה הזה משמש לתרגום ל {language}. בחרו ערכים קיימים ברשימה בצד שמאל כדי להתחיל את התרגומם.',
  ...
  'encyclopedia.settings.categoriesDesc':
    'הפעלה וכיבוי של קטגוריות שתרצו להשתמש בהן באנציקלופדיה שלכם.',
  ...
  'enc.entries.limitReached':
    '!הגעת למספר המרבי של ערכי האנציקלופדיה המותרים עבור המינוי הנוכחי שלך',
  ...
  'encyclopedia.settings.templateDescription':
    'אפשר להעתיק את תוכן האנציקלופדיה הזו ליקומים אחרים. זה הכי טוב אם אין לך סיפורים ובמקום זאת אתה רק יוצר תבנית לשימוש של אחרים.',
