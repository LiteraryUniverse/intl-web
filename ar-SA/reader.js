export default {
  ...
  'reader.externalSale.description':
    'هذه القصة غير متوفرة على Literary Universe, ولكن يمكنك الحصول عليها في أماكن أخرى.',
  'reader.storyTBC.heading': 'سيتم الاستمرار...',
  'reader.storyTBC.description':
    'هذا كل ما لدينا من القصة حتى الآن، ولكن المغامرة ستستمر في المستقبل، تفقد مرة أخرى قريباً!',
  ...
  'reader.nextRelease.scheduled':
    'الفصل التالي سيأتي في {nextReleaseAt, date} في {nextReleaseAt, time}!',
  'reader.storyContinues': 'ستستمر القصة...',
  'reader.storyOnHiatus':
    'المؤلف حاليًا في إجازة من هذه القصة وهذه القصة في وقفة مؤقتة الآن. تفقد مرة أخرى في شهر أو اثنين.',
  'reader.storyCancelled':
    'للأسف هذا هو الأمر. تم إلغاء القصة لذا من غير المرجح أن يكون هناك أي شيء جديد.',
  'reader.storyCancelled.heading': 'ملغى',
  'reader.nextChapterEstimation.verySoon':
    'بناءً على تواريخ النشر للفصول الأخيرة {chaptersCount, number} ، من المتوقع أن يتم إصدار الفصل التالي قريبًا جدًا.',
  'reader.nextChapterEstimation.days':
    'بناءً على تواريخ النشر للفصول الأخيرة {chaptersCount, number} ، يجب أن يكون الفصل التالي متاحًا في ما يقرب من {daysLeft, plural, one {يوم} other {# أيام}}.',
  'reader.nextChapterEstimation.notEnoughChapters':
    'سنقدم أيضًا تقديرًا لمتى قد يتم نشر الفصل التالي بمجرد أن يحتوي هذا القصة على أكثر من فصل واحد.',
}
