export default {
  ...
  'feedback.bugs.desc':
    'શું તમે કોઈ ભૂલ અથવા અન્ય કારણે સમસ્યા મુક્યું છે કે જે ખોટું છે અથવા જે સ્થાન પર છે. અહીં જણાવો!',
  ...
  'feedback.report.copyrightNotice':
    'કૃપા કરીને ધ્યાન આપો કે આપે આ ફોર્મનો ઉપયોગ કરવા માટે આપે કાર્યની ખરીદદાર હોવો જોઈએ. જો તમે માલિક નથી, તો કૃપા કરીને માલિકને સૂચિત કરો અથવા અમને સૂચિત કરવા માટે અન્ય શ્રેણીનો ઉપયોગ કરો. અમે કૉપિરાઇટ ઉલ્લંઘન ખૂબ ગંભીરતાથી લેવાય છે અને આ ફોર્મના અયોગ્ય અને અપમાનજનક ઉપયોગ પર પણ સમાન માર્ગદર્શન લાગુ પડે છે.',
  ...
  'faq.answer.about.whatIsLU':
    'Literary Universe is a platform for writers and readers to create, share and discover stories and worlds.',
  'faq.question.about.difference':
    'What is the difference between Literary Universe and other online reading platforms?',
  'faq.answer.about.difference':
    'Literary Universe is all-in-one platform which means it includes tools for writing, reading, worldbuilding, and community building. The key difference is inclusion of all these tools together in one platform and their interconnectedness.',
  'faq.question.about.dataLocation': 'LU ડેટા ક્યાં સંગ્રહિત છે?',
  'faq.answer.about.dataLocation':
    'લિટરરી યુનિવર્સ ડેટા યુનાઇટેડ સ્ટેટ્સ ઓફ અમેરિકામાં, વિશેષતઃ AWS us-east-1 પ્રદેશમાં સંગ્રહિત છે.',
  'faq.question.about.incorporation': 'તમે ક્યાં સમાવેશ થયેલ છો?',
  'faq.answer.about.incorporation':
    'સાહિત્યિક યુનિવર્સ ચેક રિપબ્લિકમાં સમાવેશ કર્યું છે. આપ અમારા વિશેની વધુ વિગતો મેળવી શકો છો આ પૃષ્ઠ <a href="/about">પર</a>.',
  'faq.question.about.roadmap': 'સાહિત્યિક યુનિવર્સ માટે આગામી પગલું શું છે?',
  'faq.answer.about.roadmap':
    'આ હંમેશાં વિકસિત થઈ રહે છે. વધુ વિગતો માટે અમારી રોડમેપ <a href="/roadmap">ની જુઓ</a>.',
  // Settings questions
  'faq.question.settings.changeTheme': 'સાહિત્યિક યુનિવર્સની લુક કેવી રીતે બદલવી શકો છો?',
  'faq.answer.settings.changeTheme':
    'રજીસ્ટર થયેલ ઉપયોગકર્તાઓ મૂળભૂત સેટિંગ્સ <a href="/user/settings/account">હિસાબથી તેમની થીમ બદલી શકે છે</a> "સાઇટ થીમિંગ" વિભાગમાં. અગર તમે રજીસ્ટર થયેલ નથી, તો અમે તમને તેમની થીમ સર્વ કરવામાં આવશે જેમાં તમારા બ્રાઉઝર અને ઓપરેટિંગ સિસ્ટમ સેટિંગ્સ પર આધાર રાખીશું છે.',
  'faq.question.settings.changeAvatar': 'હું મારું અવાતાર કેવી રીતે બદલી શકું?',
  'faq.answer.settings.changeAvatar':
    'તમે મારું અવાતાર તમારી પ્રોફાઇલ સેટિંગ્સ <a href="/user/settings/profile">માં બદલી શકો છો</a>.',
  'faq.question.settings.changeLanguage': 'ભાષા કેવી રીતે બદલી શકી શકો છો?',
  'faq.answer.settings.changeLanguage':
    'તમે સાહિત્યિક યુનિવર્સની ભાષા બદલી શકો છો આપની ખાતા સેટિંગ્સ <a href="/user/settings/account">માં પરત્યાયો માંથી</a>.',
  'faq.question.settings.translationMistake':
    'હું વેબસાઇટ પરના લખાણમાં ભૂલ મળી છે, તેને હું ક્યાં રિપોર્ટ કરી શકું?',
  ...
  'faq.answer.reader.creativeTypes':
    'Universe is a place where you can find all the stories and other content related to a specific literary world. Stories are either standalone stories or part of a universe that. Fan Fiction is a story that is based on another literary universe created by someone else.',
  // Workshop
  'faq.question.workshop.explain': 'What is the Workshop?',
  'faq.answer.workshop.explain':
    'The Workshop is where you can create new stories, fan fiction, universes, and other content. It is a place to write, edit and manage your creative content.',
  ...
  'faq.answer.workshop.whatIsALicense':
    'A story license is a legal document that defines how your story/universe can be used by others. It is a way to protect your rights and to define how others can use your work.',
  ...
  'faq.answer.workshop.guildOwnership':
    'Guild ownership indicated a work that is owned by an organization, we call them Guilds. This could be a publisher or another type of a company or non-profit organization. The ownership of the work is usually bit more complex and the author might not have full control over the work, it mainly means that the work is managed through the organization and not by the author from their personal account.',
  ...
  'faq.question.workshop.betaReaders':
    'What are Beta Readers and what is their purpose to my story?',
  'faq.answer.workshop.betaReaders':
    'Beta readers are people who read your story before it is published and give you feedback. They can help you find mistakes, give you ideas for improvement, and help you make your story better.',
