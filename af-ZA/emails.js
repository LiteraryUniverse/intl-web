...
export default {
  ...
  'email.enrollAccount.messageHtml':
    "Ons wil jou graag uitnooi na die Literêre Heelal! Ons het 'n persoonlike rekening vir jou voorberei waar jy toegang kan kry tot alle kenmerke van die Literêre Heelal! Sluit asseblief by ons aan om die volgende generasie van skeppende skryf- en leeswerk te skep!",
  'email.enrollAccount.button': 'Kry toegang tot jou rekening',
  'email.enrollAccount.signature':
    'Ons sien daarna uit om jou te sien,<br />Literary Universe-span',
  // Reset password
  'email.resetPassword.messageHtml':
    "Ons het 'n versoek ontvang om jou wagwoord vir jou rekening te herstel, klik asseblief op die knoppie hieronder om die proses voort te sit. As jy nie hierdie versoek gemaak het nie, kan jy hierdie e-pos ignoreer, maar dit mag 'n goeie tyd wees om jou sekuriteitsinstellings te hersien.",
  'email.resetPassword.button': 'Herstel wagwoord',
  // E-mail verification
  'email.verifyEmail.messageHtml':
    'Ons is bly om jou aan boord te hê! Klik asseblief op die knoppie hieronder om hierdie e-posadres te verifieer.',
