export default {
  ...
  'feedback.report.reportSaved':
    'សូមអរគុណសម្រាប់ការរាយការណែនាំ! យើងនឹងស្វែងរកបញ្ជូនឱ្យដឹងហើយធ្វើសកម្មភាពប្រសិនបើត្រូវការ។',
  ...
  'feedback.report.copyrightNotice':
    'សូមបញ្ជូនចំណាំថាអ្នកត្រូវជា​ម្ចាស់ការងារដែលបានប្រើប្រាស់ទម្រង់នេះ។ ប្រសិនបើអ្នកមិនមែនជា​ម្ចាស់ការងារទាំងនោះទេ សូមប្រាប់ម្ចាស់ដើម្បីដឹកជញ្ជូនឱ្យយើងដឹង យើងធ្វើការស្នើសុំការបញ្ជាក់សកម្មភាពក្រុមហ៊ុនប្រើប្រាស់របស់យើងដោយសេរីភាពខ្លាំង។',
  ...
  'faq.answer.about.dataLocation':
    'ទិន្នន័យនៃ Literary Universe ត្រូវបានរក្សាទុកនៅលើម៉ាស៊ីនបម្រើនទីតាំងនៅសហរដ្ឋអាមេរិក និងជាពិសេសនៅតំបន់ us-east-1 នៃ AWS។',
  'faq.question.about.incorporation': 'អ្នកបានបង្កើតក្រុមហ៊ុននៅទីតាំងណា?',
  'faq.answer.about.incorporation':
    'ជាក្រុមហ៊ុន Literary Universe ត្រូវបានបញ្ចូលក្នុងសាធារណៈកម្ពុជា។ អ្នកអាចរកឃើញព័ត៌មានបន្ថែមអំពីយើងនៅលើទំព័រ <a href="/about">about us page</a>។',
  'faq.question.about.roadmap': 'អ្វីជាជំហានបន្ទាប់សម្រាប់ Literary Universe?',
  'faq.answer.about.roadmap':
    'វាកំពុងផ្លាស់ប្តូរជានិច្ច។ សូមពិនិត្យមើលក្តីវិលបំផុតរបស់យើងនៅលើទំព័រ <a href="/roadmap">roadmap</a> សម្រាប់ព័ត៌មានបន្ថែម។',
  // Settings questions
  ...
  'faq.answer.settings.changeLanguage':
    'អ្នកអាចផ្លាស់ប្តូរភាសានៃ Literary Universe នៅក្នុងការកំណត់គណនី <a href="/user/settings/account">account settings</a>។',
  'faq.question.settings.translationMistake':
    'ខ្ញុំបានរកឃើញកំហុសនៅក្នុងអត្ថបទនៅលើវេបសាយ តើខ្ញុំអាចរាយការណ៍វានៅទីណាមួយ?',
  'faq.answer.settings.translationMistake':
    'ឯកសារភាសាររបស់យើងអាចរកបាននៅលើ GitHub។ អ្នកអាចដាក់ស្នើបញ្ហានៅទីនេះ <a target="_blank" href="https://github.com/LiteraryUniverse/intl-web/issues/new/choose">submit an issue there</a> ឬនៅក្នុងផ្នែក Bug នៃការផ្តល់មតិរបស់អ្នក ឬប្រសិនបើអ្នកចង់កែប្រែវាដោយខ្លួនឯងបានផ្ទាល់ខ្លួនឯងតាមរយៈទំព័ររបស់យើងនៅលើ Crowdin <a href="https://crowdin.com/project/literary-universe" target="_blank">our Crowdin page</a>។',
  // Discovery questions
