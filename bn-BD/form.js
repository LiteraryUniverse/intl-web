export default {
  ...
  'form.validator.maxLength': `অবশ্যই {max, number} {what, select,
    characters {অক্ষর}
    tags {ট্যাগ}
    genres {জনরে}
    numbers {সংখ্যা}
  ...
  'form.validator.minLength': `অবশ্যই {min, number} {what, select,
    characters {অক্ষর}
    tags {ট্যাগ}
    genres {জনরে}
    genre {জনরে}
  ...
  'form.weakPassword':
    'এই পাসওয়ার্ড দুর্বল মনে হচ্ছে। দয়া করে সংখ্যা এবং বিশেষ চিহ্ন যোগ করে তা শক্তিশালী করার বিবেচনা করুন।',
