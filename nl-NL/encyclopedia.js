export default {
  ...
  'encyclopedia.help.text':
    'Gebruik het menu aan de linkerkant om te navigeren tussen de items in de encyclopedie. Zodra je een item selecteert, wordt het in plaats van deze tekst weergegeven.',
  'encyclopedia.help.sidebar': 'Zijbalk Toolbox',
  'encyclopedia.help.sidebar.text':
    'Welkom bij jouw verhaal! Deze zijbalk geeft je gemakkelijke toegang tot alle bronnen die verband houden met jouw verhaal. Controleer de pictogrammen hierboven om de nieuwste opmerkingen te zien, jouw notities, zoek in jouw encyclopedie, blader door en voeg nieuwe items toe aan jouw encyclopedie. Als je een koppeling naar een item wilt toevoegen vanuit de verhaaltekst, selecteer dan de tekst waar je het wilt plaatsen en klik vervolgens op de verbinden knop. Je wordt dan gevraagd om een item te vinden en te selecteren.',
  ...
  'encyclopedia.container.desc':
    'Maak van dit item een container voor een nieuwe groep items. Hierdoor wordt het verborgen in de lijst met categorieën.',
  'encyclopedia.entry.name': 'Naam van het item',
  'encyclopedia.summary': 'Samenvatting',
  'encyclopedia.summary.desc':
    'Dit is een samenvatting die als enige initiële informatie op de lezer wordt weergegeven.',
  ...
  'encyclopedia.translation.desc':
    'Deze encyclopedie-interface wordt gebruikt voor vertaling naar het {language}. Kies bestaande vermeldingen in de lijst aan de linkerkant om hun vertaling te beginnen.',
  ...
  'encyclopedia.settings.categoriesDesc':
    'Schakel categorieën in en uit die je wilt gebruiken in je encyclopedie.',
  'encyclopedia.settings.introText':
    'Welkomstbericht dat wordt weergegeven na de beschrijving van het universum.',
  ...
  'enc.entries.limitReached':
    'Je hebt het maximale aantal toegestane encyclopedievermeldingen bereikt voor je huidige abonnement.',
  ...
  'encyclopedia.settings.templateDescription':
    'Sta toe dat de inhoud van deze encyclopedie wordt gekopieerd naar andere universums. Dit is het beste als je geen verhalen hebt en in plaats daarvan gewoon een sjabloon maakt voor anderen om te gebruiken.',
  ...
  'encyclopedia.templateCopy.description':
    'Kopieer de inhoud van deze encyclopedie naar jouw universum om het te verrijken.',
