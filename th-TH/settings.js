export default {
    ...
    'settings.export.explain': 'นี่จะส่งออกข้อมูลส่วนตัวทั้งหมดของคุณที่เก็บไว้ในฐานข้อมูลของเราเป็นไฟล์ JSON ซึ่งรวมถึงโปรไฟล์ของคุณ, เรื่องราว, ประวัติการอ่าน, บันทึกประจำวัน, บันทึกส่วนตัว, สถิติการเขียน, บุ๊กมาร์ก, รายการอ่าน, กิจกรรมในชุมชน, สมาชิกภาพ, และข้อมูลอื่น ๆ ที่เกี่ยวข้องกับบัญชีของคุณ',
    'settings.export.submit': 'ส่งออกข้อมูล',
    'settings.delete.title': 'ลบบัญชี',
    'settings.delete.warning': 'คำเตือน: การลบบัญชีของคุณจะเป็นการสูญเสียการเข้าถึงบัญชีนี้อย่างถาวร และไม่สามารถกู้คืนได้ ข้อมูลส่วนตัวทั้งหมดรวมถึงบันทึกประจำวัน บันทึกส่วนตัว ประวัติการอ่าน และสถิติการเขียนจะถูกลบอย่างถาวร',
    'settings.delete.published': 'คุณได้เผยแพร่เนื้อหาบนแพลตฟอร์มนี้แล้ว การลบบัญชีของคุณจะทำให้ผลงานที่คุณเผยแพร่เป็นแบบไม่ระบุตัวตน (ลบชื่อและข้อมูลโปรไฟล์ของคุณ) แทนที่จะลบผลงานเหล่านั้น ความคิดเห็นของคุณจะถูกแทนที่ด้วย "[ถูกลบ]" หากคุณต้องการถอนการเผยแพร่ผลงานของคุณก่อน กรุณาดำเนินการก่อนลบบัญชีของคุณ',
    ...
    'settings.delete.error': 'การลบบัญชีพบข้อผิดพลาด โปรดติดต่อฝ่ายสนับสนุนหากปัญหายังคงอยู่',
