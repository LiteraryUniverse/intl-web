...
export default {
    ...
    'common.futurefeature.text': 'Мы приносим свои извинения, но на данный момент эта функция недоступна. Мы прилагаем все усилия, чтобы сделать ее доступной как можно скорее.',
    ...
    'errorLoading.explained': 'Во время загрузки страницы произошла ошибка. Мы приносим извинения за причиненные неудобства. Пожалуйста, попробуйте зайти на страницу еще раз. Если проблема не исчезнет, пожалуйста, сообщите нам.',
    ...
    goodbyeForever: 'Нам очень жаль, что Вы уходите. Это было что-то, что мы сделали? Пожалуйста, дайте нам знать, если это так. В любом случае, мы желаем Вам всего наилучшего в Ваших будущих начинаниях и надеемся, что мы еще встретимся! Живите долго и процветайте!',
