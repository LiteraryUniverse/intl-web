...
export default {
  ...
  'licenses.cc-by':
    'See litsents võimaldab teistel levitada, muuta, kohandada ja luua sinu töö põhjal uusi teoseid, ka kommertslikul eesmärgil, tingimusel et nad annavad sulle autorikrediidi algse loomingu eest. See on kõige paindlikum litsents, mida pakutakse. Soovitatav maksimaalseks levitamiseks ja litsentsitud materjalide kasutamiseks.',
  'licenses.name.cc-by-sa': 'Creative Commons Attribution-ShareAlike 4.0',
  'licenses.cc-by-sa':
    'See litsents võimaldab teistel muuta, kohandada ja luua sinu töö põhjal uusi teoseid isegi kommertslikul eesmärgil, tingimusel et nad annavad sulle autorikrediidi ja litsenseerivad oma uued teosed samadel tingimustel. Seda litsentsi võrreldakse sageli "copyleft" vaba ja avatud lähtekoodiga tarkvaralitsentsidega. Kõik sinu tööle baseeruvad uued teosed kannavad sama litsentsi, seega võimaldab see ka kommertslikku kasutamist. Seda litsentsi kasutatakse Wikipedias ja soovitatakse materjalidele, mis saaksid kasu Wikipedias ja sarnaselt litsenseeritud projektidest sisu integreerimisest.',
  'licenses.name.cc-by-nd': 'Creative Commons Attribution-NoDerivs 4.0',
  'licenses.cc-by-nd':
    'See litsents võimaldab teistel levitada sinu tööd nii kommertslikul kui ka mitteärilisel eesmärgil, tingimusel et see edastatakse muutumatul kujul ja tervikuna ning antakse sulle autorikrediit.',
  'licenses.name.cc-by-nc': 'Creative Commons Attribution-NonCommercial 4.0',
  'licenses.cc-by-nc':
    'See litsents võimaldab teistel muuta, kohandada ja luua sinu töö põhjal uusi teoseid mitteärilisel eesmärgil ning kuigi nende uued teosed peavad samuti tunnustama sinu panust ja olema mitteärilised, ei pea nad oma tuletatud teoseid litsentseerima samadel tingimustel.',
  'licenses.name.cc-by-nc-sa': 'Creative Commons Attribution-NonCommercial-ShareAlike 4.0',
  'licenses.cc-by-nc-sa':
    'See litsents võimaldab teistel muuta, kohandada ja luua sinu töö põhjal uusi teoseid mitteärilisel eesmärgil, tingimusel et nad annavad sulle autorikrediidi ja litsenseerivad oma uued loomingu samadel tingimustel.',
  'licenses.name.cc-by-nc-nd': 'Creative Commons Attribution-NonCommercial-NoDerivs 4.0',
  'licenses.cc-by-nc-nd':
    'See litsents on meie kuuest peamisest litsentsist kõige piiravam, lubades teistel ainult sinu töid alla laadida ja neid teistega jagada, tingimusel et nad annavad sulle autorikrediidi, kuid nad ei tohi neid mingil viisil muuta ega kasutada kommertslikul eesmärgil.',
  'licenses.name.lu-c': 'Kirjandusliku Universumi autoriõigused',
  'licenses.lu-c':
    'Standardne täielik autoriõiguste litsents, mis võimaldab teil oma tööd müüa ja avaldada nii, nagu soovite, ning kaitsta oma õigusi sellele. Selle litsentsi abil saate ka oma lugusid müüa Literatuurne Universumis.',
  'licenses.name.cc0': 'Ühtegi õigust ei ole kaitstud - CC0 1.0',
  'licenses.cc0':
    'Avaldage oma töö avalikku valda. Erinevalt CC litsentsidest, mis võimaldavad autoriõiguste omajatel valida erinevate lubade vahel, säilitades samas oma autoriõigused, annab CC0 veel ühe valiku - võimaluse loobuda autoriõigusest ja andmebaasi kaitsest ning loojatele automaatselt antud ainuõigustest - "ühtegi õigust ei ole kaitstud" alternatiivi meie litsentsidele.',
}
