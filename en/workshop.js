export default {
  ...
  'workshop.universe.delete.notAllowed':
    'This universe can no longer be deleted through self-service. If you need it removed after the limitation period, please contact us.',
  'workshop.universe.unpublish.modalAria':
    'Confirmation modal for unpublishing a universe',
  'workshop.universe.unpublish.confirm': 'Unpublish Universe',
  'workshop.universe.unpublish.warning':
    'Unpublishing will remove this universe from public discovery and search.',
  ...
  'workshop.story.republish.modalAria':
    'Confirmation modal for republishing a story',
  'workshop.story.republish.warning':
    'Republishing will make this story discoverable again and allow new users to add it to their library.',
