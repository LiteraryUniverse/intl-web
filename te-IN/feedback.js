export default {
  ...
  'feedback.report.reportSaved':
    'నివేదిక కోసం ధన్యవాదాలు! మార్గంపై అన్వేషిస్తాము మరియు అవసరం అయితే చర్య తీసుకునేందుకు తీసుకోబోతాము.',
  ...
  'faq.answer.about.dataLocation':
    'లిటరరీ యూనివర్స్ డేటా యూనైటెడ్ స్టేట్స్ ఆఫ్ అమెరికలో, కొనసాగుతున్నారు, విశేషాంశంగా AWS us-east-1 ప్రాంతంలో.',
