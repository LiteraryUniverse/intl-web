export default {
  'roadmap.ariaTimeOptions': 'ରୋଡମାପ ଆଇଟମଗୁଡ଼ିକୁ ତାଲିକାରେ ରୁପାନ୍ତରିତ କରିବା ପାଇଁ ତାଙ୍କ ଅବସ୍ଥା ଆଧାରରେ ଚୟନଗୁଡ଼ିକୁ ।',
  'roadmap.state.backlog': 'ବ୍ୟାକ୍ଲଗ୍',
  'roadmap.state.inprogress': 'ପ୍ରଗତିରେ ଆଛି',
  'roadmap.state.preview': 'ପୂର୍ବଦର୍ଶନ',
  'roadmap.state.beta': 'ବେଟା',
  'roadmap.state.ga': 'ସାଧାରଣ ପ୍ରାପ୍ତି',
  'roadmap.eta.q1.short': 'Q1',
  'roadmap.eta.q2.short': 'Q2',
  'roadmap.eta.q3.short': 'Q3',
  'roadmap.eta.q4.short': 'Q4',
  'roadmap.eta.q1.long': 'ପ୍ରଥମ ତ୍ରୟମାସ',
  'roadmap.eta.q2.long': 'ଦ୍ୱିତୀୟ ତ୍ରୟମାସ',
  'roadmap.eta.q3.long': 'ତୃତୀୟ ତ୍ରୟମାସ',
  'roadmap.eta.q4.long': 'ଚତୁର୍ଥ ତ୍ରୟମାସ',
  'roadmap.backlog': 'ବ୍ୟାକ୍ଲଗ୍',
