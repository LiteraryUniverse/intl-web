...
export default {
    ...
    'common.swUpdate.ready.title': 'Обновление готово',
    'common.swUpdate.ready.description': 'Новая версия уже готова. Вы можете применить ее прямо сейчас.',
    'common.swUpdate.ready.writerDescription': 'Новая версия готова. Примените ее, когда закончите текущие правки текста.',
    'common.swUpdate.apply': 'Обновить сейчас',
    ...
    'dashboard.writerResume': 'Резюме писателя',
    ...
    'common.done': 'Готово',
    'contentSelector.noSelection': 'Не выбрано ни одного предмета',
    'contentSelector.selectedItems': 'Избранные предметы',
    'contentSelector.entireSite': 'Поиск по сайту',
    'contentSelector.tabsLabel': 'Варианты поиска',
    'contentSelector.title': 'Выберите содержание',
    ...
    'actions.sendToKindle': 'Отправить на Kindle',
    ...
    'invitation.page.title': 'Приглашение',
    'invitation.title': 'Вас пригласили!',
    'invitation.detail.invitedBy': 'Приглашены',
    'invitation.detail.to': 'Присоединиться',
    'invitation.detail.role': 'Роль',
    'invitation.role.member': 'Член',
    'invitation.role.collaborator': 'Сотрудник',
    'invitation.role.translator': 'Переводчик',
    'invitation.role.beta': 'Бета-ридер',
    'invitation.objectType.organization': 'организация',
    'invitation.objectType.story': 'история',
    'invitation.objectType.universe': 'Вселенная',
    'invitation.accept': 'Примите приглашение',
    'invitation.accepting': 'Принимаю...',
    'invitation.decline': 'Упадок',
    'invitation.loginRequired': 'Пожалуйста, войдите в систему или создайте учетную запись, чтобы ответить на это приглашение.',
    'invitation.haveAccount': 'У меня есть учетная запись',
    'invitation.newHere': 'Я здесь новичок',
    'invitation.registerPrompt': 'Создайте бесплатную учетную запись, чтобы принять это приглашение.',
    'invitation.register': 'Создайте учетную запись',
    'invitation.goToDashboard': 'Перейдите в раздел "Приборная панель',
    'invitation.alreadyAccepted.title': 'Приглашение уже принято',
    'invitation.alreadyAccepted.message': 'Это приглашение уже принято.',
    'invitation.alreadyDeclined.title': 'Приглашение отклонено',
    'invitation.alreadyDeclined.message': 'Это приглашение было отклонено.',
    'invitation.declined.title': 'Приглашение отклонено',
    'invitation.declined.message': 'Вы отклонили приглашение.',
    'invitation.cancelled.title': 'Приглашение отменено',
    'invitation.cancelled.message': 'Это приглашение было отменено отправителем.',
