...
export default {
  ...
  'email.enrollAccount.messageHtml':
    'Ba mhaith linn cuireadh a thabhairt duit chuig Domhan Liteartha! Tá cuntas pearsanta cruthaithe againn duit áit a mbeidh rochtain agat ar gach gné de Domhan Liteartha! Bainimid taitneamh as do chuideachta leis an gcéad ghlúin eile de scríbhneoireacht agus léitheoireacht chruthaitheacha!',
  'email.enrollAccount.button': 'Rochtain ar do chuntas',
  'email.enrollAccount.signature':
    'Táimid ag súil go mór leat a fheiceáil, foireann Literary Universe<br />',
  // Reset password
  'email.resetPassword.messageHtml':
    "Táimid tar éis iarratas a fháil chun do phasfhocal a athshocrú do do chuntas, clicáil ar an gcnaipe thíos chun leanúint ar aghaidh leis an bpróiseas. Má níor rinne tú an iarratas seo, is féidir leat an ríomhphost seo a neamhaird, ach b'fhéidir go bhfuil sé in am maith do shocruithe slándála a athbhreithniú.",
  'email.resetPassword.button': 'Athshocraigh pasfhocal',
  // E-mail verification
  'email.verifyEmail.messageHtml':
    'Táimid sásta go bhfuil tú ar bord! Cliceáil ar an gcnaipe thíos chun an seoladh ríomhphoist seo a dhearbhú.',
