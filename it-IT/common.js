...
export default {
  ...
  'site.description':
    'Literary Universe è una piattaforma creativa e di pubblicazione all-in-one per grandi universi narrativi.',
  'site.keywords':
    'scrittura creativa, scifi, sci-fi, fantasia, scrittura, pubblicazione, storia, storie, universo, web novel, webnovel',
  ...
  'common.accessdenied.msg':
    "Non hai il permesso di accedere. Se credi di avere l'autorizzazione per accedere, contatta il titolare e chiedi di ricontrollare le impostazioni.",
  ...
  'common.futurefeature.text':
    'Siamo molto spiacenti, ma questa funzione non è disponibile in questo momento. Stiamo lavorando sodo per renderla disponibile il prima possibile.',
  ...
  'common.legal.newVersionAvailable':
    'Una nuova versione ({newVersion}) di questo documento entrerà in vigore il {effectiveAt, date}.',
  'common.legal.disclaimer':
    '© {year} Tutti i diritti riservati, tutti i testi appartengono ai rispettivi autori.',
  'premium.only.title': 'Grado di iscrizione non sufficiente',
  'premium.only.msg':
    'Ci scusiamo, il tuo grado di iscrizione non è abbastanza alto per accedere a questa funzionalità.',
  'premium.only.join':
    'Offriamo diversi piani per permettere a tutti di avere il meglio da Literary Universe.',
  ...
  'errorLoading.explained':
    'Si è verificato un errore durante il caricamento della pagina. Ci scusiamo per il disagio. Prova ad accedere nuovamente alla pagina. Se il problema persiste, sei pregato/a di comunicarcelo.',
  ...
  goodbyeForever:
    'Ci dispiace vederti andare via! Abbiamo sbagliato qualcosa? Ti chiediamo di farcelo sapere. In ogni caso ti auguriamo il meglio per le tue future imprese e speriamo di incontrati di nuovo! Lunga vita a te!',
  ...
  'common.2faCodeIntro':
    'Inserisci il tuo codice unico generato dalla tua applicazione di autenticazione.',
  ...
  'signin.web3.signMessage':
    'Confermare che si desidera entrare in Literary Universe con il proprio portafoglio come metodo di autenticazione. Codice: {code}',
  ...
  create: 'Crea',
  'banner.support':
    'Literary Universe è supportato dagli utenti come te! Considera di abbonarti a uno dei nostri piani di abbonamento per rimanere indipendente e rendere Literary Universe ancora migliore!',
  ...
  'console.explain':
    "Questa è una funzionalità del browser destinata agli sviluppatori. Se qualcuno ti ha detto di copiare e incollare qualcosa qui per abilitare una funzione dell'Universo Letterario o \"hackerare\" l'account di qualcuno, si tratta di una truffa e darà loro accesso al tuo account dell'Universo Letterario.",
