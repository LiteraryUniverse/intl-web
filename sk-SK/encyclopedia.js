export default {
  ...
  'encyclopedia.help.text':
    'Na navigáciu medzi položkami encyklopédie použite menu na ľavej strane. Po výbere položky sa zobrazí namiesto tohto textu.',
  'encyclopedia.help.sidebar': 'Súbor nástrojov bočného panela',
  'encyclopedia.help.sidebar.text':
    'Vitajte vo svojom príbehu! Tento bočný panel vám umožňuje jednoduchý prístup ku všetkým zdrojom súvisiacim s vaším príbehom. Zaškrtnutím ikon vyššie si môžete pozrieť najnovšie komentáre, svoje poznámky, vyhľadávať vo svojej encyklopédii, prechádzať a pridávať nové záznamy do svojej encyklopédie. Ak chcete pridať pripojenie k záznamu z textu príbehu, vyberte text, kam ho chcete umiestniť, a potom kliknite na tlačidlo pripojiť. Následne budete vyzvaní na vyhľadanie a výber položky.',
  ...
  'encyclopedia.container.desc':
    'Vytvorte z tejto položky kontajner pre novú skupinu položiek. Tým sa skryje zo zoznamu kategórií.',
  'encyclopedia.entry.name': 'Názov položky',
  'encyclopedia.summary': 'Zhrnutie',
  'encyclopedia.summary.desc':
    'Toto je zhrnutie, ktoré bude jedinou úvodnou informáciou zobrazenou na čítačke.',
  ...
  'encyclopedia.translation.desc':
    'Toto encyklopedické rozhranie sa používa na preklad do {language}. Vyberte existujúce položky v zozname na ľavej strane a začnite ich preklad.',
...
other {je # položiek}
  ...
  'encyclopedia.settings.categoriesDesc':
    'Zapnite a vypnite kategórie, ktoré chcete používať v encyklopédii.',
  ...
  'enc.entries.limitReached':
    'Dosiahli ste maximálny povolený počet záznamov v encyklopédii pre aktuálne predplatné.',
  ...
  'encyclopedia.settings.templateDescription':
    'Povoliť kopírovanie obsahu tejto encyklopédie do iných vesmírov. Toto je najlepšie, ak nemáte žiadne príbehy a namiesto toho len vytvárate šablónu pre ostatných.',
  ...
  'encyclopedia.templateCopy.description':
    'Skopírujte obsah tejto encyklopédie do vášho vesmíru, aby ste ho obohatili.',
