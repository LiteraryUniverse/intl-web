...
export default {
  ...
  'email.enrollAccount.messageHtml':
    "Volem convidar-te a l'Univers Literari! Hem preparat un compte personal per a tu on podràs accedir a totes les funcionalitats de l'Univers Literari! Uneix-te a nosaltres per crear la propera generació d'escriptura i lectura creatives!",
  ...
  'email.resetPassword.messageHtml':
    'Hem rebut una sol·licitud per restablir la teva contrasenya del teu compte, si us plau fes clic al botó de sota per continuar amb el procés. Si no has fet aquesta sol·licitud, pots ignorar aquest correu electrònic, però pot ser un bon moment per revisar la configuració de seguretat.',
  'email.resetPassword.button': 'Restablir contrasenya',
  // E-mail verification
  'email.verifyEmail.messageHtml':
    'Estem encantats de tenir-te a bord! Si us plau fes clic al botó de sota per verificar aquesta adreça de correu electrònic.',
