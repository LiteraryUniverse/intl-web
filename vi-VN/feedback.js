export default {
  ...
  'feedback.bugs.desc':
    'Bạn đã gặp phải lỗi hoặc điều gì đó không đúng hoặc không đúng chỗ. Hãy cho chúng tôi biết ở đây!',
  'feedback.features': 'Ý tưởng & Đề xuất',
  'feedback.features.desc':
    'Có ý tưởng cho các tính năng mới hoặc cách để làm cho trang web tốt hơn? Hãy cho chúng tôi biết!',
  ...
  'feedback.lang.nosupport':
    'Ngôn ngữ hiện tại của bạn không được hỗ trợ cho phản hồi, vui lòng viết bằng tiếng Anh. Cảm ơn bạn!',
  ...
  'feedback.report.reportSaved':
    'Cảm ơn bạn đã gửi báo cáo! Chúng tôi sẽ điều tra và xử lý nếu cần thiết.',
  'feedback.report.copyrightReportSaved':
    'Cảm ơn bạn đã gửi báo cáo! Chúng tôi sẽ điều tra và liên lạc.',
  'feedback.report.copyrightOwnershipDesc': 'Tuyên bố sở hữu',
  'feedback.report.copyrightNotice':
    'Vui lòng lưu ý rằng bạn cần là chủ sở hữu hợp pháp của tác phẩm để sử dụng biểu mẫu này. Nếu bạn không phải là chủ sở hữu, vui lòng thông báo cho chủ sở hữu hoặc sử dụng danh mục khác để thông báo cho chúng tôi. Chúng tôi coi trọng việc vi phạm bản quyền và cũng áp dụng tương tự đối với việc sử dụng sai mục đích và lạm dụng biểu mẫu này.',
  'feedback.report.copyrightInternalProperty':
    'Tôi đã xuất bản tác phẩm này trên Literary Universe',
