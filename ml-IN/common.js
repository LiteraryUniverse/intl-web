...
export default {
    ...
    'common.done': 'ചെയ്തു',
    'contentSelector.noSelection': 'ഒന്നും തിരഞ്ഞെടുത്തിട്ടില്ല',
    'contentSelector.selectedItems': 'തിരഞ്ഞെടുത്ത ഇനങ്ങൾ',
    'contentSelector.entireSite': 'സൈറ്റിൽ തിരയുക',
    'contentSelector.tabsLabel': 'തിരയൽ ഓപ്ഷനുകൾ',
    'contentSelector.title': 'ഉള്ളടക്കം തിരഞ്ഞെടുക്കുക',
