export default {
  ...
  'blog.theme': 'Teema',
  'blog.theme.info':
    'Muokkaamalla teemaa voit muuttaa sivun ulkonäköä. Tämä toiminto ei ole tällä hetkellä käytettävissä.',
  ...
  'blog.settings.universeSettings':
    'Universe-blogeja integroidaan universumisivuille yleisillä asetuksilla.',
