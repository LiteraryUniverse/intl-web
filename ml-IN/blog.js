export default {
  ...
  'blog.theme': 'തീം',
  'blog.theme.info':
    'തീം സജ്ജീകരിച്ചാൽ നിങ്ങൾക്ക് പേജിന്റെ രൂപം മാറ്റാൻ കഴിയും. ഈ സവിശേഷത ഇപ്പോൾ പൂർണമായി പരിശോധിക്കപ്പെടുന്നില്ല.',
  ...
  'blog.settings.universeSettings':
    'യൂണിവേഴ്സ് ബ്ലോഗുകൾ യൂണിവേഴ്സ് കാഴ്ചകളിൽ അവയുടെ അടിസ്ഥാന ക്രമീകരണങ്ങൾ ഉപയോഗിച്ച് സജീവമാക്കപ്പെടുന്നു.',
