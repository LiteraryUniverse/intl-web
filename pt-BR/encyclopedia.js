export default {
    ...
    'encyclopedia.help.sidebar.text': 'Bem-vindo à sua história! Esta barra lateral permite acesso fácil a todos os recursos relacionados à sua história. Verifique os ícones acima para ver os comentários mais recentes, suas anotações, pesquisar sua enciclopédia, navegar e adicionar novas entradas à sua enciclopédia. Se você deseja adicionar uma conexão a uma entrada do texto da história, selecione o texto onde deseja colocá-la e clique no botão de conexão. Você será então solicitado a encontrar e selecionar um item.',
    ...
    'encyclopedia.container.desc': 'Faça desta entrada um container para um novo grupo de entradas. Isso irá ocultá-la da listagem de categorias.',
    'encyclopedia.entry.name': 'Nome da entrada',
    'encyclopedia.summary': 'Sumário',
    'encyclopedia.summary.desc': 'Esta é um resumo que será a única informação inicial exibida ao leitor.',
