...
export default {
  ...
  'email.enrollAccount.signature':
    'გვიამბებთ, რომ გიხდით ხელმეორედ ხელმისაწვდომი,<br />ლიტერატურის უნივერსიტეტის გუნდი',
  // Reset password
  'email.resetPassword.messageHtml':
    'მიიღეთ მოთხოვნა თქვენი პაროლის განულებისთვის, გთხოვთ, დააწკაპუნეთ ღილაკზე ქვემოთ, რათა გაგრძელოთ პროცესი. თუ არ განისაზღვრეთ ამ მოთხოვნას, შეგიძლიათ არასაჭიროების შემოწმება, მაგრამ ეს შესაძლებლობაა კარგი დრო თქვენი უსაფრთხოების პარამეტრების განახლებისთვის.',
  'email.resetPassword.button': 'პაროლის განულება',
  // E-mail verification
  'email.verifyEmail.messageHtml':
    'გვიამბებთ, რომ გვთავაზობთ თქვენს მიერ არჩეულ პროექტში მონაწილეობას! გთხოვთ, დააწკაპუნოთ ღილაკზე ქვემოთ, რათა დაამოწმოთ ეს ელ-ფოსტის მისამართი.',
