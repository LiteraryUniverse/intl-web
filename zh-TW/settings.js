export default {
    ...
    'settings.export.explain': '這會將儲存在我們資料庫中的所有個人資料匯出為 JSON 檔案。這包括您的個人資料、故事、閱讀歷史、日記條目、個人筆記、寫作統計、書籤、閱讀清單、社群活動、會員資格，以及與您帳戶相關的所有其他資料。',
    'settings.export.submit': '匯出資料',
    'settings.delete.title': '刪除帳戶',
    'settings.delete.warning': '警告：刪除帳戶後，您將永遠喪失對此帳戶的存取權，且無法復原。所有私人資料，包括日記項目、個人筆記、閱讀歷史和寫作統計資料都將被永久刪除。',
    'settings.delete.published': '您已在平台上發佈內容。刪除您的帳戶會將您發表的作品匿名化 (移除您的姓名和個人資料)，而非刪除。您的評論將會以"[deleted]"取代。如果您想先取消發表作品，請在刪除帳號前進行。',
    'settings.delete.confirm': '為確保安全，您確定要刪除帳戶嗎？',
    'settings.delete.cancel': '我不想刪除我的帳戶',
    'settings.delete.submit': '刪除我的帳戶',
    'settings.delete.error': '帳戶刪除遇到錯誤。如果問題仍然存在，請聯絡支援人員。',
