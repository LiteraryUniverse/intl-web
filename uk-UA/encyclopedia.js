export default {
  ...
  'encyclopedia.help.text':
    'Використовуйте меню зліва, щоб переміщуватися між елементами енциклопедії. Після вибору елемента, він буде відображатися замість цього тексту.',
  ...
  'encyclopedia.container.desc':
    'Зробити цей запис контейнером для нової групи записів. Це приховає його від списку категорій.',
  'encyclopedia.entry.name': 'Назва запису',
  'encyclopedia.summary': 'Опис',
  'encyclopedia.summary.desc':
    'Це опис, який буде єдиною початковою інформацією, відображеною для читача.',
  ...
  'encyclopedia.translation.desc':
    'Цей інтерфейс енциклопедії використовується для перекладу на {language}. Виберіть існуючі записи зі списку зліва, щоб розпочати їх переклад.',
  ...
  'encyclopedia.settings.categoriesDesc':
    'Увімкніть та вимкніть категорії, які ви хочете використовувати в енциклопедії.',
  ...
  'enc.entries.limitReached':
    'Ви досягли максимально допустимої кількості записів в енциклопедії для вашої поточної підписки.',
  ...
  'encyclopedia.settings.templateDescription':
    'Дозволити копіювання вмісту цієї енциклопедії в інші всесвіти. Це найкраще, якщо у вас немає жодних історій і ви просто створюєте шаблон для використання іншими.',
  ...
  'encyclopedia.templateCopy.description':
    'Скопіюйте вміст цієї енциклопедії до вашого всесвіту, щоб збагатити його.',
