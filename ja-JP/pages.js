export default {
    ...
    'homepage.reader.readingTitle': 'ユニークな読書体験',
    'homepage.reader.readingDesc': 'Literary Universeでは、お気に入りの架空の宇宙をより深く掘り下げることができます。Literary Universeのストーリーは同じ宇宙内でつながっており、ストーリーリーダーからすぐに宇宙百科事典にアクセスすることができます。',
    'homepage.reader.favoriteTitle': 'お気に入りの物語や作家についてもっと知ることができる',
    'homepage.reader.favoriteDesc': '宇宙大百科や作者ブログなど、好きな物語や設定、作者について何でも知ることができる機能が満載です。',
    ...
    'homepage.reader.readingExploreDesc': '宇宙大百科では、宇宙に関するあらゆる情報を知ることができ、物語にどっぷりと浸かることができます。',
    'homepage.reader.start': '読み始める',
    'homepage.writer.title': 'あなたのユニバースを紹介し、ストーリーを共有する',
    'homepage.writer.writingTitle': '書くこと、作ることを簡単にする',
