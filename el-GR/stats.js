export default {
    ...
    'stats.notEnoughData': 'Δεν υπάρχουν αρκετά δεδομένα',
    ...
    'stats.readingTime.title': 'Χρόνος ανάγνωσης Analytics',
    ...
    'stats.readingHabits.profileSummaryNoPeak': 'Ανάγνωση τις τελευταίες {weeks, number} εβδομάδες: {sessions, number} συνεδρίες, {duration} συνολικά.',
    ...
    'stats.writingHistory.diaryWords': 'Λέξεις ημερολογίου',
    // Writing history day tooltip - per-category breakdown
    'stats.writingHistory.dayTooltip.stories': 'Ιστορίες: {words}',
    'stats.writingHistory.dayTooltip.encyclopedia': 'Εγκυκλοπαίδεια: {words}',
    'stats.writingHistory.dayTooltip.blog': 'Blog: {words}',
    'stats.writingHistory.dayTooltip.diary': 'Ημερολόγιο: {words}',
    ...
    'stats.sales.product.story': 'Όλη η ιστορία',
