...
export default {
  ...
  'flashnews.onlyDisplayOn':
    'Berita akan ditampilkan hanya dalam bahasa yang dipilih di bawah ini (jika ada yang dipilih), tidak ada berita yang ditampilkan, bahkan dalam bahasa default, dalam bahasa lain.',
  ...
  'notification.workshopStoryStatus.toHiatus':
    'Cerita Anda {storyName} secara otomatis disetel ke status hiatus setelah 6 bulan tidak aktif.',
  'notification.workshopStoryStatus.toCancelled':
    'Cerita Anda {storyName} secara otomatis dibatalkan setelah satu tahun tidak aktif.',
