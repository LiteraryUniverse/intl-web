...
export default {
  ...
  'plans.feature.stats': 'Basic analytics',
  'plans.feature.stats.advanced': 'Advanced analytics',
  ...
  'service.meteor-developer.disconnect': 'Disconnect from Meteor Developer Account',
  'service.meetup.login': 'Login with Meetup',
  'service.meetup.connect': 'Connect to Meetup',
  'service.meetup.disconnect': 'Disconnect from Meetup account',
  'service.weibo.login': 'Login with Weibo',
  'service.weibo.connect': 'Connect to Weibo',
  'service.weibo.disconnect': 'Disconnect from Weibo account',
  'service.github.login': 'Login with Github',
  'service.github.connect': 'Connect to Github',
  'service.github.disconnect': 'Disconnect from Github account',
