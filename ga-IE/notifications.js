...
export default {
  ...
  'flashnews.onlyDisplayOn':
    'Beidh an scéala á sheinm ar na teangacha a roghnaítear thíos (mura roghnaítear aon cheannacha), ní bheidh aon scéal le feiceáil, fiú sa teanga réamhshocraithe, i dteangacha eile.',
  ...
  'notification.workshopStoryStatus.toHiatus':
    'Tá do scéal {storyName} curtha ar athló tar éis 6 mí gan gníomhaíocht.',
  'notification.workshopStoryStatus.toCancelled':
    'Tá do scéal {storyName} curtha ar ceal go huathoibríoch tar éis bliain gan gníomhaíocht.',
