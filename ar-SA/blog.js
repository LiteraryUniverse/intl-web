export default {
  ...
  'blog.theme': 'الموضوع',
  'blog.theme.info':
    'عند ضبط الموضوع ، ستتمكن من تغيير شكل الصفحة. هذه الميزة غير متاحة في الوقت الحالي.',
  ...
  'blog.settings.universeSettings':
    'تم دمج مدونات العالم في صفحات العالم مع الإعدادات الأساسية المأخوذة من إعدادات العالم.',
