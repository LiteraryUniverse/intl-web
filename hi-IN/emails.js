...
export default {
  ...
  'email.enrollAccount.messageHtml':
    'हम आपको कविता यूनिवर्स में आमंत्रित करना चाहेंगे! हमने आपके लिए एक व्यक्तिगत खाता तैयार कर दिया है जहां आप कविता यूनिवर्स के सभी सुविधाओं तक पहुंच सकते हैं! कृपया हमें रचनात्मक लेखन और पठन की अगली पीढ़ी में शामिल हों!',
  ...
  'email.resetPassword.messageHtml':
    'हमें आपके खाते के लिए पासवर्ड रीसेट करने का एक अनुरोध प्राप्त हुआ है, कृपया प्रक्रिया जारी रखने के लिए नीचे दिए गए बटन पर क्लिक करें। यदि आपने यह अनुरोध नहीं किया है तो आप इस ईमेल को नज़रअंदाज़ कर सकते हैं, लेकिन यह आपके सुरक्षा सेटिंग्स की समीक्षा करने का एक अच्छा समय हो सकता है।',
  'email.resetPassword.button': 'पासवर्ड रीसेट करें',
  // E-mail verification
  'email.verifyEmail.messageHtml':
    'हमें आपको बोर्ड पर देख कर खुशी हुई! कृपया इस ईमेल पते की पुष्टि करने के लिए नीचे दिए गए बटन पर क्लिक करें।',
