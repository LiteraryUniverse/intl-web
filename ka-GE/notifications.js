...
export default {
  ...
  'flashnews.onlyDisplayOn':
    'ამ სიახლის გამოქვეყნება მოხდება მხოლოდ არჩეული ენებით (თუ არამნაშინი მინიმუმ ერთი არჩეულია), სხვა ენებში არ გამოქვეყნება სიახლეები არაა, ჩვენს ტერმინებითა და მიზეზის მიხედვით',
  ...
  'notification.workshopStoryStatus.toHiatus':
    'თქვენი რომანი {storyName} -ზე ავტომატურად გაქვთ დაფარული პაუზა 6 თვის უმატებლობის შემდეგ',
  'notification.workshopStoryStatus.toCancelled':
    'თქვენი რომანი {storyName} -ზე ავტომატურად გაქვთ დაფარული გაუქმება 1 წელის უმატებლობის შემდეგ',
