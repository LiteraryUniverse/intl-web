export default {
    ...
    'workshop.story.monetizationTitle': 'కథ లాభార్జన',
    ...
    'workshop.monetization.minPriceNotice': 'ధరలను సేవ్ లేదా సింక్ చేసే ముందు, లైసెన్స్-నిర్దిష్ట కనీస ధరలతో వాటిని ధృవీకరిస్తారు.',
    'workshop.monetization.storyPrices': 'కథల ధరలు',
    'workshop.monetization.minPrice': 'కనీసం: {price}',
    'workshop.monetization.revenueSplit': 'ఆదాయ విభజన',
    'workshop.monetization.userId': 'కంట్రిబ్యూటర్ యూజర్ ఐడి',
    'workshop.monetization.splitTotal': 'కంట్రిబ్యూటర్ మొత్తం విభజన: {total}%',
    'workshop.monetization.arcPricing': 'ఆర్క్ ధరల నిర్ణయం',
    'workshop.monetization.arcRange': 'అధ్యాయాలు {from}–{to}',
    'workshop.monetization.arcEnabled': 'ఈ ఆర్క్‌ను విడిగా అమ్మండి',
    'workshop.monetization.saved': 'ధరల సెట్టింగ్‌లు సేవ్ చేయబడ్డాయి.',
    'workshop.monetization.synced': 'స్ట్రైప్ ఉత్పత్తులు మరియు ధరలు సింక్ చేయబడ్డాయి.',
    'workshop.monetization.syncStripe': 'స్ట్రైప్‌తో సింక్ చేయండి',
    ...
    'workshop.outliner.dragHint': 'ఏదైనా సన్నివేశ కాలమ్‌లు మరియు కథాంశాల మధ్య కార్డులను లాగండి.',
    ...
    'workshop.outliner.dragScene': 'డ్రాగ్ సన్నివేశం',
    ...
    'workshop.sceneManager.title': 'సీన్ మేనేజర్ – {storyTitle}',
    'workshop.scene.create': 'సన్నివేశాన్ని సృష్టించు',
    'workshop.scene.edit': 'సన్నివేశాన్ని సవరించు',
    'workshop.scene.empty': 'ఈ అధ్యాయానికి ఇంకా సన్నివేశాలు ప్రణాళిక చేయబడలేదు.',
    'workshop.scene.checklist': 'అధ్యాయ దృశ్యాలు',
    'workshop.scene.checklist.empty': 'ఈ అధ్యాయానికి ఇంకా దృశ్యాలు కేటాయించబడలేదు.',
    'workshop.scene.title.placeholder': 'సీన్ శీర్షిక…',
    'workshop.scene.details': 'సన్నివేశ వివరాలు',
    'workshop.scene.assignments.hint': 'మీ విజ్ఞాన సర్వస్వం నుండి పాత్రలను మరియు ప్రదేశాలను కేటాయించండి.',
