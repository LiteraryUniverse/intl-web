...
To activate your account, simply click the link below:\n\n{url}`,
  ...
  'email.enrollAccount.messageHtml':
    'Rádi by jsme Vás pozvali na Literary Universe! Připravili jsme pro Vás osobní účet s plným přístupek k Literary Universe! Doufáme že se přidáte a pomůžete nám vytvořit další kapitolu v kreativním psaní a čtení!',
  ...
  'email.resetPassword.messageHtml':
    'Obdrželi jsme Váš požadavek na resetování Vašeho hesla, prosím klikněte na tlačítko níže k dokončení tohoto procesu.',
  'email.resetPassword.button': 'Resetovat heslo',
  // E-mail verification
  'email.verifyEmail.messageHtml':
    'Vítejte na palubě! Pro potvrzení této e-mailové adresy prosím klikněte na tlačítko níže.',
