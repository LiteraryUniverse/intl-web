...
export default {
    ...
    'common.swUpdate.ready.title': 'Připravena aktualizace',
    'common.swUpdate.ready.description': 'Nová verze je připravena. Můžete ji použít nyní.',
    'common.swUpdate.ready.writerDescription': 'Nová verze je připravena. Použijte ji, jakmile dokončíte aktuální písemné úpravy.',
    'common.swUpdate.apply': 'Aktualizovat nyní',
    ...
    'dashboard.writerResume': 'Životopis spisovatele',
    ...
    'common.done': 'Hotovo',
    'contentSelector.noSelection': 'Žádné vybrané položky',
    'contentSelector.selectedItems': 'Vybrané položky',
    'contentSelector.entireSite': 'Vyhledávání na webu',
    ...
    'invitation.title': 'Jste pozváni!',
    'invitation.detail.invitedBy': 'Na pozvání',
    'invitation.detail.to': 'Chcete-li se připojit',
    'invitation.detail.role': 'Role',
    'invitation.role.member': 'Člen',
    'invitation.role.collaborator': 'Spolupracovník',
    'invitation.role.translator': 'Překladatel',
    'invitation.role.beta': 'Beta čtenář',
    'invitation.objectType.organization': 'organizace',
    'invitation.objectType.story': 'příběh',
    'invitation.objectType.universe': 'vesmír',
    'invitation.accept': 'Přijmout pozvání',
    'invitation.accepting': 'Přijetí...',
    'invitation.decline': 'Pokles',
    'invitation.loginRequired': 'Chcete-li odpovědět na tuto výzvu, přihlaste se nebo si vytvořte účet.',
    'invitation.haveAccount': 'Mám účet',
    'invitation.newHere': 'Jsem tu nový',
    'invitation.registerPrompt': 'Chcete-li přijmout tuto pozvánku, vytvořte si bezplatný účet.',
    'invitation.register': 'Vytvoření účtu',
    'invitation.goToDashboard': 'Přejít na ovládací panel',
    'invitation.alreadyAccepted.title': 'Pozvání již bylo přijato',
    'invitation.alreadyAccepted.message': 'Toto pozvání již bylo přijato.',
    'invitation.alreadyDeclined.title': 'Pozvání odmítnuto',
    'invitation.alreadyDeclined.message': 'Toto pozvání bylo odmítnuto.',
    'invitation.declined.title': 'Pozvání odmítnuto',
    'invitation.declined.message': 'Pozvání jste odmítli.',
    'invitation.cancelled.title': 'Pozvánka zrušena',
    'invitation.cancelled.message': 'Tato pozvánka byla odesílatelem zrušena.',
