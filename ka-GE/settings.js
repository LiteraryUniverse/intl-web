export default {
  ...
  'settings.languages.notice':
    'ინგლისური და ჩეხური ამჟამად არიან ერთადერთი რეალურად მხარდაჭერდებადი ენები. სხვა ენები ხდება ხელმისაწვდომი ვოლონტებისა და არტემის მადლობით, მაგრამ ისინი შეიძლება კიდევ არასრული და არასწორი იყოს ზედამხედველი ადგილებში.',
  'settings.languages.join':
    'თუ გსურთ ჩვენს დახმარება, შეგიძლიათ თქვენც თარგმნოთ Literary Universe.',
  ...
  'settings.web3.verify.explained':
    'ამ მისამართს თქვენს მფლობელობის დამოწმებისთვის გთხოვთ გახსნათ შეტყობინება და გადახედეთ თქვენი მიმდინარე მეტამეტს.',
  'settings.web3.verified': 'დამოწმებულია',
  'settings.web3.verificationMessage':
    'მომხმარებლის დამოწმება {username} Literary Universe-ისთვის. კოდი: {code}',
  'settings.web3.unlink': 'საფულე ამოშლა',
  'settings.web3.linkingMessage':
    'გთხოვთ დაადასტუროთ, რომ გსურთ თქვენი საფულეს დააკავშიროთ Literary Universe-ს. კოდი: {code}',
  ...
  'settings.accessibility.paragraphHighlighting':
    'გამოახსენით მიმდინარე პარაგრაფი, რომლის თქვენ ხართ მიმაგრების ზემოთ',
