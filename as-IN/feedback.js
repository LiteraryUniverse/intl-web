export default {
  ...
  'feedback.report.reportSaved':
    'প্ৰতিবেদনৰ বাবে ধন্যবাদ! আমি যদি প্ৰয়োজন হয় তেন্তে আমি তথ্য সংগ্ৰহ কৰি আৰোপ নিবাৰিব।',
  'feedback.report.copyrightReportSaved':
    'প্ৰতিবেদনৰ বাবে ধন্যবাদ! আমি তথ্য সংগ্ৰহ কৰি আৰোপ নিবাৰিব আৰু যোগাযোগ কৰিব।',
  'feedback.report.copyrightOwnershipDesc': 'মালিকানা বিবৰণী',
  'feedback.report.copyrightNotice':
    'দয়া কৰি মনত ধৰণীত আপুনি কাজটোৰ মালিক হওৱা লাগিব। যদি আপুনি মালিক নহয়, অনুগ্ৰহ কৰি মালিকক জানাইব অথবা আপুনি আমাৰ লগত যোগাযোগ কৰিব বাবে অন্য শ্ৰেণীত ব্যৱহাৰ কৰক। আমি কপিৰাইট লঙ্ঘনসমূহক অসম্ভবত গম্ভীৰভাৱে নেওৱাৰ চেষ্টা কৰি থাকোঁ আৰু এই ফর্মৰ অপচয়কৰ ব্যৱহাৰও তথ্য সংগ্ৰহ কৰি আৰোপ নিবাৰিব।',
  ...
  'faq.answer.about.roadmap':
    'এইটো সতত উন্নীত হোৱা হৈ থাকে। অধিক বিবৰণ পোৱা যাব আমাৰ <a href="/roadmap">ৰ পথপথি পৃষ্ঠাত</a> ।',
  // Settings questions
  'faq.question.settings.changeTheme': 'লিটেৰেৰী ইউনিভাৰ্সৰ চেহা কিবা সলনি কৰিব পাৰো?',
  'faq.answer.settings.changeTheme':
    'নিবন্ধিত ব্যৱহাৰকাৰীসকলে তালিকা পৰিবৰ্তন কৰিব পাৰে তাঁদৰ <a href="/user/settings/account">একাউণ্ট ছেটিংছত</a> অধীনত "চাইট থিমিং" বিভাগত। আমাৰ এটা প্ৰকাশ্য আৰু এটা কৃষ্ণ থিম উপলব্ধ। আপুনি যদি নিবন্ধিত নহয়, তেন্তে আমি আপোনাৰ ব্ৰাউজাৰ আৰু অপাৰেটিং ছিষ্টেমৰ ছেটিংছৰ ভিতৰত কোনো থিম আপডেট কৰিবলৈ চেষ্টা কৰিম।',
  'faq.question.settings.changeAvatar': 'মই কিবা প্ৰতিবিম্ব সলনি কৰিব পাৰো?',
  'faq.answer.settings.changeAvatar':
    'আপুনি আপোনাৰ প্ৰতিবিম্ব সলনি কৰিব পাৰিব আপোনাৰ <a href="/user/settings/profile">প্ৰফাইল ছেটিংছত</a>।',
  'faq.question.settings.changeLanguage': 'লিটেৰেৰী ইউনিভাৰ্সৰ ভাষা কিবা সলনি কৰিব পাৰো?',
  'faq.answer.settings.changeLanguage':
    'আপুনি লিটেৰেৰী ইউনিভাৰ্সৰ ভাষা পৰিবৰ্তন কৰিব পাৰিব আপোনাৰ <a href="/user/settings/account">একাউণ্ট ছেটিংছত</a>।',
  'faq.question.settings.translationMistake':
    'মই ওৱেবছাইটত থাকা লিখনিৰ ভুল পোৱা গৈছে, তাৰ কোথাতে জনাৰ পৰামৰ্শ কৰিব পাৰো?',
