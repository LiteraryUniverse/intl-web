export default {
  ...
  'encyclopedia.container.desc':
    'Bu girişi yeni bir grup girişin konteyneri yapın. Bu, kategoriler listesinden gizleyecektir.',
  'encyclopedia.entry.name': 'Girişin adı',
  'encyclopedia.summary': 'Özet',
  'encyclopedia.summary.desc':
    'Bu, okuyucuda yalnızca başlangıç bilgisi olarak gösterilecek bir özet.',
  ...
  'encyclopedia.translation.desc':
    'Bu ansiklopedi arayüzü, {language}diline çeviri yapmak için kullanılır. Çevirilerine başlamak için sol taraftaki listeden mevcut girişleri seçin.',
  ...
  'encyclopedia.settings.categoriesDesc':
    'Ansiklopedinizde kullanmak istediğiniz kategorileri açıp kapatın.',
  'encyclopedia.settings.introText':
    'Evren açıklamasından sonra görüntülenecek hoş geldiniz mesajı.',
  ...
  'enc.entries.limitReached':
    'Geçerli aboneliğiniz için izin verilen en fazla ansiklopedi girişine ulaştınız.',
  ...
  'encyclopedia.settings.templateDescription':
    'Bu ansiklopedinin içeriğinin diğer evrenlere kopyalanmasına izin verin. Bu, hikayeleriniz olmadan sadece başkalarının kullanması için bir şablon oluşturuyorsanız en iyisidir.',
  ...
  'encyclopedia.templateCopy.description':
    'Bu ansiklopedinin içeriğini evreninize kopyalayarak zenginleştirin.',
