export default {
    ...
    'settings.export.explain': 'Це дозволить експортувати всі ваші персональні дані, що зберігаються в нашій базі даних, у вигляді JSON-файлу. Сюди входять ваш профіль, історії, історія читання, записи в щоденнику, особисті нотатки, статистика написання, закладки, списки читання, активність у спільнотах, членство та всі інші дані, пов\'язані з вашим обліковим записом.',
    'settings.export.submit': 'Експортувати дані',
    'settings.delete.title': 'Видалити обліковий запис',
    'settings.delete.warning': 'ПОПЕРЕДЖЕННЯ: Видаляючи свій обліковий запис, ви назавжди втрачаєте доступ до нього, і відновити його неможливо. Всі приватні дані, включаючи записи в щоденнику, особисті нотатки, історію читання та статистику написання, будуть видалені назавжди.',
    'settings.delete.published': 'Ви опублікували контент на платформі. Видалення вашого облікового запису призведе до анонімізації ваших опублікованих робіт (видалення вашого імені та інформації про профіль), а не до їх видалення. Ваші коментарі будуть замінені на "[видалено]". Якщо ви хочете спочатку видалити свої роботи, будь ласка, зробіть це перед видаленням вашого облікового запису.',
    ...
    'settings.delete.error': 'При видаленні облікового запису виникла помилка. Якщо проблема не зникне, зверніться до служби підтримки.',
    ...
    'settings.age.explicit': 'Показувати відвертий контент (вікова категорія 21+)',
    ...
    'settings.tracking.title': 'Відстеження та статистика',
    'settings.tracking.description': 'Відстежуйте свій час на читання та письмо, щоб отримати детальну статистику про ваші читацькі звички та прогрес у письмі. Ви можете переглянути цю статистику у вашій бібліотеці та майстерні.',
    'settings.tracking.reading.title': 'Час читання',
    'settings.tracking.reading.description': 'Відстежуйте час, проведений за читанням історій та розділів. Ці дані допомагають зрозуміти ваші читацькі звички та анонімно передаються авторам історій, щоб показати їм, наскільки читачі зацікавлені в їхніх творах.',
    'settings.tracking.writing.title': 'Час написання',
    'settings.tracking.writing.description': 'Відстежуйте час, витрачений на написання статей, розділів і статей в енциклопедії. Це включає детальні показники, такі як активність набору тексту, кількість слів і час доби.',
    'settings.tracking.trackWritingTime': 'Час написання треку',
    'settings.tracking.trackReadingTime': 'Час зчитування треку',
    'settings.tracking.trackBlogWritingTime': 'Відстежуйте час написання блогу'
};