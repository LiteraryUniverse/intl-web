...
export default {
  ...
  'flashnews.onlyDisplayOn':
    'Haberler sadece aşağıda seçilen dillerde gösterilecek (eğer herhangi bir dil seçili ise), diğer dillerde varsayılan dilde bile haber gösterilmeyecek.',
  ...
  'notification.workshopStoryStatus.toHiatus':
    'Hikayeniz {storyName} hareketsizlik nedeniyle otomatik olarak ara verildi.',
  'notification.workshopStoryStatus.toCancelled':
    'Hikayeniz {storyName} bir yıllık hareketsizlikten sonra otomatik olarak iptal edildi.',
