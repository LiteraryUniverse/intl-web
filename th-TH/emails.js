...
export default {
  ...
  'email.enrollAccount.messageHtml':
    'เราต้องการเชิญชวนคุณเข้าร่วมกับจักรวาลวรรณกรรม! เราได้เตรียมบัญชีส่วนตัวสำหรับคุณเองไว้แล้ว เพื่อให้คุณสามารถเข้าถึงคุณสมบัติทั้งหมดของจักรวาลวรรณกรรมได้! โปรดร่วมกับเราในการสร้างเครื่องมือเขียนและอ่านเจนเนอเรชันต่อไป!',
  ...
  'email.resetPassword.messageHtml':
    'เราได้รับคำขอการรีเซ็ตรหัสผ่านสำหรับบัญชีของคุณ โปรดคลิกที่ปุ่มด้านล่างเพื่อดำเนินการต่อ หากคุณไม่ได้ทำคำขอนี้ คุณสามารถเพิกเฉยต่ออีเมลนี้ได้ แต่นี่อาจเป็นเวลาที่ดีในการตรวจสอบการตั้งค่าความปลอดภัยของคุณ',
