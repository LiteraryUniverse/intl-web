export default {
  'genre.scifi': 'વિજ્ઞાન કથાસાહિત્ય',
  'genre.fantasy': 'કાલ્પનિક',
  'genre.adventure': 'આવાજણી',
  'genre.poetry': 'કવિતા',
  'genre.comedy': 'કૉમેડી',
  'genre.drama': 'નાટક',
  'genre.nonfiction': 'અસત્ય',
  'genre.fiction': 'કથાસાહિત્ય',
  'genre.romance': 'રોમાંચ',
  'genre.satire': 'વ્યંગ્ય',
  'genre.tragedy': 'દુઃખદ્રાવ્ય',
  'genre.crime': 'Crime',
  'genre.historical': 'ઐતિહાસિક કથાસાહિત્ય',
  'genre.horror': 'ભયાનક',
  'genre.mystery': 'રહસ્ય',
  'genre.thriller': 'થ્રિલર',
  'genre.western': 'પશ્ચિમ',
  'genre.memoir': 'જીવનચરિત્ર',
  'genre.biography': 'જીવનવૃત્તાંત',
  'genre.steampunk': 'સ્ટીમપંક',
  'genre.mythology': 'પુરાણો',
  'genre.fairytale': 'માનવી કથા',
  'genre.superhero': 'સુપરહીરો',
  ...
  'genre.fantasy.description':
    'આધ્યાત્મિક વિશ્વો માં માયાવી ક્રિયાઓ, અસ્તિત્વ વિષયક ઘટનાઓ અને પૌરાણિક પ્રાણીઓની ઘણી વસ્તુઓને શામેલ કરતી લિટરરી જાત છે, જે માનવિક વિશ્વો માં સ્થાન મેળવે છે. તેમાં યોધાઓ, સારી અને બુરી વચ્ચેની લડાઇઓ, અને બાળકોની વયસ્કતા વારસી વાર્તાઓ શામેલ થાય છે. આધ્યાત્મિક વિશ્વ ઉચ્ચ આધ્યાત્મિક, શહેરી આધ્યાત્મિક, કૃષ્ણ આધ્યાત્મિક અને પરીકથાઓ વગેરે જેવી ઉપ-જાતિઓમાં વહેંચવામાં આવે છે. તે સામાજિક અને નૈતિકતાના વિષયોને શામેલ કરે છે, જે સારી અને બુરીની પ્રકૃતિને અન્વેષણ કરે છે.',
  ...
  'genre.isekai.description':
    'આ જાપાની લાઇટ નોવેલ, મંગા અને એનીમે ની આ ઉપ-જાતિ એક વ્યક્તિનું એક અલગ વિશ્વ અથવા વૈકલ્પિક વિશ્વમાં સ્થાનાંતરિત થવાનું જ વિષય છે. પ્રોટેગોનિસ્ટ નવી દુનિયાના અનોખા સંસ્કૃતિઓ અને વાતાવરણમાં સંચરણ કરીને અનુકૂળતા કરવી અને અકસ્માત પરિજનો અને શત્રુઓને સામે લેવાનું પ્રયાસ કરવું પડે છે. આ વાર્તાઓ હંમેશા હાસ્યપૂર્ણ અને કૉમેડીની હોઈ શકે છે કે કાળી અને તીવ્ર હોઈ શકે છે, પરંતુ હંમેશા ક્લાસિક એડવેન્ચર થીમ્સ પર તાજગીની અને કલ્પનાશીલ લેવામાં આવે છે.',
}
