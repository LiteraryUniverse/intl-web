...
export default {
  ...
  'flashnews.onlyDisplayOn':
    'Nyheden vises kun på de valgte sprog nedenfor (hvis nogen er valgt), der vil ikke vises nogen nyheder, selv på standardsproget, på andre sprog.',
  ...
  'notification.workshopStoryStatus.toHiatus':
    'Din historie {storyName} er automatisk blevet sat på pause efter 6 måneders inaktivitet.',
  'notification.workshopStoryStatus.toCancelled':
    'Din historie {storyName} er automatisk blevet afbrudt efter et års inaktivitet.',
