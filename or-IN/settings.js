export default {
  ...
  'settings.languages.notice':
    'ଇଂରାଜୀ ଏବଂ ଚେକ୍ ବର୍ତମାନରେ ଏକମାତ୍ର ସମର୍ଥିତ ଭାଷାଗୁଡ଼ିକ । ଅନ୍ୟ ଭାଷାଗୁଡ଼ିକ ଅଦ୍ୟାଯାବଧାନରେ ଉପସ୍ଥିତ ଅଟେ । ଅଦ୍ୟାୟାବଧାନରେ ଉପସ୍ଥିତ ଭାଷାଗୁଡ଼ିକ ଅପୂର୍ଣାଙ୍କରେ ଏବଂ କୌଣସି ଜାଗାରେ ଭୁଲ ଥାଏ ।',
  ...
  'settings.web3.verify.explained':
    'ଏହି ଠିକଣା ଆପଣଙ୍କୁ ପାଇଁ ସତ୍ୟାପିତ କରିବାକୁ ଆମେ ଆପଣଙ୍କୁ ଏକ ସନ୍ଦେଶ ଲିଖିବାରେ ଆମେ ଆପଣଙ୍କର ମାଲିକାନାରେ ଆପଣଙ୍କର ସମର୍ପଣକୁ ନିଶ୍ଚିତ କରିବାରେ ଆପଣଙ୍କୁ ପଡିବା ପଡିବା ପାରିବେ |',
  'settings.web3.verified': 'ସତ୍ୟାପିତ',
  'settings.web3.verificationMessage':
    'ଲିଟେରରୀ ଇୟୁନିଭର୍ସ ପାଇବାରେ ବ୍ୟବହାରକାରୀ {username} ଯାଞ୍ଚିତ କରାଯାଇଛି | କୋଡ: {code}',
  ...
  'settings.web3.linkError':
    'ଏହି ଠିକଣା ଆଗରୁ ଆମର ଡାଟାବେସରେ ରେଖାଯାଇଛି ଏବଂ ଏହି କାରଣରେ ଏହି ଠିକଣା ନିର୍ଧାରଣ କରିବାକୁ ପାରିବେ ନାହିଁ |',
  // Reader settings
