export default {
  ...
  'homepage.explanation':
    'გსურთ თქვენც ადრევით გამოიწეროთ ფანტასტიური მსგავსი მსოფლიო, რომელშიც თქვენც გადახადებთ გაკვეთილს? ლიტერატურულ უნივერსუმზე, ჩვენ გთავაზობთ ინსტრუმენტებს ამ ვიზიის რეალობის გახსნაზე. ყველა მწერალს უნდა ჰქონდეს წვდომა უმაღლეს რესურსებზე და მხიარული მხიარული. ამიტომაც ჩვენ დიზაინებული ვართ ყველაფერს ერთ სივრცეში, რომელიც აგდებს კომპლექსურ მოთხრობას და განხილვას. მწერალებისთვის, ეს არის სიზარმარის სამუშაო ადგილი; წიგნებისათვის, გამოცდილების ოდისება გადაგვეხმარება. შემოგვიერთდით, როგორც ჩვენ გვამბერავენ ლიტერატურულ კანონების სამყაროში, და გადაგვიხმარება რამდენად შემდეგი გზა გვაძლევს გამოცდილებაში.',
  ...
  'gdpr.processing.desc':
    'ლიტერატურული უნივერსუმი სრულად დართულია ბრაუზერის პარამეტრების მიხედვით, მაგალითად "არ გამოაქვს მონაცემები" მოთხოვნებისთვის ჩვენი Matomo სტატისტიკის სერვერზე.',
  ...
  'about.attributionsIntro':
    'ლიტერატურული უნივერსუმი მრავალი ღია კოდის პროექტზე და უფასო რესურსის ბაზაზე დაყენებულია. ქვემოთ იხილეთ მათი სია.',
  'about.attributionsMatomo':
    'ჩვენი ანალიტიკა გამოიყენებს საკუთარ ჰოსტში მდებარე Matomo-ს და IP2Location LITE მონაცემებს, რომლებიც ხელმისაწვდომია https://lite.ip2location.com მისამართზე.',
