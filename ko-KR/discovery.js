export default {
    ...
    'story.estimatedReadingTime': `이 이야기는 읽는 데 {hours, plural,
        =0 {}
        one {1시간과 }
        other {#시간 }
    }{minutes, plural,
    ...
    'discover.search.resultsTotal.universe': `{results, plural,
        ...
        one {1개의 우주가 발견되었습니다}
        other {#개의 우주가 발견되었습니다}
    }.`,
    'discover.search.resultsTotal.story': `{results, plural,
        =0 {매개변수와 일치하는 이야기가 없습니다}
        one {1개의 이야기가 발견되었습니다}
        other {#개의 이야기가 발견되었습니다}
    }.`,
    ...
    'discovery.story.tableOfContent': '목차',
    'story.status.hiatus': '휴지 상태',
    'story.status.cancelled': '취소됨',
    'story.chapter.wasRead': '읽음 - {readAt, date}',
    'discovery.moreDetails': '추가 세부 정보',
    'discovery.read': '읽기',
    ...
    'discovery.ai.noUniverses': '아직 AI가 생성한 유니버스는 없습니다.',
    'discovery.ai.noStories': '아직 AI가 생성한 스토리는 제공되지 않습니다.',
