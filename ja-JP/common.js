...
export default {
  ...
  'site.description':
    'Literary Universeは、壮大な文学の世界をオールインワン・プラットフォームで制作・出版します。',
  ...
  'common.accessdenied.msg':
    'アクセスが拒否されました。アクセス権がある場合は、設定の再確認を管理者に問い合わせてください。',
  ...
  'common.futurefeature.text':
    '大変申し訳ありませんが、この機能は現在のところご利用できません。できるだけ早くご利用できるように取り組んでおります。',
  ...
  'common.legal.newVersionAvailable':
    'この文書の新バージョン（{newVersion}）は、{effectiveAt, date}に有効になります。',
  'common.legal.disclaimer': '© {year} すべての文章の著作権は、それぞれの著者に帰属します。',
  'premium.only.title': '会員ランクが十分ではありません',
  'premium.only.msg':
    '申し訳ありませんが、あなたの会員ランクはこの機能を利用するには十分ではありません。',
  'premium.only.join':
    '皆様がLiteracy Universeを最大限活用していただくために、様々なプランをご用意しています。',
  ...
  // for beta only
  'beta.notice':
    'Literary Universe BETAへようこそ。これはパブリックプレビューであり、アプリはまだ進行中です。そのため、エラーや未完成の機能があることが予想されます。エラーや機能しないものがありましたら、ぜひお知らせください。また、すべての機能が整うまでお待ちください。',
  ...
  'errorLoading.explained':
    'ページの読み込み中にエラーが発生しました。ご不便をおかけして申し訳ありません。お手数ですが、もう一度ページにアクセスしてみてください。それでも問題が解決しない場合は、お手数ですがご連絡ください。',
  ...
  goodbyeForever:
    '退会されるのは残念です。こちらで何かご不便なことがありましたでしょうか？ご教示いただけますと幸いです。いずれにしても、今後の活躍をお祈りするとともに、またお会いできることを願っています。今後のさらなるご発展を願いつつ。',
  ...
  'signin.web3.signMessage':
    '認証方法としてウォレットでLiterary Universeにアクセスすることを確認してください。コード：{code}',
  ...
  create: '作成する',
  'banner.support':
    'Literary Universeは、あなたのようなユーザーによって支えられています！Literary Universeのイベントをより良いものにするために、ぜひ購読をご検討ください！',
  ...
  'console.explain':
    'これは開発者向けのブラウザ機能です。もし誰かがあなたに文学の宇宙の機能を有効にするために何かをここにコピー＆ペーストするように言ったり、誰かのアカウントを"ハック"するためにそうするように言ったりした場合、それは詐欺であり、文学の宇宙のアカウントへのアクセスを提供します。',
  'common.coping': 'コピー中...',
