export default {
  ...
  'workshop.universe.publishing.notice':
    'Ak vesmír nezverejníte, bude zverejnený automaticky po zverejnení prvého príbehu spojeného s týmto vesmírom.',
  'workshop.universe.settings': 'Nastavenia vesmíru {universe}',
  'workshop.universe.publishedOn':
    'Tento vesmír bol publikovaný {date, date, long} {date, time, short}',
  ...
  'workshop.universe.rating.desc':
    'Príbehy a fanfiction nad týmto hodnotením budú skryté z výpisu stránky vesmíru pre anonymných používateľov a používateľov, ktorí nemajú príslušný vek.',
  ...
  'workshop.story.cannon.desc.create':
    'Tento príbeh bude vytvorený ako kanonický príbeh vo vesmíre {universe}.',
  'workshop.story.fanfiction.search':
    'Zadajte názov vesmíru (musí byť vo vašej knižnici). A potom vyberte z návrhov.',
  ...
  'workshop.story.error.fanfiction.selectuniverse':
    'Pre svoju fanfiction si musíte vybrať originálny vesmír!',
  ...
  'workshop.story.publishing.notice':
    'Príbeh sa zverejní automaticky po uverejnení prvej kapitoly.',
  'workshop.settings.edit': 'Upraviť nastavenia',
  'workshop.story.publishedOn':
    'Tento príbeh bol uverejnený dňa {date, date, long} {date, time, short}',
  ...
  'workshop.translation.updatedOrig':
    'Posledná aktualizácia originálu: {updatedAt, date, long} {updatedAt, time, medium}',
  'workshop.translation.updatedTrs':
    'Posledná aktualizácia prekladu: {updatedAt, date, long} {updatedAt, time, medium}',
  'workshop.translation.revisionOrig':
    'Posledná revízia {revision, number}, originálu: {updatedAt, date, long} {updatedAt, time, medium}',
  'workshop.translation.revisionTrs':
    'Posledná revízia {revision, number}, prekladu: {updatedAt, date, long} {updatedAt, time, medium}',
  ...
  'workshop.fanfic.needUniverseInLibrary':
    'Existuje mnoho vesmírov. Tie, do ktorých chcete písať, si najprv pridajte do svojej knižnice, aby sme ich mohli nájsť.',
  ...
  'workshop.beta.revisionInfo':
    'Toto je revízia {revision, number}, vytvorená dňa {createdAt, date, long}.',
  ...
  'workshop.translation.premium':
    'Aby ste mohli pridávať preklady, musíte mať aspoň predplatné Prieskumník.',
  'workshop.story.finished': 'Príbeh je dokončený',
  'workshop.story.publishing.externalSellingNotice':
    'Keďže predávate mimo Literary Universe, môžete príbeh publikovať už teraz. Odkazy na zoznam vášho obchodu sa objavia na poviedke alebo na konci aktuálnej poviedky, ktorú tu uverejníte.',
  ...
  'workshop.fictionalTime.linkedToET':
    'Začína tento čas pozemským dátumom (gregoriánsky kalendár)?',
  ...
  'workshop.shoppingExternal.explainer':
    'Ak sa váš príbeh predáva inde, môžete tu nastaviť odkazy. Odkazy sa potom zobrazia namiesto obsahu alebo na konci obsahu, ktorý ste si vybrali na náhľad.',
  ...
  'workshop.writerSidebar.description':
    'Vitajte vo svojom príbehu! Tento bočný panel vám umožňuje jednoduchý prístup ku všetkým zdrojom súvisiacim s vaším príbehom. Pozrite si ikony vyššie, aby ste videli najnovšie komentáre, svoje poznámky a mnoho ďalšieho!',
  ...
  'workshop.ratingAdjusted':
    'Kvôli sťažnostiam sme museli upraviť vaše hodnotenie na také, ktoré sme považovali za primerané. Zmena hodnotenia je preto teraz zakázaná.',
  ...
  'workshop.universe.isAIGeneratedTooltip':
    'Dajte nám vedieť, či bol niektorý obsah vo vesmíre vytvorený umelou inteligenciou alebo s jej pomocou. Tieto informácie používame na správne označenie a vzhľadom na spôsob generovania programov AI môžu existovať určité obmedzenia.',
  'workshop.story.isAIGenerated': 'Je príbeh generovaný umelou inteligenciou?',
  'workshop.story.isAIGeneratedTooltip':
    'Dajte nám vedieť, či bol niektorý z príbehov vytvorený umelou inteligenciou alebo s jej pomocou. Tieto informácie používame na správne označenie a vzhľadom na spôsob generovania programov AI môžu existovať určité obmedzenia.',
  'workshop.publicationAgreement.aria': 'Zmluva o zverejnení diela',
  'workshop.publicationAgreement.intro':
    'Sme radi, že ste sa rozhodli uverejniť svoju tvorbu u nás. Predtým, ako budeme pokračovať, potrebujeme, aby ste si prečítali našu zmluvu o publikovaní, aby ste pochopili, čo to znamená po právnej stránke.',
  ...
  'workshop.statusExplain.hiatus1':
    'Hiatus znamená, že sa na túto príbeh na určitý čas odstavíte z akéhokoľvek dôvodu. Uvätíte tým svojich čitateľov, že by nemali očakávať žiadne nové aktualizácie v nasledujúcich týždňoch alebo dokonca až pár mesiacov.',
  'workshop.statusExplain.hiatus2':
    'Ak napublikujete akékoľvek kapitoly, stav Hiatus bude automaticky zrušený. Alebo si ho môžete zmeniť sami.',
  'workshop.statusExplain.hiatus3':
    'Ak svoj príbeh v Hiatusu nebudete rozvíjať počas šiestich mesiacov, automaticky označíme tento príbeh ako zrušený.',
  'workshop.statusExplain.cancelled1':
    'Je nám ľúto, že nemôžete pokračovať v práci na príbehu. Na druhej strane sme radi, že ste ochotní dať o tom vedieť svojim čitateľom.',
  'workshop.statusExplain.cancelled2':
    'Zrušenie príbehu oznámi vašim čitateľom, že nemajú očakávať žiadne nové aktualizácie.',
  'workshop.statusExplain.cancelled3':
    'Vždy môžete vrátiť späť tým, že publikujete kapitolu alebo zmeníte stav.',
  'workshop.statusExplain.finished1':
    'Blahoželáme! Po celej tej tvrdej práci si konečne dosiahol koniec neuvěřitelné cesty. Aj keď sa príbeh teraz končí, dúfame, že v budúcnosti budú ďalšie príbehy, ale teraz si oddýchni a uži si zaslúžený odpočinok.',
  'workshop.statusExplain.finished2':
    'Označenie príbehu ako ukončeného povie čitateľom, že príbeh je dokončený. Aj keď by ste nemali pridávať žiadne nové kapitoly, my vás nezastavujeme a pridanie špeciálnych kapitol nie je zlý nápad, napríklad pridať viac epilógov pre všetky postavy.',
  'workshop.statusExplain.finished3':
    'Hoci môžete vždy zrušiť tento stav, silne odporúčame to nedelať. Ak má byť príbeh pokračovať, možno by bolo lepšie začať nový príbeh.',
  ...
  'workshop.statusChangeEmail.hiatusTitle':
    'Stav vášho príbehu bol automaticky nastavený na hiatus',
  'workshop.statusChangeEmail.hiatusIntro':
    'Vzhľadom na nečinnosť bol stav vášho príbehu automaticky nastavený na hiatus.',
  'workshop.statusChangeEmail.hiatusWhy':
    'Bol automaticky prerušený kvôli absencii nového kapitoly viac ako 6 mesiacov.',
  'workshop.statusChangeEmail.hiatusWhatFollows':
    'Tento stav sa automaticky zruší, ak vydáte novú kapitolu. Ak v nasledujúcich 6 mesiacoch nevydáte novú kapitolu, príbeh automaticky označíme ako zrušený.',
  'workshop.statusChangeEmail.cancellationIntro':
    'Stav vášho príbehu bol automaticky nastavený na zrušený.',
  'workshop.statusChangeEmail.cancellationWhy':
    'K tomu došlo, pretože od doby, keď bola príbehu nastavená prestávka pred 6 mesiacmi, ste nezverejnili žiadne nové kapitoly. Po roku neaktivity automaticky nastavujeme príbehy ako zrušené, aby si čitatelia mohli uvedomiť, ktoré príbehy sú aktívne.',
  'workshop.statusChangeEmail.cancellationWhatFollows':
    'Ak vydáte novú kapitolu, tento stav sa automaticky zruší. Ak už na tomto príbehu nechcete pracovať, nemusíte robiť nič ďalšie.',
  ...
  'workshop.videoTrailer.suggestPlatforms':
    'Ak chýba vaša video platforma, dajte nám vedieť cez našu <a>spätnú väzbu</a>!',
}
