...
export default {
  ...
  'email.resetPassword.messageHtml':
    'Λάβαμε μια αίτηση για επαναφορά του κωδικού πρόσβασης για τον λογαριασμό σας, παρακαλούμε κάντε κλικ στο κουμπί παρακάτω για να συνεχίσετε τη διαδικασία. Αν δεν έχετε κάνει αυτήν την αίτηση, μπορείτε να αγνοήσετε αυτό το μήνυμα, αλλά ίσως είναι καλή ιδέα να ελέγξετε τις ρυθμίσεις ασφαλείας σας.',
  'email.resetPassword.button': 'Επαναφορά κωδικού πρόσβασης',
  // E-mail verification
  'email.verifyEmail.messageHtml':
    'Χαρούμενοι που είστε μέλος της ομάδας μας! Παρακαλούμε κάντε κλικ στο κουμπί παρακάτω για να επιβεβαιώσετε τη διεύθυνση αυτού του e-mail.',
  ...
  'email.verifying':
    'Γίνεται επαλήθευση του ηλεκτρονικού ταχυδρομείου σας. Αυτό θα πάρει μόνο ένα λεπτό...',
