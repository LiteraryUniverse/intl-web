export default {
    ...
    'stats.readingTime.title': '閱讀時間分析',
    ...
    'stats.readingHabits.profileSummaryNoPeak': '過去 {weeks, number} 週的閱讀記錄： {sessions, number} 節數， {duration} 總數。',
    ...
    'stats.writingHistory.diaryWords': '日記字句',
    // Writing history day tooltip - per-category breakdown
    'stats.writingHistory.dayTooltip.stories': '故事： {words}',
    'stats.writingHistory.dayTooltip.encyclopedia': '百科全書： {words}',
    'stats.writingHistory.dayTooltip.blog': '部落格： {words}',
    ...
    'stats.sales.product.story': '完整故事',
