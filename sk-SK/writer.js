export default {
  ...
  'writer.publish.scheduleExplained':
    'Kapitolu môžete publikovať okamžite alebo naplánovať jej sprístupnenie na neskorší dátum.',
  'writer.publish.schedule': 'Nastavenie dátumu zverejnenia',
  'writer.publish.previousChapterPublished':
    'Predchádzajúca kapitola bola uverejnená dňa {publishDate, date, short} v {publishDate, time}',
  'writer.publish.previousChapterScheduled':
    'Uverejnenie predchádzajúcej kapitoly je naplánované na {publishDate, date, short} v {publishDate, time}',
  'writer.publish.alreadyPublished':
    'Táto kapitola už bola uverejnená {publishedAt, date, short}. Nové verzie budú uverejnené okamžite.',
