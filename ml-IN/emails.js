...
export default {
  ...
  'email.resetPassword.messageHtml':
    'നിങ്ങളുടെ അക്കൗണ്ടിനായി നിങ്ങളുടെ പാസ്വേഡ് റീസെറ്റ് ചെയ്യുന്നതിന് ഒരു അഭ്യർത്ഥന ലഭിച്ചു, പ്രോസസ് തുടങ്ങുന്നതിന് ദയവായി ബട്ടൺ അമർത്തുക. ഇത് നിങ്ങൾ ഈ അഭ്യർത്ഥന ചെയ്തതല്ലേയുള്ളൂ എന്നാൽ നിങ്ങളുടെ സുരക്ഷാ ക്രമങ്ങളെ പരിശോധിക്കാൻ ഒരു നല്ല സമയമാണിത്.',
  'email.resetPassword.button': 'പാസ്വേഡ് റീസെറ്റ് ചെയ്യുക',
  // E-mail verification
  'email.verifyEmail.messageHtml':
    'നിങ്ങളെ പരിശോധിക്കാൻ ഞങ്ങൾ സന്തുഷ്ടമാണ്! ദയവായി ഈ ഇമെയിൽ വിരിയുകയാണ് ബട്ടൺ അമർത്തുക.',
