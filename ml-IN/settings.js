export default {
  ...
  'settings.languages.notice':
    'ഇംഗ്ലീഷ് ആന്റ് ചെക്ക് നിലവാരമാണ് പ്രസ്ഥാനത്തിന് പിന്നിൽ പിന്നെ പിന്തുണയ്ക്കുന്ന ഭാഷകളാണ്. മറ്റ് ഭാഷകളെ അതിന്റെ അദ്ധ്യാപകരുടെയും AI പരിഭാഷയുടെയും സഹായത്താൽ ലഭ്യമാണ്, പക്ഷേ അവ ഇനിയും പൂർണ്ണമായി അനുപൂർവ്വമായിരിക്കാനാകില്ലാത്തതാണ്.',
  ...
  'settings.web3.verify.explained':
    'ഈ വിലാസം നിങ്ങളുടെയാണെന്ന് പരിശോധിക്കുന്നതിന് ഞങ്ങൾ നിങ്ങളുടെ വാലറ്റിന്റെ ഉടമസ്ഥത ഉറപ്പിക്കുന്നതാക്കാൻ ഒരു സന്ദേശം സൈൻ ചെയ്യാൻ ഞങ്ങൾ അപേക്ഷിക്കുന്നു.',
  'settings.web3.verified': 'പരിശോധിച്ചുകൊണ്ടുള്ളു',
  'settings.web3.verificationMessage':
    'സാഹിത്യ യൂണിവേഴ്സിന് ഉപയോക്താവ് {username} പരിശോധിക്കുന്നു. കോഡ്: {code}',
  'settings.web3.unlink': 'വാലറ്റ് നീക്കംചെയ്യുക',
  'settings.web3.linkingMessage':
    'ദയവായി നിങ്ങളുടെ വാലറ്റ് സാഹിത്യ യൂണിവേഴ്സിനു ബന്ധപ്പെടുകയും എന്നതാണെന്ന് സ്ഥിരീകരിക്കുക. കോഡ്: {code}',
  'settings.web3.linkError':
    'ഈ വിലാസം ഇതിനാൽ ഞങ്ങളുടെ ഡാറ്റാബേസിൽ പട്ടികപ്പെടുത്തപ്പെടുന്നുവെന്ന് സ്ഥിരീകരിക്കപ്പെടുന്നുണ്ട്!',
  // Reader settings
