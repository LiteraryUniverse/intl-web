...
export default {
  ...
  'site.description':
    'Literary Universe - это универсальная творческая и издательская платформа для создания вселенных больших историй.',
  'site.keywords':
    'творческое письмо, научно фантастикое, научная-фантастика, фэнтези, писание, публикация, история, истории, вселенная, веб-новелла, вебновелла',
  ...
  'common.accessdenied.msg':
    'У вас нет разрешения на просмотр данного раздела. Свяжитесь с владельцем и попросите его открыть вам доступ. Если у вас должен быть доступ, то пусть владелец дважды проверит настройки.',
  ...
  'common.futurefeature.text':
    'Сожалеем, но данная функция недоступна в настоящий момент. Мы работаем над тем, чтобы сделать её доступной в ближайшее время.',
  ...
  'common.legal.newVersionAvailable':
    'Новая версия ({newVersion}) этого документа вступит в силу с {effectiveAt, date}',
  ...
  'premium.only.msg':
    'Приносим свои извинения, ваш рейтинг участника недостаточно высок, чтобы получить доступ к этой функции.',
  'premium.only.join':
    'Мы предлагаем различные планы подписки для каждого, чтобы получить максимум от Literary Universe.',
  ...
  'errorLoading.explained':
    'Произошла ошибка при загрузке страницы. Приносим свои извинения за доставленные неудобства. Повторите попытку доступа к странице ещё раз. Если проблема не исчезнет, сообщите нам об этом.',
  ...
  goodbyeForever:
    'Сожалеем, что вы уходите. Мы что-то сделали? Сообщите нам, если это так. В любом случае мы желаем вам всего наилучшего в ваших будущих начинаниях и надеемся, что мы ещё встретимся! Живи долго и процветай!',
  ...
  'signin.web3.signMessage':
    'Пожалуйста, подтвердите, что вы хотите войти в Literary Universe, используя свой кошелёк в качестве метода авторизации. Код: {code}',
  ...
  create: 'Создать',
  'banner.support':
    'Literary Universe поддерживается такими пользователями, как вы! Пожалуйста, рассмотрите возможность подписаться на один из наших планов подписки, чтобы оставаться независимыми и делать события Literary Universe лучше!',
  ...
  'console.stop': 'Стоп!',
  'console.explain':
    'Это функция браузера, предназначенная для разработчиков. Если кто-то сказал вам скопировать-вставить что-то сюда, чтобы включить какую-то функцию Literary Universe или «взломать» чью-то учётную запись, это мошенничество, и он получит доступ к вашей учётной записи Literary Universe.',
