export default {
  ...
  'feedback.report.reportSaved':
    'გმადლობთ რეპორტისთვის! ჩვენ გამოვიყენებთ დამატებითი კადრებს და გამოვაქვეყნებთ საჭირო მდგომარეობისას.',
  'feedback.report.copyrightReportSaved':
    'გმადლობთ რეპორტისთვის! ჩვენ გამოვიყენებთ დამატებითი კადრებს და დაგვიკავშირდებით.',
  'feedback.report.copyrightOwnershipDesc': 'საკოპირაიტის უფლებების მიმოხილვა',
  'feedback.report.copyrightNotice':
    'გთხოვთ გახსენით, რომ თქვენ უნდა იყოთ ნამდვილი მფლობელი საქმიანი საქმიანი მუშაობისთვის. თუ თქვენ არ ხართ მფლობელი, გთხოვთ შეატყობინოთ მფლობელს ან გამოიყენოთ სხვა კატეგორია ჩვენთვის შესახებ. ჩვენ ვიყენებთ საკოპირაიტის გაყვარებისთვის უფლებებს საუკეთესო სერიოზობით და არასასურველი და აბურდისაგან გამოყენებისთვის.',
  ...
  'faq.section.guilds': 'გილდები',
  // About us questions
  'faq.question.about.whatIsLU': 'რა არის ლიტერატურული უნივერსიტეტი?',
  ...
  'faq.answer.about.dataLocation':
    'Literary Universe მონაცემები იქნება შენახული სერვერებზე ამერიკის შეერთებულ შტატებში, სპეციფურად AWS us-east-1 რეგიონში.',
