export default {
    ...
    'about.CEO': '最高経営責任者',
    'about.CTO': '最高技術責任者',
    'about.jan': 'ジャンは、先見の明と技術的な知能を兼ね備えたLieterary Universeの創設者です。この大規模なLiterary Universeの作家であるジャンは、読書体験を損なわずに物語を書くことは技術面でも読み手の側からみても難しいといつも感じていました。そこで、ジャンは、大規模な宇宙で物語を簡単に書けるようになるアプリケーションを作るべくウェブ開発の勉強をすることを決めました。',
    'about.history.text': '2010年にロチェスター工科大学に入学したジャンは、クリエイティブライティングのサイトを構築するために、ウェブ開発についてより深く学ぶことにしました。2013年には、Imagine RITで最初の概念実証を行いました。ジャンはその後も勉強を続け、2016年には修士課程のキャップストーン・プロジェクトとしてアプリの新バージョンを作成しました。このプロジェクトは2016年秋にも続けられ、今日のような形へと進化しました。',
