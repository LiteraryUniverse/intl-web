...
export default {
  ...
  'flashnews.onlyDisplayOn':
    'החדשות יתווספו רק בשפה הנבחרת למטה (אם נבחרו), לא יוצגו חדישות באף שפה אחרת, גם לא בשפת ברירת המחדל.',
  ...
  'notification.workshopStoryStatus.toHiatus':
    'הסיפור שלך {storyName} הוכרז כנעול אוטומטית לאחר 6 חודשים של חוסר פעילות.',
  'notification.workshopStoryStatus.toCancelled':
    'הסיפור שלך {storyName} הוכרז כבוטל אוטומטית לאחר שנה של חוסר פעילות.',
