...
export default {
  ...
  'email.enrollAccount.messageHtml':
    'Mes norėtume pakviesti jus į Literatūrinę Visatą! Mes jau sukūrėme jums asmeninę paskyrą, kurioje galėsite pasiekti visus Literatūrinės Visatos funkcionalumus! Prašome prisijungti prie mūsų kuriant ateities kūrybinės rašymo ir skaitymo įrankius!',
  ...
  'email.resetPassword.messageHtml':
    'Mes gavome prašymą atkurti Jūsų slaptažodį Jūsų paskyrai, prašome paspausti žemiau esantį mygtuką, kad tęstumėte procesą. Jei Jūs nesate padaręs šio prašymo, galite ignoruoti šį el. laišką, tačiau tai gali būti geras laikas peržiūrėti saugumo nustatymus.',
  'email.resetPassword.button': 'Atkurti slaptažodį',
  // E-mail verification
  'email.verifyEmail.messageHtml':
    'Džiaugiamės, kad Jūs prisijungėte! Prašome paspausti žemiau esantį mygtuką, kad patvirtintumėte šį el. pašto adresą.',
