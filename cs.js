...
export default {
  ...
  'plans.account.visitor.desc': 'Vstupní účet na vyzkoušení.',
  'plans.account.explorer': 'Průzkumník',
  'plans.account.explorer.desc': 'Pro kutily a přátele.',
  'plans.account.initiate': 'Zasvědcený',
  'plans.account.initiate.desc': 'Pro začínající spisovatele.',
  'plans.account.adventurer': 'Dobroduh',
  'plans.account.adventurer.desc': 'Pro dedikované tvůrce a podporovatele.',
  'plans.account.storyteller': 'Vypravěč',
  'plans.account.storyteller.desc': 'Pro profesionální tvůrce.',
  ...
  'plans.feature.blog': 'Osobní & universe blogs',
