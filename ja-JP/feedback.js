export default {
    ...
    'feedback.bugs': '問題点',
    'feedback.bugs.desc': 'エラーや、間違い、何か困ったことがありましたか？。 こちらにご連絡ください。',
    'feedback.features': 'アイデアと提案事項',
    'feedback.features.desc': '新機能やサイトを改善する方法についてのアイデアがあれば、ご教示ください。',
    'feedback.help': 'ヘルプ・操作解説',
    'feedback.help.desc': 'ごきげんよう_____？ 回答はこちらに進んでください。',
    'feedback.desc': 'ヘルプ＆問題解決サポートセンターへようこそ！',
    'feedback.open': '開いた',
    'feedback.closed': '閉館',
    ...
    'feedback.lang.nosupport': '申し訳ありませんが、ご使用の言語ではフィードバックがサポートされていませんので、恐れ入りますが英語でご記入ください。よろしくお願いします。',
    'feedback.new.thanks': 'ご連絡ありがとうございます！ すぐに調べます。',
