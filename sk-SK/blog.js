export default {
  ...
  'blog.theme': 'Téma',
  'blog.theme.info':
    'Úpravou témy budete môcť zmeniť vzhľad stránky. Táto funkcia nie je v súčasnosti pripravená.',
  ...
  'blog.slug.explained':
    'Pekne vyzerajúce url na príspevok. Vyhnite sa používaniu špeciálnych znakov okrem "-".',
  ...
  'blog.settings.universeSettings':
    'Blogy vesmíru sú integrované do stránok vesmíru a ich základné nastavenia sú prevzaté z nastavení vesmíru.',
