...
export default {
    ...
    'story.includeUniverse': 'Inclure l\'univers dans le titre',
    'story.genre': 'Genre',
    'story.genres': 'Genres',
    'story.read': 'Lire',
    'story.lastUpdate': 'Dernière mise à jour le {date, date, medium} {date, time, short}.',
    'story.finishedAt': 'Terminé le {date, date, medium}.',
    'story.hiatusAt': 'En pause depuis {date, date, medium}.',
    'story.cancelledAt': 'Annulé le {date, date, medium}.',
    ...
    'error.oops': 'Oups ! Quelque chose s\'est gravement mal passé !',
    'error.apologies': 'Nous nous excusons pour ce désagrément et nous ferons de notre mieux pour y remédier rapidement.',
    'error.400.text': 'Erreur 400 : {errorMessage}',
    ...
    'common.swUpdate.ready.title': 'Mise à jour prête',
    'common.swUpdate.ready.description': 'Une nouvelle version est prête. Vous pouvez l\'appliquer dès maintenant.',
    'common.swUpdate.ready.writerDescription': 'Une nouvelle version est prête. Appliquez-la lorsque vous aurez terminé vos travaux de rédaction en cours.',
    'common.swUpdate.apply': 'Mise à jour',
    ...
    'errorLoading.explained': 'Une erreur s\'est produite pendant le chargement de la page. Nous vous prions de nous excuser pour ce désagrément. Veuillez réessayer d\'accéder à la page. Si le problème persiste, veuillez nous en informer.',
    ...
    goodbyeForever: 'Nous sommes désolés de vous voir partir. Est-ce que c\'est quelque chose que nous avons fait ? N\'hésitez pas à nous le faire savoir. Quoi qu\'il en soit, nous vous souhaitons le meilleur dans vos projets futurs et espérons que nous nous reverrons ! Longue vie et prospérité !',
    ...
    'common.publishNow': 'Publier maintenant',
    'common.publishLater': 'Publier plus tard',
    ...
    'story.notes.audienceAgeGroup': 'Groupe d\'âge du public cible',
    'story.notes.audienceSex': 'Public cible : sexe',
    ...
    'common.done': 'Terminé',
    'contentSelector.noSelection': 'Aucun élément sélectionné',
    'contentSelector.selectedItems': 'Articles sélectionnés',
    'contentSelector.entireSite': 'Site de recherche',
    'contentSelector.tabsLabel': 'Options de recherche',
    'contentSelector.title': 'Sélectionnez le contenu',
    ...
    create: 'Créer',
    'banner.support': 'L\'Univers littéraire est rendu possible grâce au soutien d\'utilisateurs comme vous. Pour nous aider à rester indépendants et à améliorer la plateforme, veuillez envisager de souscrire à l\'un de nos plans.',
    'banner.seePlans': 'Visitez notre page sur les plans pour plus d\'informations.',
    ...
    'common.oldest': 'Le plus ancien',
    'common.noSelection': 'Pas de sélection',
    'common.content': 'Contenu',
    'common.theWayOfTheAuthor': 'La voie de l\'auteur',
    ...
    'actions.sendToKindle': 'Envoyer à Kindle',
    ...
    'common.words': 'mots',
    'common.quickSummary': 'Résumé rapide',
    'common.creating': 'Créer...',
    // Invitation landing page
    'invitation.page.title': 'Invitation',
    'invitation.title': 'Vous êtes invités !',
    'invitation.detail.invitedBy': 'Invité par',
    'invitation.detail.to': 'Pour adhérer',
    'invitation.detail.role': 'Rôle',
    'invitation.role.member': 'Membre',
    'invitation.role.collaborator': 'Collaborateur',
    'invitation.role.translator': 'Traducteur',
    'invitation.role.beta': 'Lecteur bêta',
    'invitation.objectType.organization': 'l\'organisation',
    'invitation.objectType.story': 'histoire',
    'invitation.objectType.universe': 'univers',
    'invitation.accept': 'Accepter l\'invitation',
    'invitation.accepting': 'Accepter...',
    'invitation.decline': 'Déclin',
    'invitation.loginRequired': 'Veuillez vous connecter ou créer un compte pour répondre à cette invitation.',
    'invitation.haveAccount': 'J\'ai un compte',
    'invitation.newHere': 'Je suis nouveau ici',
    'invitation.registerPrompt': 'Créez un compte gratuit pour accepter cette invitation.',
    'invitation.register': 'Créer un compte',
    'invitation.goToDashboard': 'Accéder au tableau de bord',
    'invitation.alreadyAccepted.title': 'Invitation déjà acceptée',
    'invitation.alreadyAccepted.message': 'Cette invitation a déjà été acceptée.',
    'invitation.alreadyDeclined.title': 'Invitation refusée',
    'invitation.alreadyDeclined.message': 'Cette invitation a été déclinée.',
    'invitation.declined.title': 'Invitation refusée',
    'invitation.declined.message': 'Vous avez décliné l\'invitation.',
    'invitation.cancelled.title': 'Invitation annulée',
    'invitation.cancelled.message': 'Cette invitation a été annulée par l\'expéditeur.',
