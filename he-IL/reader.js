export default {
  ...
  'reader.externalSale.description':
    'סיפור זה אינו זמין ב־Literary Universe, אבל ניתן למצוא אותו במקומות אחרים.',
  ...
  'reader.nextRelease.scheduled':
    'הפרק הבא יגיע ב־ {nextReleaseAt, date} ב־ {nextReleaseAt, time}!',
  'reader.storyContinues': 'הסיפור ממשיך...',
  'reader.storyOnHiatus':
    'הסופר כרגע לוקח הפסקה מהסיפור הזה והסיפור הזה בפועל בהשהייה עכשיו. מומלץ לחזור עוד חודש או שניים.',
  'reader.storyCancelled':
    'לצערנו זהו הסוף. הסיפור בוטל אז כנראה שאין יכולת לצפות יותר לשום דבר חדש.',
  ...
  'reader.nextChapterEstimation.notEnoughChapters':
    'אנו נספק ערך משוער לכאשר הפרק הבא עשוי להתפרסם כאשר יהיה לסיפור זה יותר מפרק אחד.',
}
