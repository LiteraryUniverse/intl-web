...
export default {
  ...
  'email.resetPassword.messageHtml':
    'మీ ఖాతాకు మీ పాస్వర్డ్ రీసెట్ చేయడానికి మేము ఒక అభ్యర్థన పొందాము, దయచేసి ప్రారంభించే ప్రాసెస్ కొరకు క్రింది బటన్‌ను క్లిక్ చేయండి. మీరు ఈ అభ్యర్థన చేసినట్లయితే, మీరు ఈ ఇమెయిల్‌ని నిరాకరించగలరు, కానీ మీ భద్రతా సెట్టింగ్‌లను సవిశేషంగా సమీక్షించడం ఒక మంచి సమయంలో ఉంటుంది.',
  'email.resetPassword.button': 'పాస్వర్డ్ రీసెట్ చేయండి',
  // E-mail verification
  'email.verifyEmail.messageHtml':
    'మనం మీకు గుండెలో ఉండటం సంతోషంగా ఉంది! దయచేసి ఈ ఇమెయిల్ చిరునామాను ధృవీకరించే క్రింది బటన్‌ను క్లిక్ చేయండి.',
