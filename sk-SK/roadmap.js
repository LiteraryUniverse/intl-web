export default {
  'roadmap.meta.description': 'Plány na rozvoj Literárneho vesmíru.',
  'roadmap.ariaTimeOptions': 'Výbery položiek plánu na základe ich stavu.',
  'roadmap.state.backlog': 'Backlog',
  'roadmap.state.inprogress': 'Rozpracovaný',
  'roadmap.state.preview': 'Náhľad',
  'roadmap.state.beta': 'Beta',
  'roadmap.state.ga': 'Všeobecná dostupnosť',
  'roadmap.eta.q1.short': 'Š1',
  'roadmap.eta.q2.short': 'Š2',
  'roadmap.eta.q3.short': 'Š3',
  'roadmap.eta.q4.short': 'Š4',
  'roadmap.eta.q1.long': 'Prvý štvrťrok',
  'roadmap.eta.q2.long': 'Druhý štvrťrok',
  'roadmap.eta.q3.long': 'Tretí štvrťrok',
  'roadmap.eta.q4.long': 'Štvrtý štvrťrok',
  'roadmap.backlog': 'Backlog',
  'roadmap.history': 'História vývoja',
