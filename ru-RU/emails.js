...
export default {
    ...
    'email.enrollAccount.messageHtml': 'Мы хотели бы пригласить Вас в Литературную Вселенную! Мы подготовили для Вас персональный аккаунт, где Вы сможете получить доступ ко всем возможностям Литературной Вселенной. Пожалуйста, присоединяйтесь к нам в создании нового поколения творческого письма и чтения!',
    'email.enrollAccount.button': 'Перейти к учётной записи',
    'email.enrollAccount.signature': 'Мы с нетерпением ждем встречи с Вами, команда<br />Literary Universe.',
    // Reset password
    'email.resetPassword.messageHtml': 'Мы получили запрос на сброс пароля для Вашей учетной записи. Пожалуйста, нажмите на кнопку ниже, чтобы продолжить процесс. Если Вы не делали этого запроса, Вы можете проигнорировать это письмо, но, возможно, сейчас самое время пересмотреть настройки безопасности.',
    'email.resetPassword.button': 'Сбросить пароль',
    // E-mail verification
    'email.verifyEmail.messageHtml': 'Мы рады видеть Вас на борту! Пожалуйста, нажмите на кнопку ниже, чтобы проверить этот адрес электронной почты.',
