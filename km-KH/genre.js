export default {
  'genre.scifi': 'រឿងអប់រំសារពិភពលោក',
  'genre.fantasy': 'រឿងអប់រំហេតុ',
  'genre.adventure': 'រឿងជីវប្រចាំថ្ងៃ',
  'genre.poetry': 'ការសរសេរពិភពលោក',
  'genre.comedy': 'រឿងកំប្លែង',
  'genre.drama': 'រឿងដ្រាម៉ា',
  'genre.nonfiction': 'ការសរសេរអន្តរសក្ខណ៍',
  'genre.fiction': 'រឿងដំណើរការ',
  'genre.romance': 'រឿងស្នេហ៍',
  'genre.satire': 'រឿងប្រពៃណី',
  'genre.tragedy': 'រឿងអំពីសុខភាព',
  'genre.crime': 'Crime',
  'genre.historical': 'រឿងប្រវត្តិប្រដាល់ប្រវែង',
  'genre.horror': 'រឿងព្រឹក',
  'genre.mystery': 'រឿងសំណួរ',
  'genre.thriller': 'រឿងអំពីការឆ្លើយតប',
  'genre.western': 'រឿងអាប់រំស្តង់',
  'genre.memoir': 'រឿងអលង្ការសិទ្ធិ',
  'genre.biography': 'ជីវប្រវត្តិ',
  'genre.steampunk': 'រឿងស្ទេពប៉ូនក',
  'genre.mythology': 'រឿងអន្តរសក្ខណ៍',
  'genre.fairytale': 'រឿងព្រីររាជ',
  'genre.superhero': 'រឿងអ្នកប្រើប្រាស់សង្គ្រោះ',
  ...
  'genre.fantasy.description':
    'ប្រភេទរឿងដែលមានប្រភេទនៃប៉ាវីតស្ថានភាព ព្រមទាំងប្រភេទនៃការបំបាត់ ព្រមទាំងការការពន្យល់ស្ថានភាពស្រី និងបង្អែមនៅក្នុងពិភពលោកដែលគឺជាពិភពដែលមានទម្រង់នៃរដ្ឋមន្ត្រីនិងសត្វចិត្តនៅក្នុងពិភពលោកផ្សេងៗ។ វាអាចបង្ហាញពីបំបែកនៃការប្រមូលផ្លូវរបស់ការពិសេស ការប្រមូលផ្លូវរបស់ការប្រឆាំង ការប្រមូលផ្លូវរបស់ការប្រើប្រាស់និងការប្រឆាំងនៅក្នុងពិភពលោកផ្សេងៗ។ វាសម្រាប់ពិភពលោកដែលមានស្រាប់រឿងលោកចង្វាក់ ស្រាប់រឿងមានចង្វាក់ខ្លាំង ស្រាប់រឿងមានចង្វាក់ស្រស់ និងរឿងមានចង្វាក់ពិសេស នៅក្នុងពិភពលោកផ្សេងៗ។ វាសម្រាប់ពិភពលោកដែលមានការពន្យល់ស្ថានភាពនិងស្ថានភាពរបស់ការប្រឆាំងនិងស្ថានភាពនិយាយរឿងលោកចង្វាក់ឬប្រែប្រួលទៅក្នុងពិភពលោកផ្សេងៗ។',
  ...
  'genre.isekai.description':
    'ប្រភេទរឿងលោកចង្វាក់ជំនួយនៅក្នុងសិល្បះជប៉ុនដែលមានរបៀបប្រើប្រាស់សម្រាប់ការហៅចង្វាក់ឬប្រែប្រួលទៅក្នុងពិភពលោកផ្សេងៗនៅក្នុងពិភពលោកផ្សេងៗ។ អ្នកចង់ទស្សនា និងបង្កើតស្ថានភាពថ្មីរបស់ពិភពលោកដែលមានសម្រាប់និយាយរឿងលោកចង្វាក់ឬប្រែប្រួលទៅក្នុងពិភពលោកផ្សេងៗ។ អ្នកចង់រៀបចំនិងប្រើចង្វាក់ថ្មីនេះបានស្អាតជាង និងមានការស្វែងរកការជួយបន្ថែមថ្មីនិងការប្រើប្រាស់ទូទៅក្នុងពិភពលោកផ្សេងៗ។',
}
