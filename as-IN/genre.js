export default {
  'genre.scifi': 'বিজ্ঞান-কল্পবিদ্যা',
  'genre.fantasy': 'কল্পবিদ্যা',
  'genre.adventure': 'অভিযান',
  'genre.poetry': 'কবিতা',
  'genre.comedy': 'হাস্যকর',
  'genre.drama': 'নাটক',
  'genre.nonfiction': 'অলৌকিক',
  'genre.fiction': 'কথা-গল্প',
  'genre.romance': 'ভ্রমণময়',
  'genre.satire': 'হাস্যকর কল্পবিদ্যা',
  'genre.tragedy': 'বিপদজনক ঘটনা',
  'genre.crime': 'Crime',
  'genre.historical': 'ঐতিহাসিক কল্পবিদ্যা',
  'genre.horror': 'ভয়ঙ্কর',
  'genre.mystery': 'গুপ্তচর',
  'genre.thriller': 'থ্রিলার',
  'genre.western': 'পশ্চিম',
  'genre.memoir': 'আত্মজীবনী',
  'genre.biography': 'জীবনী',
  'genre.steampunk': 'স্টিমপাঙ্ক',
  'genre.mythology': 'পৌরাণিক কথা',
  'genre.fairytale': 'পরীর গল্প',
  'genre.superhero': 'সুপারহিরো',
  ...
  'genre.fantasy.description':
    'কল্পসাধারণ একটি সাহিত্যিক জাতি যা যৌক্তিক পৃথিবীগুলির মধ্যে মেজিক, অদ্ভুত ঘটনাগুলি এবং পৌরাণিক প্রাণীদের উপাদানে জড়িত হয়, সাধারণত কল্পমান প্রপূর্ণ প্রপঞ্চে সেট করা হয়। এটি প্রশংসা হতে পারে যুদ্ধের মধ্যে নৈতিকতা এবং নৈতিকতার বিষয়ে শোধ করা, ভাল এবং খারাপ মধ্যে লড়াইয়ে নায়কদের ছবি। কল্পসাধারণকে উচ্চ কল্পমান, শহর কল্পমান, অন্ধকার কল্পমান এবং পরী গল্প এইগুলির মতো উপ-জাতিগুলিতে বিভক্ত করা যেতে পারে। এটি সাধারণত ভাল এবং খারাপের স্বাভাবিকতা অনুসন্ধান করা হয়।',
  ...
  'genre.isekai.description':
    'এই জাপানী লাইট উপন্যাস, মাঙ্গা, এবং অ্যানিমে এই জাতীয় উপজাতির চারিত্রিকের জন্য পরিবহন বা পুনর্জন্ম একটি পৃথিবী বা বিভিন্ন বিশ্বান্তরে। প্রধান চরিত্রটি নতুন পৃথিবীর বিশেষ সংস্কৃতি এবং পরিবেশে নেভিগেট এবং অভিযানের পুনর্জন্ম বা পরিবহন করতে হবে, সাধারণত নতুন কার্যক্রম এবং নতুন মিত্র এবং শত্রুদের সঙ্গে সম্পর্ক করতে হবে। এই গল্পগুলি হাসির মতো ও কমেডি থেকে অন্ধকার ও তীব্র হতে পারে, কিন্তু সবসময় ক্লাসিক অ্যাডভেঞ্চার থিমের জন্য একটি তাজা এবং কল্পনামূলক দৃষ্টিভঙ্গি প্রদান করে।',
}
