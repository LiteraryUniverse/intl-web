export default {
    ...
    'blog.qa.references.title': '参考文献',
    'blog.qa.references.add': 'リファレンスを追加',
    'blog.qa.references.sectionTitle': '関連コンテンツ',
    'blog.qa.reference.encyclopedia': '百科事典エントリー: {title}',
    'blog.qa.reference.story': 'ストーリー： {title}{chapter}',
    'blog.qa.reference.chapter': ' (Chapter: {chapterTitle})',
    'blog.qa.reference.blogPost': 'ブログ記事 {title}',
    'blog.qa.reference.type.encyclopedia': '百科事典エントリー',
    'blog.qa.reference.type.story': 'ストーリー',
    'blog.qa.reference.type.blog': 'ブログ記事',
    'blog.qa.reference.chapter.option': 'チャプター {sequence}',
    'blog.qa.reference.chapter.untitled': '無題の章',
    'blog.qa.reference.chapter.placeholder': '章を選択...',
    'blog.qa.reference.line': '{typeLabel} - {title}{chapterPart}',
    'blog.qa.reference.type': '{type, select, encyclopedia {📚百科事典} story {📖ストーリー} blog {📝ブログ} other {📝参考}} 。',
    'blog.qa.outdated.title': '古いステータス',
    'blog.qa.outdated.marked': 'この質問は時代遅れです。',
    'blog.qa.outdated.replacement': '質問に代わる：',
    'blog.qa.outdated.unmark': '現在のものとしてマークする',
    'blog.qa.outdated.mark': '古いとマークする',
    'blog.qa.outdated.confirm': '古いとマークする',
    'blog.qa.outdated.replacementPlaceholder': '検索置換質問...',
    'blog.qa.outdated.notice': 'この答えは古いかもしれない。',
    'blog.qa.outdated.seeReplacement': '{question} 。',
    // Q&A Public
    'blog.qa.title': '質問',
