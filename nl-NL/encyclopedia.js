export default {
    ...
    'encyclopedia.container.desc': 'Maak van dit item een container voor een nieuwe groep items. Hierdoor wordt het verborgen in de lijst met categorieën.',
    'encyclopedia.entry.name': 'Naam van het item',
    'encyclopedia.summary': 'Samenvatting',
    'encyclopedia.summary.desc': 'Dit is een samenvatting die als enige initiële informatie op de lezer wordt weergegeven.',
