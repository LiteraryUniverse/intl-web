export default {
  ...
  'feedback.bugs.desc':
    'Συναντήσατε κάποιο σφάλμα ή κάτι άλλο που είναι λάθος ή μη τοποθετημένο. Πείτε μας εδώ!',
  'feedback.features': 'Ιδέες & Προτάσεις',
  'feedback.features.desc':
    'Έχετε ιδέες για νέες λειτουργίες ή πώς να κάνετε τον ιστότοπο καλύτερο; Πείτε μας!',
  ...
  'feedback.lang.nosupport':
    'Η τρέχουσα γλώσσα σας δεν υποστηρίζεται για τα σχόλια, παρακαλώ γράψτε στα Αγγλικά. Ευχαριστούμε!',
