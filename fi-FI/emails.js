...
export default {
  ...
  'email.enrollAccount.messageHtml':
    'Haluamme kutsua sinut Literary Universeen! Olemme valmistelleet sinulle henkilökohtaisen tilin, josta voit käyttää kaikkia Literary Universen ominaisuuksia! Liity kanssamme luomaan seuraavan sukupolven luovan kirjoittamisen ja lukemisen työkaluja!',
  ...
  'email.resetPassword.messageHtml':
    'Olemme vastaanottaneet pyynnön salasanan palauttamiseksi tilillesi. Ole hyvä ja klikkaa alla olevaa painiketta jatkaaksesi prosessia. Mikäli et ole tehnyt tätä pyyntöä, voit jättää tämän sähköpostin huomiotta, mutta nyt voisi olla hyvä hetki tarkistaa turvallisuusasetuksesi.',
  'email.resetPassword.button': 'Palauta salasana',
  // E-mail verification
  'email.verifyEmail.messageHtml':
    'Olemme iloisia, että olet mukana! Ole hyvä ja klikkaa alla olevaa painiketta vahvistaaksesi tämän sähköpostiosoitteen.',
