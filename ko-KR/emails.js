...
export default {
  ...
  'email.enrollAccount.messageHtml':
    '문학 우주에 초대합니다! 우리는 이미 귀하를 위한 개인 계정을 준비했습니다. 여기에서 문학 우주의 모든 기능에 액세스할 수 있습니다! 다음 세대의 창작 및 독서에 참여해 주세요!',
  ...
  'email.resetPassword.messageHtml':
    '귀하의 계정 비밀번호 재설정 요청을 받았습니다. 계속 진행하려면 아래 버튼을 클릭하십시오. 만약 이 요청을 하지 않았다면, 이 이메일을 무시하셔도 됩니다. 하지만 보안 설정을 확인하는 좋은 시기일 수도 있습니다.',
  'email.resetPassword.button': '비밀번호 재설정',
  // E-mail verification
  'email.verifyEmail.messageHtml':
    '환영합니다! 이 이메일 주소를 확인하려면 아래 버튼을 클릭하십시오.',
