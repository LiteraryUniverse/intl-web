export default {
  ...
  'groups.type.closedDesc':
    'Fermé - Les personnes doivent être approuvées avant de pouvoir rejoindre votre groupe.',
  'groups.type.hidden': 'Caché',
  'groups.type.hiddenDesc':
    'Caché - Seules les personnes que vous invitez peuvent se joindre à vous.',
  ...
  'groups.leaveGroup.confirm':
    'Juste pour être sûr. Êtes-vous certain de vouloir quitter {groupName}?',
  ...
  'groups.join.pendingRequest':
    "Votre demande d'adhésion à ce groupe est en attente d'approbation par les administrateurs du groupe.",
