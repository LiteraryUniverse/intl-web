export default {
  'legal.modal.intro':
    'Извините, что прерываем вас. Но прежде чем мы позволим вам продолжить, мы обязаны по закону убедиться, что вы ознакомлены и согласны с нашими Условиями использования, Политикой конфиденциальности и Соглашением об авторских правах.',
