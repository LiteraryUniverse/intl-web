...
export default {
    ...
    'common.legal.disclaimer': '© {year} সমস্ত অধিকার সংরক্ষিত, সমস্ত লেখা তাদের সংশ্লিষ্ট লেখকদের।',
    ...
    'common.createdOn': '{date, date, long} এ তৈরি',
    ...
    'error.oops': 'ওহ! কিছু একটা মারাত্মকভাবে ভুল হয়ে গেছে!',
    'error.apologies': 'আমরা অসুবিধার জন্য ক্ষমা প্রার্থনা করছি, আমরা শীঘ্রই এটি ঠিক করার জন্য আমাদের সর্বোচ্চ চেষ্টা করব।',
    'error.400.text': 'ত্রুটি ৪০০: {errorMessage}',
    'common.offlineStatus': 'আপনি বর্তমানে অফলাইনে আছেন।',
    male: 'পুরুষ',
    female: 'মহিলা',
    'common.legal.effectiveAt': '{date, date, medium} থেকে কার্যকর',
    ...
    'common.publishNow': 'এখনই প্রকাশ করুন',
    'common.publishLater': 'পরে প্রকাশ করুন',
    ...
    'story.notes.audienceAgeGroup': 'লক্ষ্য দর্শক বয়স গ্রুপ',
    'story.notes.audienceSex': 'লক্ষ্য দর্শক লিঙ্গ',
    ...
    'common.done': 'সম্পন্ন',
    'contentSelector.noSelection': 'কোনও আইটেম নির্বাচিত নয়',
    'contentSelector.selectedItems': 'নির্বাচিত আইটেমসমূহ',
    'contentSelector.entireSite': 'সাইট অনুসন্ধান',
    'contentSelector.tabsLabel': 'অনুসন্ধান বিকল্পসমূহ',
    'contentSelector.title': 'নির্বাচিত বিষয়বস্তু',
    ...
    create: 'তৈরি করুন',
    'banner.support': 'লিটারারি ইউনিভার্স আপনার মতো ব্যবহারকারীদের সমর্থনে সম্ভব হয়েছে। আমাদের স্বাধীনতা বজায় রাখতে এবং প্ল্যাটফর্ম উন্নত করতে, অনুগ্রহ করে আমাদের কোনো একটি প্ল্যানে সাবস্ক্রাইব করার কথা ভাবুন।',
    ...
    'common.noSelection': 'কোনও নির্বাচন নেই',
    'common.content': 'Content',
    'common.theWayOfTheAuthor': 'লেখকের পথ',
    ...
    'invitation.page.title': 'আমন্ত্রণ',
    'invitation.title': 'আপনাকে আমন্ত্রণ জানানো হয়েছে!',
    'invitation.detail.invitedBy': 'দ্বারা আমন্ত্রণিত',
    'invitation.detail.to': 'যোগ দিতে',
    'invitation.detail.role': 'ভূমিকা',
    'invitation.role.member': 'সদস্য',
    'invitation.role.collaborator': 'সহযোগী',
    'invitation.role.translator': 'অনুবাদক',
    'invitation.role.beta': 'বিটা পাঠক',
    'invitation.objectType.organization': 'সংগঠন',
    'invitation.objectType.story': 'গল্প',
    'invitation.objectType.universe': 'ব্ৰহ্মাণ্ড',
    'invitation.accept': 'আমন্ত্রণ গ্রহণ করুন',
    'invitation.accepting': 'গ্রহণ করছি...',
    'invitation.decline': 'হ্রাস',
    'invitation.loginRequired': 'অনুগ্রহ করে এই আমন্ত্রণে সাড়া দিতে লগ ইন করুন অথবা একটি অ্যাকাউন্ট তৈরি করুন।',
    'invitation.haveAccount': 'আমার একটি অ্যাকাউন্ট আছে',
    'invitation.newHere': 'আমি এখানে নতুন',
    'invitation.registerPrompt': 'এই আমন্ত্রণ গ্রহণ করতে একটি বিনামূল্যের অ্যাকাউন্ট তৈরি করুন।',
    'invitation.register': 'অ্যাকাউন্ট তৈরি করুন',
    'invitation.goToDashboard': 'ড্যাশবোর্ডে যান',
    'invitation.alreadyAccepted.title': 'আমন্ত্রণ ইতিমধ্যেই গৃহীত হয়েছে',
    'invitation.alreadyAccepted.message': 'এই আমন্ত্রণটি ইতিমধ্যেই গ্রহণ করা হয়েছে।',
    'invitation.alreadyDeclined.title': 'আমন্ত্রণ প্রত্যাখ্যাত',
    'invitation.alreadyDeclined.message': 'এই আমন্ত্রণ প্রত্যাখ্যাত হয়েছে।',
    'invitation.declined.title': 'আমন্ত্রণ প্রত্যাখ্যাত',
    'invitation.declined.message': 'আপনি আমন্ত্রণটি প্রত্যাখ্যান করেছেন।',
    'invitation.cancelled.title': 'আমন্ত্রণ বাতিল',
    'invitation.cancelled.message': 'এই আমন্ত্রণপত্র প্রেরক দ্বারা বাতিল করা হয়েছে।',
