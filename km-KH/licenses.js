...
export default {
  ...
  'licenses.lu-c':
    'អាជ្ញាធរសម្រាប់អាននិងលក្ខណៈពន្ធរបស់អ្នកដែលអនុញ្ញាតឱ្យលក្ខណៈសម្បត្តិរបស់អ្នកបានការលក្ខណៈការលក្ខណៈរបស់អ្នកបានការពារត្រាំមួយ។ អាជ្ញាធរនេះក៏ឱ្យអ្នកជួយលក្ខណៈរបស់អ្នកបានជួយលក្ខណៈរបស់អ្នកបានលក្ខណៈការលក្ខណៈរបស់អ្នកបានការលក្ខណៈរបស់អ្នកបានការពារត្រាំមួយ។',
  'licenses.name.cc0': 'គ្មានការការិយាល័យដែលបានគេការការិយាល័យ - CC0 1.0',
  'licenses.cc0':
    'ដាក់លក្ខណៈរបស់អ្នកចូលក្នុងបរិស្ថានសាធារណៈសាធារណៈសន្ទនារបស់ CC ដែលអនុញ្ញាតឱ្យមានការជ្រើសរើសពីការអនុញ្ញាតការអនុញ្ញាតប្រភេទចរន្តដែលអនុញ្ញាតឱ្យមានការការការិយាល័យមួយចំនួនដែលអនុញ្ញាតឱ្យមានការការការការការលក្ខណៈការលក្ខណៈរបស់អ្នកបានការពារត្រាំមួយ - ការជ្រើសរើសពីការអនុញ្ញាតរបស់យើង។',
}
