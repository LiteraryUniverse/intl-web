...
export default {
  ...
  'flashnews.onlyDisplayOn':
    'Tin tức sẽ chỉ hiển thị trên các ngôn ngữ đã chọn bên dưới (nếu có), không có tin tức nào được hiển thị, thậm chí trong ngôn ngữ mặc định, trong các ngôn ngữ khác.',
  ...
  'notification.workshopStoryStatus.toHiatus':
    'Câu chuyện của bạn {storyName} đã tự động chuyển sang tạm dừng sau 6 tháng không hoạt động.',
  'notification.workshopStoryStatus.toCancelled':
    'Câu chuyện của bạn {storyName} đã tự động chuyển sang hủy sau một năm không hoạt động.',
